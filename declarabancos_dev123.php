    ...
    <body>
        <div class="container">
            <div class="row">
                ...
                <br>
                <p class="text-bold">Assunto: Abertura de Conta- Salário</p>
                <br>
                <p class="">
                    Prezados Senhores, <br>
                    Vimos, através da presente, encaminhar o(a) colaborador(a) relacionado(a) abaixo a essa instituição financeira, para abertura de conta salário e, para tanto, apresentamos os dados cadastrais, a saber:
                </p>
                <p>Nome: <strong><?=$row['nome']?></strong></p>
                <p>CPF:<strong> <?=$row['cpf']; ?></strong></p>
                <p>Endereço:<strong> <?=$row['endereco']; ?> - <?=$row['bairro']; ?> - <?=$row['cidade']; ?> CEP: <?=$row['cep']; ?></strong></p> 
