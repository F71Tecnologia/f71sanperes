...
if (isset($_REQUEST['gerar']) || isset($_REQUEST['todos_projetos'])) {
    ...
    if ($tipo_contratacao == 2) {
        $str_qr_relatorio = "SELECT *, (YEAR(CURDATE())-YEAR(data_nasci)) - (RIGHT(CURDATE(),5)<RIGHT(data_nasci,5)) AS idade, date_format(data_nasci, '%d/%m/%Y') AS data_nascibr
            FROM rh_clt
...
<html lang="pt">
    <head>
        ...
        <title>:: Intranet :: Relatórios por Idade</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - Relatórios por Idade </h2></div>
