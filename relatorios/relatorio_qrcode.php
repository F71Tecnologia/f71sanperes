...
<html lang="pt">
    <head>
        ...
        <title>:: Intranet :: Relatório de Funcionários por Unidade </title>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - RECURSOS HUMANOS <small> - Relatório de Funcionários por Unidade</small></h2></div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading text-bold hidden-print">Relatório</div>
                        <div class="panel-body">
                            ...
                            <div class="form-group" >
                                <label for="select" class="col-sm-2 control-label hidden-print" >Unidade</label>
                                <div class="col-sm-3">
                        ...
                        <div class="panel-footer text-right hidden-print controls">
                            ...
                            <button type="button" onclick="tableToExcel('tabela', 'Funcionário por Unidade')" value="Exportar para Excel" class="btn btn-success" ><span class="fa fa-file-excel-o"></span> Exportar para Excel</button>
                            <?php } ?>
                ...
                <?php if (!empty($qr_relatorio) && (isset($_POST['gerar']))){ ?>
                    <table class="table table-striped table-condensed table-bordered table-hover text-sm valign-middle" id="tabela">
                       ...
                       <?php while ($row_rel = mysql_fetch_assoc($qr_relatorio)) { $class = ($cont++ % 2 == 0)?"even":"odd"?>
                            <?php  if($row_rel['numero']){ ?>
                            <tr class="<?php echo $class ?>">
                         
                                <td> <?php echo $row_rel['nome']; ?></td>
                                <td> <?php echo "<img src='http://chart.apis.google.com/chart?cht=qr&chl=".$row_rel['numero']."&chs=125x125&alt='".$row_rel['numero']."'/>" ?></td>                                                
                            </tr>                                
                       <?php } } ?>        
