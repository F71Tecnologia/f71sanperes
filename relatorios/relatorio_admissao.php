...
if (isset($_REQUEST['gerar']) || isset($_REQUEST['todos_projetos'])) {
    ...
    $sql = "SELECT A.id_clt, A.nome, A.matricula, A.cpf, A.pis, A.tel_cel, DATE_FORMAT(A.data_entrada,'%d/%m/%Y') AS dt_admissao, E.nome as projeto, C.nome as funcao
                FROM rh_clt AS A
                ...
                WHERE A.data_entrada BETWEEN '{$dt_iniCon}' AND '{$dt_fimCon}' AND D.id_regiao = {$regiao}";
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-footer text-right hidden-print">
                        <?php if (!empty($qr_relatorio) and ( isset($_POST['gerar']) || isset($_REQUEST['todos_projetos']))) { ?>
                            <button type="button" onclick="tableToExcel('tbRelatorio', 'Relatório de Admissões')" class="btn btn-success"><span class="fa fa-file-excel-o"></span> Exportar para Excel</button>
                        <?php } ?>
