...
if (!empty($_REQUEST['data_xls'])) {
    ...
    echo "  <head>";
    echo "  <title>Relatório de Contribuição Sindical</title>";
                    ...
                    <div class="panel-heading text-bold hidden-print">Relatório</div>
                        <div class="panel-body">
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-sm-5">
                                    <?php echo montaSelect(array("-1" => "« Selecione a Região»"), $optSind, array('name' => "id_sindicato", 'id' => 'id_sindicato', 'class' => 'form-control')); ?> <span class="loader"></span> 
                                </div>
