...
if (!empty($_REQUEST['data_xls'])) {
    ...
    header("Content-Disposition: attachment; filename=relatorio_participantes_folha.xls");

    echo "\xEF\xBB\xBF";
    echo "<html xmlns:o='urn:schemas-microsoft-com:office:office' xmlns:x='urn:schemas-microsoft-com:office:excel/' xmlns='http://www.w3.org/TR/REC-html40'>";
    echo "  <head>";
    echo "  <title>Relatório de Participantes na Folha</title>";
...
if (isset($_REQUEST['gerar']) || isset($_REQUEST['todos_projetos'])) {
    ...
    $sql = "SELECT B.matricula, B.nome, C.nome funcao, D.unidade, DATE_FORMAT(B.data_entrada, '%d/%m/%Y') entrada, E.especifica
            FROM rh_folha_proc A
              ...
              LEFT JOIN rhstatus E ON B.`status` = E.codigo
            WHERE A.id_projeto = $projeto 
              AND A.`status` > 0 
              AND A.id_folha = (SELECT F.id_folha FROM rh_folha F WHERE F.projeto = $projeto ORDER BY F.id_folha DESC LIMIT 1);";
...
<html lang="pt">
    <head>
        ...
        <title>:: Intranet :: Relatório de Participantes na Folha</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - Relatório de Participantes na Folha</h2></div>
