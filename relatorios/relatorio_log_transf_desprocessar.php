...
$breadcrumb_config = array("nivel" => "../", "key_btn" => "6", "area" => "Sistema", "id_form" => "form1", "ativo" => "Relatório de Transferência Desprocessadas");
         ...
         <script>
            $(function() {
                ...
                $('#regiao').ajaxGetJson("../methods.php", {method: "carregaProjetos"}, function(data) {
                    ...
                    var selected = $("input[name=hide_" + id_destination + "]").val(); console.log(selected);
                    if (selected !== undefined) {
                        $("#" + id_destination).val(selected);
                    }
                    $('#projeto').trigger('change');
                    $("#projeto option[value='-1']").remove()
                }, "projeto");
