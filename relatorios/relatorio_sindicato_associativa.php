...
if (!empty($_REQUEST['data_xls'])) {
    ...
    header("Content-Disposition: attachment; filename=relatorio_sindicato_associativa.xls");

    echo "\xEF\xBB\xBF";
    echo "<html xmlns:o='urn:schemas-microsoft-com:office:office' xmlns:x='urn:schemas-microsoft-com:office:excel/' xmlns='http://www.w3.org/TR/REC-html40'>";
    echo "  <head>";
    echo "  <title>Relatório de Contribuição Associativa</title>";
...
if (isset($_REQUEST['gerar']) || isset($_REQUEST['todos_projetos'])) {
    ...
    $sql = "SELECT A.id_clt, A.nome, A.cpf, A.rh_sindicato, C.nome sindicato, B.valor
            ...
            WHERE id_projeto = $projeto AND (A.status < 60 OR A.status IN (70, 200)) AND A.isento_sindical_associativa = 0 AND rh_sindicato > 0 
...
<html lang="pt">
    <head>
        ...
        <title>:: Intranet :: Relatório de Contribuição Associativa</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - Relatório de Contribuição Associativa</h2></div>
