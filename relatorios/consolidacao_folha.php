...
<table cellspacing="0" cellpadding="0" class="relacao" style="width:100%; border:0; page-break-after:always;">
  ...
  <tr> 
    <td colspan="3">
    <p id="excel" style="text-align: left; margin-top: 20px"><input type="button" onclick="tableToExcel('tbRelatorio', 'Relatório')" value="Exportar para Excel" class="exportarExcel"></p>
    <table id="tbRelatorio" cellspacing="2" cellpadding="3" class="relacao" style="font-weight:normal; line-height:22px; margin-top:30px; border:0; width:100%;">
      <tr class="secao">       
