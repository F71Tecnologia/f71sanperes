...
if (!empty($_REQUEST['data_xls'])) {
    ...
    header("Content-Disposition: attachment; filename=endereco_autonomo.xls");

    echo "\xEF\xBB\xBF";
    echo "<html xmlns:o='urn:schemas-microsoft-com:office:office' xmlns:x='urn:schemas-microsoft-com:office:excel/' xmlns='http://www.w3.org/TR/REC-html40'>";
    echo "  <head>";
    echo "  <title>Endereco Autonomo</title>";
...
if (isset($_REQUEST['gerar']) || isset($_REQUEST['todos_projetos'])) {
    ...
    $sql = "SELECT A.id_autonomo, A.nome, A.cpf, B.unidade, CONCAT(A.endereco,', ', A.numero, ' - ', A.bairro, ', ', A.cidade, ', ', A.uf, ' - ', A.cep ) endereco
            FROM autonomo A
            LEFT JOIN unidade B ON A.id_unidade = B.id_unidade
...
<html lang="pt">
    <head>
        ...
        <title>:: Intranet :: Relatório de Participantes por PIS</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - Relatório de Participantes por PIS</h2></div>
                    ...
                    <div id="tabela">
                        <table id="tbRelatorio" border="0" cellpadding="0" cellspacing="0" class="table table-striped table-hover text-sm valign-middle table-bordered" width="100%" style="page-break-after:auto;"> 
                            ...
                            <?php foreach ($participantes as $key => $value) { ?>
                                <tbody>
                                    <tr>
                                        <td class="text-center"><?php echo $value['id_autonomo']; ?></td>
