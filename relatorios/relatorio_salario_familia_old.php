        ...
        <body style="background-color:#FFF; margin-top:30px; margin-bottom:30px;">
            <table cellspacing="0" cellpadding="0" class="relacao" style="width:720px; border:0px; page-break-after:always;">
                ...
                <tr> 
                    <td colspan="3">
                        <?php
                        while ($row_dependentes = mysql_fetch_array($result_dependentes)) {
                            ...
                            <table class="relacao" width="100%" cellpadding="3" cellspacing="1">
                                ...
                                <tr class="linha_um">
                                    <?php
                                        $ano1 = explode("/", $row_dependentes['data1']);
                                        if($ano1[2] >= $AnoValido){
                                    ?>  
                                ...
                                <?php if (!empty($row_dependentes['nome2'])) { ?>
                                    <tr class="linha_dois">
                                    <?php
                                        $ano2 = explode("/", $row_dependentes['data2']);
                                        if($ano2[2] >= $AnoValido){
                                    ?> 
                                ...
                                <?php } if (!empty($row_dependentes['nome3'])) { ?>
                                    <?php
                                        $ano3 = explode("/", $row_dependentes['data3']);
                                        if($ano3[2] >= $AnoValido){
                                    ?>
                                    <tr class="linha_um">
                                ...
                                <?php } if (!empty($row_dependentes['nome4'])) { ?>
                                    <?php
                                        $ano4 = explode("/", $row_dependentes['data4']);
                                        if($ano4[2] >= $AnoValido){
                                    ?>
                                    <tr class="linha_dois">
                                ...
                                <?php } if (!empty($row_dependentes['nome5'])) { ?>
                                    <?php
                                        $ano5 = explode("/", $row_dependentes['data5']);
                                        if($ano5[2] >= $AnoValido){
                                    ?>
                                    <tr class="linha_um">
