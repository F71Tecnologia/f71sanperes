    ...
    <body class="novaintra" >        
        <div id="content">
            <form  name="form" action="<?= $_SERVER['PHP_SELF'] ?>" id="form1" method="post" id="form">
                ...
                <?= $resposta ?>
                <a href="listaRelatorios.php" class="botao">Voltar para Gestão de Relatórios</a>
                <br><br>
                <fieldset class="noprint">
                    ...
                    <div class="fleft">
                        ...
                        <p>
                            <label class="first">Nome do Relatório:</label>
                            <input type="text" name="nome" id="nome" value="<?= $relatorio['nome']; ?>" style="width: 20em;">
                        </p>                        
                        <p>
                            <label class="first">URL do Relatório:</label>
