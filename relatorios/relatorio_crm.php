...
if (!empty($_REQUEST['data_xls'])) {
    ...
    header("Content-Disposition: attachment; filename=relatorio_crm.xls");

    echo "\xEF\xBB\xBF";
    echo "<html xmlns:o='urn:schemas-microsoft-com:office:office' xmlns:x='urn:schemas-microsoft-com:office:excel/' xmlns='http://www.w3.org/TR/REC-html40'>";
    echo "  <head>";
    echo "  <title>Endereco CRM</title>";
...
if (isset($_REQUEST['gerar']) || isset($_REQUEST['todos_projetos'])) {
    ...
    $sql = "SELECT A.id_clt, A.nome, A.cpf, C.nome curso, A.conselho
            FROM rh_clt A
            LEFT JOIN unidade B ON A.id_unidade = B.id_unidade
            LEFT JOIN curso C ON A.id_curso = C.id_curso
            WHERE id_projeto = $projeto AND (A.status < 60 || A.status IN (70,200)) AND C.nome LIKE '%MEDICO%'
            ORDER BY nome";
...
<html lang="pt">
    <head>
        ...
        <title>:: Intranet :: Relatório de CRM</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - Relatório de CRM</h2></div>
