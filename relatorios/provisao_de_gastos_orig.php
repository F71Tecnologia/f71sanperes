 ...
 * 
 * Versao: 3.0.01687 - 31/07/2015 - Jacques - Implementacao de tabela temporária para geracao de provisao de gastos com compatibilidade retroativa
 * Versao: 3.0.01734 - 26/08/2015 - Jacques - Implementado exclusao lógica para registros no header_recisao_lote
 * Versao: 3.0.01735 - 26/08/2015 - Jacques - Adicionado log de inclusao e exclusao das provisões de gastos
 * Versao: 3.0.01815 - 28/08/2015 - Jacques - Correcao de bug na montagem da query confirmar_rescisao a partir da linha 274
 * Versao: 3.0.01817 - 28/08/2015 - Jacques - Correcao nos totalizadores quando o fator for o empregado, agrupamento por vetor dos grupos e liberacao do botao de confirmacao de efetivacao de recisao.
 * Versao: 3.0.01879 - 01/08/2015 - Jacques - Adicionado set de variável $clt e $id_rescisao_lote vindo de post com (int) e definido no update rh_recisao id_recisao_lote > 0 para tentar sanar registros de rh_recisao que estao sendo ativados aleatoriamente
 * Versao: 3.0.01885 - 01/08/2015 - Jacques - Adicionado exportacao para excel via javascript ao invéz de montagem direto por relatório (Para acelerar processo para geracao do relatório pela Lagos)
 * Versao: 3.0.02581 - 30/09/2015 - Jacques - Alterado o método de exportacao para o excel para ver se resolve o problema de exportacao de grandes listas de dados
 * Versao: 3.0.03415 - 23/10/2015 - Jacques - Desativado o botao de "Provisao Trabalhista" e alterado o valor do botao "Visualizar Rescisao" 
 *                                           para "Visualizar Previsao de Gastos". Acao solicitada pelo Rogério.
 * Versao: 3.0.03801 - 04/11/2015 - Jacques - Ativacao do botao Provisao Trabalhista a pedido de Ramon.
 * Versao: 3.0.03806 - 05/11/2015 - Jacques - Alteracao do método de exportacao da provisao trabalhista para o mesmo procedimento do provisao de gastos que já usa código que permite exportacao com muitos dados
 * Versao: 3.0.03810 - 05/11/2015 - Jacques - Alteracao do código de página UTF-8 para ISO-8859-1 a ser usado nas exportacões de planilhas
 * Versao: 3.0.03821 - 05/11/2015 - Jacques - Retirado todas as acentuações do código pois não foi encontrado de forma rápida uma solução
 * Versão: 3.0.03898 - 09/11/2015 - Jacques - Segundo solicitação de acerto do Milton a base para calculo de INSS e FGTS = 13o + Aviso + Lei
 *                                           Com INSS = 26.92, PIS = 1%, FGTS = 8%.
 * Versão: 3.0.04030 - 11/11/2015 - Jacques - Adicionado a seleção da região na listagem das provisões de gastos
 * Versão: 3.0.05974 - 26/01/2016 - Jacques - Adicionado filtro para situação de Clt no processamento de provisão de gastos
 * Versão: 3.0.06013 - 27/01/2016 - Jacques - Adicionado opção de lançamento de movimento em lote a pedido de Jeferson
 * Versão: 3.0.06051 - 27/01/2016 - Jacques - Adicionado opção de exclusão e atualização de lançamento de movimento em lote 
 * Versão: 3.0.06129 - 27/01/2016 - Jacques - Alterado o filtro de Visualizar Participantes, segundo orientação de Junior o status 200 deverá ficar em atividade normal
 *                                           ou período de experiência de acordo com a situação.
 * Versão: 3.0.06170 - 04/02/2016 - Jacques - Adicionado o campo de situação nas provisões geradas, reposicionamento da div relatório, e dos combos para melhor utilização e visualização
 * Versão: 3.0.06502 - 16/02/2016 - Jacques - input desnecessário na geração da planilha de cálculo do provisão trabalhista pois o primeiro lote a ser processado é que vai definir o valor
 ...
 * Versão: 3.0.06857 - 22/02/2016 - Jacques - Correção do bug no lançamento de movimento individual gerado pela criação do movimento em lote
 * Versão: 3.0.10611 - 16/08/2016 - Jacques - Retificação de retorno JSON em gerar rescisão e alinhamento de ampulheta e scroll de tela
 * Versão: 3.0.10969 - 30/08/2016 - Jacques - Alterado método de efetivação de rescisões via cliente com disponibilização de barra de progresso
 * 
 * 
 * 
 * @author Nao definido 
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">     
    <head>
        ...
        <link href="../css/cupertino/jquery-ui-1.9.2.custom.css?10699" rel="stylesheet" type="text/css" />
        <link href="//code.jquery.com/ui/1.12.0/themes/base/jquery-ui.css" rel="stylesheet" type="text/css"/>
        <link href="../css/validationEngine.jquery.css?10699" rel="stylesheet" type="text/css" />
        <link href="../favicon.ico" rel="shortcut icon" />
        <script src="https://code.jquery.com/jquery-1.12.4.js"></script>
        <script src="https://code.jquery.com/ui/1.12.0/jquery-ui.js"></script>        
        <script src="../js/jquery-1.8.3.min.js?10699" type="text/javascript"></script>
        <script src="../js/jquery-ui-1.9.2.custom.min.js?10699" type="text/javascript"></script>
        <script src="../js/jquery-base64-master/jquery.base64.js" type="text/javascript"></script>
        <script src="../js/global.js?10699" type="text/javascript"></script> 
        <script src="../js/ramon.js?10699" type="text/javascript"></script>
        <script src="../js/jquery.validationEngine_2.6.2.js?10699" type="text/javascript"></script>
        <script src="../js/jquery.validationEngine-pt_BR-2.6.js?10699" type="text/javascript"></script>
        <script src="../js/tableExport.jquery.plugin-master/tableExport.js?10699" type="text/javascript"></script>        
