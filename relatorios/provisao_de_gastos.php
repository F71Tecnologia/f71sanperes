 ...
 * @version: 3.0.00616 - 19/12/2016 - Jacques - Adicionado label que indentifica movimento coletivo do lançamento individual
 * @version: 3.0.00616 - 11/01/2017 - Jacques - Versão homologada pela Michele com funcional
 * 
 * 
 * 
 * @author Nao definido 
...
if (isset($_REQUEST['method']) && $_REQUEST['method'] == "verificaParticipantes") {
    ...
    $verifica_participantes = "
                ...
                FROM 
                    ...
                    WHERE {$criteria} AND (A.status < 60 || A.status IN(67,68,69,70,90,200)) 
...
if (isset($_REQUEST['method']) && $_REQUEST['method'] == "carrega_movimentos") {
    ...
    $query_movimentos = "SELECT 
                            ...
                            B.descicao,
                            A.id_rescisao_lote_coletivo,
                            CONCAT(B.descicao,(IF(A.id_rescisao_lote_coletivo,' (LANC. COLETIVO) ',''))) descicao
    ...
    if ($sql_movs) {
        ...
        while ($linhas_movs = mysql_fetch_assoc($sql_movs)) {
            ...
            $dados[] = array("id_mov" => $linhas_movs['id_mov_fmt'], "id_rescisao" => $linhas_movs['id_rescisao'], "id_movimento" => $linhas_movs['id_movimento'], "id_rescisao_lote_coletivo" => $linhas_movs['id_rescisao_lote_coletivo'], "tipo" => utf8_encode($linhas_movs['tipo']), "nome_movimento" => utf8_encode(trim($linhas_movs['descicao'])), "valor" => $linhas_movs['valor']);
...
//                                html += "</tfoot></table><br/>";
                ...
                $(".lanca_movimento").click(function() {
                    ...
                    thickBoxModal("Lançamento", "#lancamento_mov", 920, 700);
...
//                    });
                ...
                $("body").on("click", "#lanca_movimento_lote", function () {
                    ...
                    thickBoxModal("Lançamento", "#lancamento_mov_lote", 920, 700);
        ...
        <article>  
            ...
            <div id="content" style="width: 1150px; display: table;">
                ...
                <form  name="form" action="" method="post" id="form" accept-charset="iso-8859-1">
                    ...
                    <?php
                    include('provisao_de_gastos_rescisao_inc.php');
                    include('provisao_de_gastos_trabalhista_inc.php');
                    ?>
                </form>
                <footer>
                    <div>
                    ...
                    <div class="lancamento">
                        <div id="lancamento_mov">
                            <div id="box-1">
                                ...
                                <h3 class="descricao_box">» Lançamento de Movimento Individual</h3>
                                <fieldset>
                                    <p>
                    ...
                    <div class="lancamento">
                        <div id="lancamento_mov_lote">
                            <div id="box-3">
                                ...
                                <h3 class="descricao_box">» Lançamento de Movimento coletivo</h3>
                                <fieldset>
                                    <p>
                                        <label class="first">Selecione o movimento</label>
