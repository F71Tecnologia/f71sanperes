...
.style18 {font-size: 9px; font-weight: bold; color: #000000; }
-->
</style></head>
...
$img -> imagemCNPJ();
?><br />
              <span class="style2"><strong>ESCOLHA DO FORNECEDOR</strong></span><br />
              <br />
              <span class="style23">NUMERO DO PROCESSO: <?php print "$row[num_processo]";?></span></div></td>
        </tr>
        <tr height="32">
          <td height="32">&nbsp;</td>
        </tr>
	  ...
	  print "
          ...
          ?>
           ...
           <table width="96%" align="center" cellpadding="0" cellspacing="0" class="tarefa"> 
            ...
            <a href="<?=print "reldecisao.php?compra=$id_compra&regiao=$regiao";?>" target="_blank" style="text-decoration:none">IMPRIMIR COTA&Ccedil;&Otilde;ES</a> <img src="imagens/impressora.jpg" alt="Imprimir" width="30" height="30" align="absmiddle" /><br />
            <br />
            Slecione o Fornecedor pelo qual o Produto ou Servi&ccedil;o ser&aacute; adquirido:</strong>
        <form action="decisao.php" method="post" name="form1" class="style2" id="form3"><div align="center">
              ...
              <p><br />
                <input type="submit" name="GRAVAR4" id="GRAVAR4" value="Selecionar Fornecedor para Compra" />
                <br />
                <br />
