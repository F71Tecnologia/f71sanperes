...
$breadcrumb_caminhos[0] = array("Gestão de RH" => "../", "Cooperativas" => "cooperativa_nova2.php");
$breadcrumb_caminhos[1] = array("Gestão de RH" => "../", "Cooperativas" => "cooperativa_nova2.php");
                    ...
                    <div class="col-lg-12">
                        <fieldset>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 control-label no-padding" for="nome">Razão Social:</label>
                        ...
                        <fieldset class="col-lg-12">
                            ...
                            <fieldset class="col-lg-offset-1 col-lg-5">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 control-label" for="enderecop">Endereço:</label>
                            ...
                            <fieldset class="col-lg-offset-1 col-lg-5">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 control-label" for="enderecod">Endereço:</label>
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-lg-2 control-label" for="bonificacao">Bonificação:</label>
