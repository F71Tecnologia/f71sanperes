...
//$result_reg = mysql_query("Select * from regioes where id_regiao = $row[regiao]");
...
$result_vale = mysql_query("Select * from vale where id_bolsista = '$id_bol'");
...
<table width="720" bgcolor="#FFFFFF" class="bordaescura1px">
  <tr>
    <td><table width="650">
      <tr>
        <td width="155"><?php
...
if($row['foto'] == "1"){
	...
	if($nome_para_arquivo == "0"){
		...
		$nome_imagem = $id_reg."_".$pro."_".$nome_para_arquivo.".gif";
	}
}else{
