...
$REFolha_pro = mysql_query("SELECT * FROM folha_cooperado where id_folha = '$folha' and status = '3' ORDER BY nome ASC");
...
<table width="98%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" align="center">
  <tr>
	...
	$cont ++;
		...
		echo '<h1 style="page-break-after: always"><!---Aqui a página é quebrada--> </h1>'; 
