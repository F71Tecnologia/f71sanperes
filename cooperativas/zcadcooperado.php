...
'$r_ramal','$r_fax','$r_email','$rh_vinculo','$rh_status','$rh_horario','$rh_sindicato','$rh_cbo','$cota','$parcelas','$contrato_medico', '$matricula', '$n_processo', '$email', '$data_emissao', '$tipo_sanguineo', '$estCivilId')");
        exit;
