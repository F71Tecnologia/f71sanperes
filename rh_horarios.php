...
$('#horas_mes, #dias_mes, #entrada1, #saida1, #entrada2, #saida2').blur(function(){
...
onFocus="this.style.background='#CCFFCC'" onBlur="this.style.background='#FFFFFF'"  style="background:#FFFFFF;"></td>
                ...
                <tr>
                    ...
                    <td width="12%">&nbsp;&nbsp;&nbsp;
                    <input name="dias_mes" type="text" id="dias_mes" size="10"
                      onFocus="this.style.background='#CCFFCC'" onBlur="this.style.background='#FFFFFF'"  style="background:#FFFFFF;"></td>
                </tr>
...
<td><input type="text" name="entrada1" value="<?php echo $row_horarios['entrada_1']?>" id="entrada1" rel="<?php echo $row_horarios['id_horario']?>"  OnKeyUP="formatar('##:##:##', this); pula(8,this.id,saida1.id)" maxlength="8"   size="5"/></td>
<td><input type="text" name="saida1" value="<?php echo $row_horarios['saida_1']?>" id="saida1" rel="<?php echo $row_horarios['id_horario']?>" OnKeyUP="formatar('##:##:##', this); pula(8,this.id,saida1.id)" maxlength="8" size="5"/></td>
<td><input type="text" name="entrada2" value="<?php echo $row_horarios['entrada_2']?>" id="entrada2" rel="<?php echo $row_horarios['id_horario']?>" OnKeyUP="formatar('##:##:##', this); pula(8,this.id,saida1.id)" maxlength="8" size="5"/></td>
<td><input type="text" name="saida2" value="<?php echo $row_horarios['saida_2']?>" id="saida2" rel="<?php echo $row_horarios['id_horario']?>" OnKeyUP="formatar('##:##:##', this); pula(8,this.id,saida1.id)" maxlength="8" size="5"/></td>
<td><?php echo $row_horarios['dias_semana']?></td>
<td><input type="text" name="horas_mes" value="<?php echo $row_horarios['horas_mes']?>" id="horas_mes" rel="<?php echo $row_horarios['id_horario']?>" size="5"/></td>
<td><input type="text" name="dias_mes" value="<?php echo $row_horarios['dias_mes']?>"   id="dias_mes" rel="<?php echo $row_horarios['id_horario']?>" size="5"/></td>
