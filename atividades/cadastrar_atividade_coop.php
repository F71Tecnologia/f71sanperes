...
// SELECIONANDO AS REGIÕES CADASTRADAS NO BANCO
    ...
    ?>
    <html>
        <head><title>:: Intranet ::- CADASTRO DE FUN&Ccedil;&Otilde;ES (COOPERADO)</title>
        ...
        <body>
            <div id="corpo">
                <div id="conteudo">  
                    ...
                    <h3>CADASTRO DE FUNÇÕES <br>(COOPERADO)</h3>
                    ...
                    <form action='../cadastro2.php' method='post' name='form1' id='form1' onSubmit="return validaForm()">
                        <table  border='0' cellpadding='0' cellspacing='0'  align='center' class="relacao" bgcolor="#E5E5E5">
                            ...
                            <tr class="titulo_tabela1">
                                <td  colspan='4'>Dados do Função</td>
                            </tr>
                            ...
                            <tr>
                                <td class="secao" align="right">Nome da Função:</td>
                                <td colspan='3' align="left">
                        ...
                        <input name='contratacao' type='hidden' id='contratacao' value='3'/> 
                    </form>
                    ...
                    <script>
                        ...
                        function validaForm() {
                            ...
                            if (d.atividade.value == "") {
                                alert("O campo Nome da Função deve ser preenchido!");
                                d.atividade.focus();
                                return false;
                            }
                            ...
                            if(d.id_cbo.value == 0) {
                                alert("Deve-se selecionar um CBO!");
                                d.pesquisa_usuario.focus();
                                return false;
                            }
                            ...
                            if (d.parcelas.value == "") {
                                alert("O campo PARCELAS deve ser preenchido!");
                                d.parcelas.focus();
                                return false;
                            }

                            if (d.quota.value == "") {
                                alert("O campo QUOTAS deve ser preenchido!");
                                d.quota.focus();
                                return false;
                            }
