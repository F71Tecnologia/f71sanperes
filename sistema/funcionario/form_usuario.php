                                        ...
                                        if (mysql_num_rows($qr_acoes) != 0) {
                                            ...
                                            <table border="0"  cellspacing="0">
                                                <tr bgcolor="#C7E2E2">
                                                    ...
                                                    <td colspan="2">
                                                        <input type="checkbox" name="botoes[]" value="<?php echo $row_botoes['botoes_id']; ?>"  <?php if ($row_assoc['botoes_id'] == $row_botoes['botoes_id']) echo 'checked'; ?> class="checkAll" data-type="class" data-name="master_acoes_"> <?php echo $row_botoes['botoes_nome']; ?> - Ações PP
                                                    </td>  
                                                </tr>
