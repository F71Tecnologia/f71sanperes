...
if(isset($_REQUEST['in']) && !empty($_REQUEST['in'])){
    ...
    $strInsert = "INSERT INTO `terceiro_ponto` (`id_projeto`, `id_regiao`, `id_terceirizado`,`id_autonomo`,`id_funcionario`, `id_cracha_temporario`, `data_completa`, `data`, `hora`, `imagem`, `pis`, `flag`) VALUES ".$sqlIn;
