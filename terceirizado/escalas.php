            ...
            <div class="detalhes-modulo">
                <div class="bs-glyphicons">
                    <div class="box-rh-list">
                        ...
                        <a class="bot_nv col-lg-2 col-md-4 col-sm-4 col-xs-6 valign-middle" href="relatorio_acesso_restrito2.php" target="blank">
                            <img align="absmiddle" src="../img_menu_principal/rel_gerencial.png"/>
                            <p><!--Relatório -->Controle de Acesso</p>
                        </a>
                        <a class="bot_nv col-lg-2 col-md-4 col-sm-4 col-xs-6 valign-middle" href="relatorio_escala.php" target="blank">
                            <img align="absmiddle" src="../img_menu_principal/rel_gerencial.png"/>
                            <p><!--Relatório -->Controle de Acesso Por Escala</p>
                        </a>
                        <a class="bot_nv col-lg-2 col-md-4 col-sm-4 col-xs-6 valign-middle" href="relatorio_maquina.php" target="blank">
                            <img align="absmiddle" src="../img_menu_principal/rel_gerencial.png"/>
                            <p><!--Relatório -->Controle de Máquina</p>
                        </a>                        
