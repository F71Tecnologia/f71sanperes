...
if (isset($_REQUEST['gerar'])) {
	...
	$sql = "select
		...
		from rh_clt t
                inner join
		    terceiro_ponto p on t.pis = p.pis and t.pis is not null and t.pis <> '' 
...
$breadcrumb_config = array("nivel"=>"../", "key_btn"=>"40", "area"=>"Controle de Acesso", "id_form"=>"form1", "ativo"=>"Relatório Controle de Acesso");
