            ...
            <div class="detalhes-modulo">
                <div class="bs-glyphicons">
                    <div class="box-rh-list">
                        <a class="bot_nv col-lg-2 col-md-4 col-sm-4 col-xs-6 valign-middle" href="acesso_escala2.php" target="blank">
                        ...
                        <a class="bot_nv col-lg-2 col-md-4 col-sm-4 col-xs-6 valign-middle" href="relatorio_acesso_escala2.php" target="blank">
                            <img align="absmiddle" src="../img_menu_principal/rel_gerencial.png"/>
