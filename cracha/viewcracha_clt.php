...
$sql = "select count(t.id_funcionario) as total from funcionario t 
	where t.id_regiao = {$id_regiao};";
$res = mysql_query($sql);
...
$sql = "select t.id_funcionario, t.nome, t.foto from funcionario t 
	where t.id_regiao = {$id_regiao} limit 8 offset {$pag};";
...
<center>
	...
	<div id="duascol">
		...
		<table align="center" width="250px" cellspacing="0" cellpadding="12" style="font-size:13px; line-height:22px; padding: 10px;">
		    ...
		    <tr>
			<td style="text-align: center">
			    <?=gera_barras("*2000".$row['id_funcionario']."*")?>
			</td>
		    </tr>
