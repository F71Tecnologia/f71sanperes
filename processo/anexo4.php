...
if($row_prestador['imprimir'] < "5"){

print "

<script>

alert(\"Você não pode imprimir o ANEXO 4 sem ter gerado o ANEXO 3!\");
...
?>
     ...
     <h3 align="center"><font size="6"> ANEXO IV - Das Condi&ccedil;&otilde;es Comerciais</font></h3>
     <p align="center">&nbsp;</p>
     <p align="center">&nbsp;</p>
...
<p style="text-align:justify"><font size="4"> Além das regras contidas no Regulamento de Contratação de Obras e Serviços do <?php echo $row_vmaster['razao']?> deverão ser obedecidos os Princípios da Boa Fé e da Obrigatoriedade dos efeitos contratuais. A Contratada não poderá delegar ou transferir a terceiros a prestação de serviços ora pactuados. </font></p>
...
mysql_query("UPDATE prestadorservico SET imprimir = '6', contratado_por = '$id_user', contratado_em = '$data_b', acompanhamento = '3' WHERE id_prestador = '$id_prestador'") or die ("Erro no UPDATE<br><br>".mysql_error()) ;
