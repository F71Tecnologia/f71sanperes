...
<p> Pelo presente instrumento particular de prestação de serviços, de um lado <?php
$nomEmp -> nomeEmpresa(); 
 ?>, associação civil sem fins lucrativos, com sede <?=$row_prestador['endereco']?>, inscrita no CNPJ/MF sob o nº <?=$row_prestador['cnpj']?>, neste ato por seu representante legal, <?=$row_prestador['responsavel']?>, <?=$row_prestador['nacionalidade']?>,   <strong><?=$row_prestador['civil']?>, <?=$row_prestador['formacao']?></strong>, portador da Cédula de Identidade n.º <?=$row_prestador['rg']?>, inscrito no CPF/MF sob o n.º <strong>
<?=$row_prestador['cpf']?>
...
<ul>
 <li> <p>1.1	Para os fins do presente Contrato:</p>
 	  <p><strong>"Lei Aplicável"</strong> significa, em relação a qualquer procedimento, obrigação, responsabilidade e/ou circunstância, todas as leis, normas e padrões estabelecidos por órgão governamental ou regulador e geralmente adotados para o setor, bem como os princípios de auto-regulamentação regionais, nacionais ou internacionais, se aplicáveis a tais procedimentos, obrigações, responsabilidades e/ou circunstâncias;</p>
		...
		<p><strong>"Remuneração"</strong> significa os valores devidos à CONTRATADA pela CONTRATANTE, de acordo com o disposto na Cláusula 6;</p>
...
<p align="right" style="font-weight:bold;">1/5</p>
				...
				<p>(f)	as referências a determinado gênero estendem-se a todos os gêneros, ao passo que as referências no singular estendem-se ao plural e vice-versa; e</p>
		
				<p>(g)	os cabeçalhos são aqui inseridos apenas para conveniência, não devendo ser considerados na interpretação do presente Contrato.</p>     
               </li>
         </ul> 
      </li>      
      </ul>
    ...
    <ul> 
    	<li>
        	<p>3.1	A CONTRATADA prestará serviços descritos no <strong>Anexo II – Dos Serviços </strong>do presente Contrato, doravante denominados <strong>"Serviços"</strong>, observadas as Boas Práticas e, ainda, as disposições contidas no presente instrumento e os termos da Lei Aplicável.</p>
            <ul>
            	<li>
           			 <p>3.1.1	A prestação dos Serviços ora avençada não tem sob forma nenhuma ou sob qualquer pretexto caráter de exclusividade, podendo a CONTRATANTE utilizar-se de outras prestadoras de serviços a seu exclusivo critério.</p>
                </li>               
                
            </ul>
        </li>
        <li>
        <p>3.2	Sem prejuízo às demais obrigações assumidas pela CONTRATADA neste instrumento, esta prestará os Serviços em atendimento ao Padrão Adequado, devotando-lhes os mais altos padrões de técnica, zelo, especificações, padrões e critérios de qualidade, prioridade, atenção e tempestividade. </p>

		<p>3.3	A CONTRATADA fará com que as obrigações por ela ora assumidas sejam atendidas por uma equipe suficiente (com número de integrantes adequado) e devidamente qualificada, treinada e capacitada para esse propósito específico.</p>

		<p>3.4	A CONTRATADA abster-se-á da prática de atos que possam ocasionar qualquer espécie de dano ou prejuízo aos negócios ou à reputação da CONTRATANTE e/ou seus administradores.</p>
    ...
    <ul>	
    	<li>
        <p>4.1	Além das obrigações assumidas em outras cláusulas do Contrato, a CONTRATADA, neste ato, compromete-se e obriga-se a:</p>
        ...
        <ul>
			...
			<p>(c)	responsabilizar-se integralmente pela conduta, freqüência e pontualidade de seus funcionários envolvidos diretamente na execução dos Serviços, podendo a CONTRATANTE exigir substituições de funcionários a seu exclusivo critério;	</p>

			<p>(d)	afastar ou substituir o seu funcionário, cuja conduta ou presença seja considerada pela CONTRATANTE inconveniente, imediatamente após o recebimento de comunicação da CONTRATANTE, devendo providenciar sua imediata substituição por outro profissional devidamente qualificado e capacitado para a prestação dos Serviços;</p>

			<p>(e)	indenizar a CONTRATANTE por quaisquer danos ou prejuízos e responsabilizar-se integralmente por, mas não se limitando a, quaisquer obrigações e indenizações, perdas e danos, lucros cessantes, prejuízos de quaisquer espécies, ou sob quaisquer títulos, perdas de negócios, perda, avaria, danificação parcial ou total ou extravio de mercadorias, produtos, equipamentos, documentos, defeitos, ou quaisquer outros danos diretos, indiretos, acidentais, especiais, conseqüenciais ou punitivos, decorrentes direta ou indiretamente, da prestação dos Serviços; </p>
    ...
    <p>&nbsp;</p>
			<p>(g)	prestar contas à CONTRATANTE das atividades desenvolvidas na prestação dos Serviços, sempre que solicitado pela CONTRATANTE; </p>
			...
			<p>(i)	comprovar o atendimento de todas as exigências legais trabalhistas, previdenciárias, securitárias ou de outra natureza com relação aos funcionários que prestarão os Serviços, sempre que requisitado pela CONTRATANTE;</p>
        ...
        <li>
        	<p>4.2	Todos e quaisquer encargos decorrentes de condenação judicial, sejam trabalhistas, previdenciários e/ou fundiários, pertinentes aos profissionais que venham a ser indicados pela CONTRATADA para execução dos Serviços, serão de exclusiva responsabilidade da CONTRATADA, não respondendo a CONTRATANTE por tais encargos, sequer em caráter subsidiário, ficando certo que, entre o pessoal da CONTRATADA e a CONTRATANTE não há e não haverá nenhuma relação ou vínculo trabalhista.</p>

			<p>4.3	A CONTRATADA garante, desde já, os Serviços por ela prestados em razão deste contrato, quanto à qualidade, desempenho e funcionalidade, bem como contra todo e qualquer defeito, obrigando-se desde já a refazer, reparar ou repor toda a execução dos Serviços, assim como danos e prejuízos deles decorrentes.</p>
        </li>
    ...
    <ul>
    	<li>
			...
			<p>(b)	não deslocar os funcionários da CONTRATADA para execução de serviços fora do local estabelecido no presente Contrato sem o consentimento expresso e prévio da CONTRATADA.</p>
    ...
    <ul>
        ...
        <p>6.1	Os preços dos Serviços, durante a vigência deste instrumento, serão aqueles indicados no Anexo III – Da Remuneração, inclusos todos os Tributos incidentes e decorrentes deste Contrato.</p>
     	 <p> 6.2	Os preços dos Serviços conforme mencionado no Anexo III baseiam-se na legislação vigente na data da assinatura deste instrumento, computando todos os tributos incidentes à época. Fica expressamente estabelecido que quaisquer aumentos, reduções, modificações, criações, extinções ou isenções de tributos, decorrentes de alterações introduzidas na legislação federal, estadual ou municipal, a partir da data da assinatura deste instrumento e durante o período de sua vigência, desde que acordado entre CONTRATANTE e CONTRATADA, poderão ensejar uma majoração ou redução proporcional dos preços, a partir da data da vigência das novas disposições legais. Os eventuais ajustes de preços visarão sempre restabelecer o equilíbrio econômico-financeiro do contrato, tomando-se por base a data de sua assinatura.</p>

		<p>6.3	O prazo para pagamento das faturas pela CONTRATANTE é de 30 (trinta) dias, a contar da emissão da fatura pela CONTRATADA, contanto que tal fatura seja encaminhada à CONTRATANTE em até 10 (dez) dias contados da sua emissão.</p>

		<p>6.4	A comprovação da ocorrência dos eventos geradores de pagamento deverá ser efetuada através da apresentação dos documentos que demonstrem a efetiva realização da prestação dos Serviços em conformidade com o disposto neste instrumento, devidamente aprovados pela CONTRATANTE.</p>

		<p>6.5	Na hipótese de atraso injustificado pela CONTRATANTE no pagamento das faturas emitidas pela CONTRATADA, poderá esta última cobrar multa à taxa de 2% (dois por cento) bem como juros de 1% ao mês "pro rata die" até o efetivo pagamento dos valores em atraso.</p>

		<p>6.6	A CONTRATANTE não será responsável por qualquer outro pagamento alheio aos valores constantes do Anexo III, ou a qualquer outro título, por força do aqui disposto.</p>
        </li>
    </ul>
    ...
    <ul>	
        ...
        <li>
      	 <p> 7.2	Não obstante o disposto acima, ficará facultado à CONTRATANTE declarar rescindido o presente Contrato, a seu exclusivo critério, mediante aviso escrito nesse sentido, enviado à CONTRATADA com 30 (trinta) dias de antecedência, sem que caibam qualquer indenização à CONTRATADA. Serão quitados apenas os valores referentes a Serviços já prestados, observadas todas as disposições deste Contrato.</p>
         
         <p>7.3	Rescindido o presente Contrato por qualquer motivo, incumbe à CONTRATADA, se assim o exigir a CONTRATANTE, a adoção de todas as providências que venham a ser necessárias para que os Serviços continuem a ser disponibilizados à CONTRATANTE por outro prestador que esta indicar, assim que viável e com a menor interrupção possível nos negócios da CONTRATANTE. </p>
    ...
    <ul>
    	<li>
        <p>9.1	A CONTRATADA compromete-se a celebrar e formalizar todos os instrumentos, registros, certificações e demais documentos, bem como praticar todos os atos (e instar terceiros a também assim proceder, dentro de sua competência), conforme eventualmente necessário para levar a pleno vigor e efeito os propósitos do presente Contrato.  </p>
        <p>9.2	A CONTRATADA neste ato declara à CONTRATANTE expressamente possuir todas as licenças, inscrições, certificações, registros e tudo o mais exigido pela Lei Aplicável à plena, completa e satisfatória prestação dos Serviços, isentando a CONTRATANTE por qualquer questionamento, danos, indenizações, multas, prejuízos e/ou pagamentos efetuados pelas as autoridades ou órgão competentes relacionados à prestação dos Serviços.</p>
    ...
    <ul>
		...
		<p>10.3	Fica desde já facultado à CONTRATADA subcontratar quaisquer obrigações por ela ora assumidas, se houver motivos para crer que tais obrigações serão cumpridas em estrita observância aos critérios aqui previstos, mediante prévio consentimento da CONTRATANTE. </p>
        </li>
        <ul>
        	<li>
            <p>10.3.1	Na hipótese de subcontratação das obrigações ora atinentes à CONTRATADA: </p>

			<p>(a)	a CONTRATADA obterá do subcontratado seu compromisso em cumprir as obrigações que seriam de outra forma exigíveis da própria CONTRATADA, caso as correspondentes atividades não tivessem sido por ela subcontratadas;</p>

			<p>(b)	a CONTRATADA providenciará para que a CONTRATANTE possua direito de ação diretamente contra o subcontratado, caso este não cumpra suas obrigações perante a CONTRATADA (e, se possível, fazer com que a CONTRATANTE seja parte integrante de eventual instrumento de subcontratação); e</p>

			<p>(c)	a CONTRATADA permanecerá responsável por quaisquer atos ou omissões do subcontratado, como se tais atos ou omissões lhe fossem diretamente atribuíveis nos termos do presente Contrato.</p>
