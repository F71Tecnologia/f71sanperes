...
alert(\"Você não pode imprimir o ANEXO 1 sem ter GERADO O CONTRATO!\");
...
<p style="text-align:justify"><font size="4"> Conforme determinado no item 2 - Do Prazo de Vigência, e no subitem 2.1, onde determina que “o presente contrato entrará em pleno vigor na data de sua assinatura” e respeitando o contrato n.º <?php echo $row_prestador['numero']; ?> assinado pelo <?php echo $row_vmaster['razao']?> através da <?php echo $row_parceiro['parceiro_nome']; ?>, deverá o contrato de prestação de serviço ter vigência de 12 (doze) meses, podendo ser prorrogado por igual período, de acordo com o subitem 2.2 do presente contrato. </font></p>
