...
<p> Pelo presente instrumento particular de prestação de serviços, de um lado <strong><?php echo $row_master['razao']?></strong>, associação civil sem fins lucrativos, com sede <strong><?=$row_master['endereco']?></strong>, inscrita no CNPJ/MF sob o nº <?=$row_prestador['cnpj']?>, neste ato por seu representante legal, <strong><?=$row_master['responsavel']?></strong>, <strong><?=$row_master['nacionalidade']?></strong>,   <strong><?=$row_master['civil']?>, <?=$row_master['formacao']?></strong>, portador da Cédula de Identidade n.º <strong><?=$row_master['rg']?></strong>, inscrito no CPF/MF sob o n.º <strong>
<strong><?=$row_master['cpf']?></strong>
...
<ul>
 <li> <p>1.1	Para os fins do presente Contrato:</p>
  ...
  <table width="100%"><tr><td align="right"><b>1/6</b></td></tr></table> 
	...
	<p>&nbsp;</p>		           
  <table width="100%"><tr><td align="right"><b>2/6</b></td></tr></table> 
			<p>&nbsp;</p>
...
<p>&nbsp;</p>
<table width="100%"><tr><td align="right"><b>3/6</b></td></tr></table> 
...
<p>&nbsp;</p>
<table width="100%"><tr><td align="right"><b>4/6</b></td></tr></table>
	...
	<p>&nbsp;</p>
    <p>&nbsp;</p>
	<table width="100%"><tr><td align="right"><b>5/6</b></td></tr></table>              
