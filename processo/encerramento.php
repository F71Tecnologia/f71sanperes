...
mysql_query("UPDATE prestadorservico SET encerrado_por = '$id_user', encerrado_em = '$data_b', acompanhamento = '5' WHERE id_prestador = '$id_prestador'") or die ("Erro no UPDATE<br><br>".mysql_error()) ;

}else{ // AKI O PROCESSO É TERMINADO DE FORMA CORRETA, ONDE TODOS OS PAÇOS FORAM SEGUIDOS
