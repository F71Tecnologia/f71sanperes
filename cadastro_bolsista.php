...
<table cellpadding="0" cellspacing="1" class="secao">
  ...
  <tr >
    <td class="secao">Nº do Conselho:</td>
    <td>
	<input name="rg" type="text" id="rg" size="13" maxlength="14">
    </td>
    <td class="secao">Orgão Regulamentador:</td>
    <td>
...
$pai = $_REQUEST['pai'];
$mae = $_REQUEST['mae'];
$nacionalidade_pai = mysql_real_escape_string(trim(str_replace("'", "",$_REQUEST['nacionalidade_pai'])));
$nacionalidade_mae = mysql_real_escape_string(trim(str_replace("'", "",$_REQUEST['nacionalidade_mae'])));
