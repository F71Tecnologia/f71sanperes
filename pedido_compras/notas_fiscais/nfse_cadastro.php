        ...
        <div class="panel panel-default">
            <div class="panel-body"> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input id="codigoverificacao" name="codigoverificacao" method="post" type="text" class="form-control text-uppercase text-center validate[required]" value="<?= $nfse_arr['CodigoVerificacao'] ?>">
                    </div>
                </div>
                <div class="form-group">
