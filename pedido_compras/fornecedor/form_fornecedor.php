<form action="index.php" method="post" class="form-horizontal" id="form-fornecedor">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label for="tipo" class="col-sm-2 control-label">Tipo de Empresa</label>
                <div class="col-sm-5">
                    <?= montaSelect($optionsTipos, $cad_fornecedor['tipo'], 'name="tipo" id="tipo" class="form-control"'); ?>
                </div>
            </div>
            <div class="form-group">
                <label for="tipo" class="col-sm-2 control-label">Clasificação</label>
                <div class="col-sm-5">
                    <?= montaSelect($optionsClassificacao, $cad_fornecedor['tipo'], 'name="tipo" id="tipo" class="form-control"'); ?>
                </div>
            </div>
            <hr>
