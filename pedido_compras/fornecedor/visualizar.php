    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Visualizar Fornecedor</div>
                <?php require_once 'table_dados_fornecedor.php'; ?>
                <div class="panel-footer text-right">
                    <a href="index.php" class="btn btn-default"><i class="fa fa-reply"></i> Voltar</a>
                    <a href="index.php?method=print&id_fornecedor=<?= $cad_fornecedor['id_fornecedor'] ?>" target="_blank" class="btn btn-success"><i class="fa fa-print"></i> Imprimir</a>
                </div>
            </div>
