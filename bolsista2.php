...
if(!empty($_POST['classe']) AND $_POST['classe'] == 'autonomo'){
    ...
    if(mysql_num_rows($result_unidades) > 0){
        while ($row_unidades = mysql_fetch_array($result_unidades)) { ?>
            <button type="button" onclick="tableToExcel('tbRelatorio_a_<?=$row_unidades[0]?>', 'Relatório')" class="btn btn-success pull-right"><span class="fa fa-file-excel-o"></span>&nbsp;&nbsp;Exportar para Excel</button>
                ...
                <div class="tab-pane clt active">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            if(mysql_num_rows($result_unidades) > 0){
                                while ($row_unidades = mysql_fetch_array($result_unidades)) { ?>
                                    <button type="button" onclick="tableToExcel('tbRelatorio_<?=$row_unidades[0]?>', 'Relatório')" class="btn btn-success pull-right"><span class="fa fa-file-excel-o"></span>&nbsp;&nbsp;Exportar para Excel</button>
            ...
            $(function() {
                ...
                $("body").on("click", ".bt-upload-curriculo",function(){
                    ...
                    var message = $("<form>",{
                        ...
                        $('<p>',{ for:"file_curriculo", text:"Currículo" }),
                        $('<input>',{ type:"file", name:"file_curriculo", id:"file_curriculo", class:"validate[required,custom[docsType]]" }),
                        $('<p>',{ text:"Só serão aceitos currículos com extensão: png, jpg, pdf, doc e docx." }),
