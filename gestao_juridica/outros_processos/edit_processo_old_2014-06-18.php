    ...
    <table cellpadding="0" cellspacing="1" class="secao">
         ...
         <tr>
          ...
          <tr>
             ...
             <td colspan="7"><input name="nome" size="50" type="text" id="nome"  value="<?=$row_processo['proc_nome']?>" /></td>
          </tr>
          <tr>
             <td class="secao" >Nome:</td>
             <td colspan="7"><input name="nome1" size="50" type="text" id="nome1"  value="<?=$row_processo['proc_nome1']?>" /></td>
          </tr>
          <tr>
             <td class="secao" >Nome:</td>
             <td colspan="7"><input name="nome2" size="50" type="text" id="nome2"  value="<?=$row_processo['proc_nome2']?>" /></td>
          </tr>
