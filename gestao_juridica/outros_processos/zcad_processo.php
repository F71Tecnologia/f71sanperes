                ...
                <script type="text/javascript">
                    $(function() {
                        ...
                        $('#add_n_processo').click(function() {
                            ...
                            var campo = '<input name="n_processo[]" size="30" type="text" id="n_processo" " class="numero_processo"/> \n\
                                         <label>Ordem:</label><input name="ordem[]" type="text" size="2" />\n\
                                         <label>Tipo:</label>\n\
                                         <input type="radio" name="tipo_proc" value=""/><label>PJe</label>\n\
                                         <input type="radio" name="tipo_proc" value=""/><label>Outro</label>';
                        ...
                        <table align="center" width="100%" cellspacing="0" cellpadding="12" style="font-size:13px; line-height:22px;">
                            <tr>
                                <td><a href="#" onclick="history:back();"></a>
                                    ...
                                    ?>
                                    <?php //echo $_SERVER['PHP_SELF'] É PRA FICAR DENTO DO ACTION ?>
                                    <form action="" method="post" name="form1" 
                                        ...
                                        <table cellpadding="0" cellspacing="1" class="secao">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3"><input name="nome" size="50" type="text" id="nome"/></td>
                                            </tr>
                                            <tr>
                                                <td class="secao" >Nome:</td>
                                                <td colspan="3"><input name="nome1" size="50" type="text" id="nome1"/></td>
                                            </tr>
                                            <tr>
                                                <td class="secao" >Nome:</td>
                                                <td colspan="3"><input name="nome2" size="50" type="text" id="nome2"/></td>
                                            </tr>
                                            ...
                                            <?php if ($row_tipo_proc['proc_tipo_id'] == 5) { ?>
                                                <tr>
                                                    ...
                                                    <td colspan="3"><input type="text" name="n_oficio" id ="n_oficio"/></td>
                                                </tr>
                                            <?php } ?>
