...
$cep_empresa      = $Clt -> cep;
list($logradouro_empresa,$bairro_empresa,$cidade_empresa,$uf_empresa) = explode(' - ',$endereco_empresa);
...
// Multa de Atraso
if($row_rescisao['motivo'] != '63' and $row_rescisao['motivo'] != '64') {
...
<table id="rescisao" cellpadding="0" cellspacing="1">
  ...
  <tr>
    <td>
      ...
      <div class="valor"><?php echo $cidade_empresa; ?></div>
    </td>
    <td>
  ...
  <tr>
    <td><span class="numero">50</span> Saldo de <?php echo sprintf('%02d',$row_rescisao['dias_saldo']); ?> dias Sal&aacute;rio (l&iacute;quido de 0 faltas acrescidas do DSR)</td>
  ...
  <tr>
    ...
    <td><div class="valor">R$ <?php echo formato_real($row_rescisao['ad_noturno']); ?></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><span class="numero">69</span> Aviso-Pr&eacute;vio Indenizado</td>
  ...
  <tr>
  	<td align="center" colspan="6">
    	<?php 
			$qr_clt = mysql_query("SELECT agencia,conta FROM rh_clt WHERE id_clt = '{$id_clt}' LIMIT 1");
