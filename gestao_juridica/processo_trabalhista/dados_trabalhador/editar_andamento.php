...
$inserir = mysql_query("UPDATE proc_trab_andamento SET andamento_data_movi = '$data_andamento' ,
														andamento_horario  = '$horario'
													  WHERE andamento_id = '$id_andamento' LIMIT 1");
...
<body>
    <div id="corpo">
        ...
        <tr>
            ...
            <td><input name="data_andamento" type="text" value="<?php echo implode('/', array_reverse(explode('-',$row_andamento['andamento_data_movi']))); ?>" id="data"/></td>
        </tr>
        <?php if($row_andamento['proc_status'] <=6) {?>
         <tr>
        	<td class="secao">Horário</td>
            <td><input name="horario" type="text" value="<?php echo substr($row_andamento['andamento_horario'],0,5); ?>"  id="horario"/></td>
        </tr>
        <?php } ?>
        <tr>
