...
$qr_regiao  = mysql_query("SELECT * FROM rhempresa WHERE id_regiao = '$regiao'");
...
$Cabecalho  = $ClassDATA -> RegiaoLogado();
$Cabecalho .= ', ';
...
$valor_inss2               = $total_remuneracoes2;
$total_descontos2          = $x;
...
<body>
<?php
$pdf -> Image('../../../../rh/images/fundo_ferias.jpg', 0,0.9,20.4075,27.1771,'jpg');
...
$pdf -> SetXY(3.4,22.71);
$pdf -> Cell(0,0,$row_regiao['nome'] . " ( CNPJ: " . $row_regiao['cnpj'] . " )",0,0,'L');
...
echo "<script>location.href=\"arquivos/$nomearquivo\"</script>";
$pdf -> Close();
?>
</body>
</html>