                      ...
                      <tr>
                        ...
                        <td rowspan="3">
							<?php if(in_array($_COOKIE['logado'],array('5','9','68','75','82'))) { ?>
                            	<a href="index.php?deletar=true&id=<?php echo $id_ferias; ?>&enc=<?php echo $_GET['enc']; ?>" title="Desprocessar Férias" onclick="return window.confirm('Você tem certeza que quer desprocessar esta férias?');"><img src="../../../../rh/imagensrh/deletar.gif" /></a>
							<?php } ?>
                        </td>
                      </tr>
                      <tr>
