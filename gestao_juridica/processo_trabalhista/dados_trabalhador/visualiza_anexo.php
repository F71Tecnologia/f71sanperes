...
$i++;
	...
	echo '<a href="visualiza_anexo.php?id_anexo='.$id_pg_anterior.'&id_andamento='.$id_andamento.'" class="pg"> << Anterior </a>';
		...
		if($prox_pg == 1){			
			$proximo = '<a href="visualiza_anexo.php?id_anexo='.$row_total['andamento_anexo_id'].'&id_andamento='.$id_andamento.'" class="pg"> Próximo >> </a>';
			$prox_pg = 0;
		}
	...
	echo '<a href="visualiza_anexo.php?id_anexo='.$row_total['andamento_anexo_id'].'&id_andamento='.$id_andamento.'" class="pg"><span style="'.$color.'">'.$i.'</span></a>';
...
if(isset($_GET['id_andamento'])) {
	...
	echo '<img src="anexos/'.$row_anexo['andamento_anexo_nome'].'.'.$row_anexo['andamento_anexo_ext'].'" width="60%" height="60%"/>';
