            ...
            <link href="../../jquery/validationEngine/validationEngine.jquery.css" rel="stylesheet" type="text/css">
                ...
                <script type="text/javascript">
                    $(function() {
                        ...
                        $('.tipo_num_proc').attr('name','tipo_num_proc_' ).change(function() {
                            $('.numero_processo').attr('name',"n_processo_" ).unmask();
                            $('.numero_processo').attr('name',"n_processo_"  ).val("");
                            if ($(this).attr({checked: "checked"})) {
                                if ($(this).val() == "PJe") {
                                    $('.numero_processo').attr('name',"n_processo_").mask('99-99.99.99.99.99');
                                } else if ($(this).val() == "OUTRO") {
                                    $('.numero_processo').attr('name',"n_processo_").mask('9999999-99.9999.9.99.9999');
                                }
                            }
                        });
                        ...
                        $("#add_n_processo").click(function() {
                            ...
                            var cloned = $('.a2:first').clone()
                                    .find('input:radio').attr('name', 'tipo_num_proc_' + cont).end()
                                    .find(".numero_processo").attr('name',"n_processo_" + cont).unmask().val("").end();
                       //     var seila = $('.numero_processo').attr('name',"n_processo_" + ++p ).unmask().val("").end();
                            $(cloned).appendTo("#campos_n_processo");
                       //     $(seila).appendTo("#campos_n_processo");
                       cont++;
                        });
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div id="campos_n_processo">
                                                        <div class="a2">
                                                            <p><label>Tipo:</label>
                                                                <input type="radio" name="tipo_num_proc_1" value="PJe" class="tipo_num_proc"/><label>PJe</label>
                                                                <input type="radio" name="tipo_num_proc_1" value="OUTRO" class="tipo_num_proc"/><label>OUTRO</label>
                                                            </p>

                                                            <input name="n_processo_1" size="25" type="text" id="n_processo1" class="numero_processo" />
                                                            <label id="lOrdem">Ordem:</label><input name="ordem_1" id="ordem1" type="text" size="2"/>
                                                        </div>
                                                    </div>
                                                </td>
