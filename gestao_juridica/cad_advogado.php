                        ...
                        <div class="panel-heading"> DADOS</div>
                            <div class="panel-body"> 
                                <form action="<?php echo $_SERVER['PHP_SELF'] ?>?regiao=<?php echo $regiao ?>" class="form-horizontal" method="post" name="form1" 
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Estagi&aacute;rio:</label>
                                        <div class="col-sm-2">
                                            <div class="input-group">
                                                <label class="input-group-addon">
                                                    <input type="radio" name="estagiario" value="1" />
                                                </label>
                                                <label type="text" class="form-control">Sim</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="input-group">
                                                <label class="input-group-addon">
                                                    <input name="estagiario" type="radio" value="2" />
                                                </label>
                                                <label type="text" class="form-control">Não</label>
                                            </div>
                                        </div>
                                    </div>
