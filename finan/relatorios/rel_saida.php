...
$breadcrumb_config = array("nivel"=>"../", "key_btn"=>"4", "area"=>"Financeiro", "id_form"=>"form1", "ativo"=>"Relatório de Saídas");
...
<html lang="pt">
    <head>
        ...
        <title>:: Intranet :: Relatório de Saídas</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header box-financeiro-header"><h2><span class="glyphicon glyphicon-usd"></span> - Financeiro<small> - Relatório de Saídas</small></h2></div>
            <form action="" method="post" class="form-horizontal top-margin1" name="form1" id="form1">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">Relatório de Saídas</div>
            ...
            <div class="alert alert-dismissable alert-warning col-lg-6">                
                TOTAL DE SAÍDAS: <?php echo "{$dataIni} a {$dataFim}: <strong> " . formataMoeda($valor_total1) . "</strong>"; ?>
            </div>
