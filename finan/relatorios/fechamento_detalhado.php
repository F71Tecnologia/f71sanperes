...
$breadcrumb_config = array("nivel"=>"../", "key_btn"=>"4", "area"=>"Financeiro", "id_form"=>"form1", "ativo"=>"Relatório Mensal Descritivo Detalhado");
...
<html lang="pt">
    <head>
        ...
        <title>:: Intranet :: Relatório Mensal Descritivo Detalhado</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header box-financeiro-header"><h2><span class="glyphicon glyphicon-usd"></span> - Financeiro<small> - Relatório Mensal Descritivo Detalhado</small></h2></div>
            <form action="" method="post" class="form-horizontal top-margin1" name="form1" id="form1">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">Relatório Mensal Descritivo Detalhado</div>
