...
$breadcrumb_config = array("nivel"=>"../", "key_btn"=>"4", "area"=>"Financeiro", "id_form"=>"form1", "ativo"=>"Relatório Anual Descritivo");
...
<html lang="pt">
    <head>
        ...
        <title>:: Intranet :: Relatório Anual Descritivo</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header box-financeiro-header"><h2><span class="glyphicon glyphicon-usd"></span> - Financeiro<small> - Relatório Anual Descritivo</small></h2></div>
            <form action="" method="post" class="form-horizontal top-margin1" name="form1" id="form1">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">Relatório Anual Descritivo</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <select name="tipo" id="tipo" class="form-control">
                                    ...
                                    <option value="saida" <?=selected("saida", $tipoR); ?>>Saída</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
