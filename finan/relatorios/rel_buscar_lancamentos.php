...
$breadcrumb_config = array("nivel"=>"../", "key_btn"=>"4", "area"=>"Financeiro", "id_form"=>"form1", "ativo"=>"Buscar Lançamentos");
...
<html lang="pt">
    <head>
        ...
        <title>:: Intranet :: Buscar Lançamentos</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header box-financeiro-header"><h2><span class="glyphicon glyphicon-usd"></span> - Financeiro<small> - Buscar Lançamentos</small></h2></div>
...
<!--                            <label for="select" class="col-sm-1 control-label text-sm no-padding-l">Nº Registros</label>
                            <div class="col-sm-3">
                    ...
                    <div class="panel-footer text-right">
                        <button type="button" id="imprimir" value="Imprimir " class="btn btn-default"><i class="fa fa-print"></i> Gerar Borderô</button>
