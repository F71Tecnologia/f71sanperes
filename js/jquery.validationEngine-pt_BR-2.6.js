        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "ajaxUser":{
                    ...
                    "alertTextOk":"* Este usuário esta liberado",
                    "alertTextLoad":"* Carregando, aguarde",
                    "alertText":"* Este usuário já está sendo utilizado"
                },
                "ajaxName":{
...
//                        }
                    ...
                    "alertText": "PIS inválido",
                    "alertTextOK": "PIS válido"
                },
               "docsType": {
                   "regex": /png|jpg|doc|docx|pdf$/,
                   "alertText": "* Tipo do documento não suportado"
                },
                "auxDistancia": {
