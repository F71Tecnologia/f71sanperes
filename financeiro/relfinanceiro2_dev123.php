...
<table border='0' align='center' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF' class="conteudo">
  ...
  <tr>
    ...
    <table width="100%" align='center' cellpadding="3" cellspacing="1" id="tableOrden">
      ...
      <tr bgcolor="#999999">
      	<th>&nbsp;</th>
        <th><div align='center'><font size=1><b>CÓDIGO SAIDA</b></font></div></th>
        <th><div align='center'><font size=1><b>DATA DE RECEBIMENTO</b></font></div></th>
        <th><div align='center'><font size=1><b>NOME DO CRÉDITO</b></font></div></th>
		<th><div align='center'><font size=1><b>ESPECIFICAÇÃO</b></font></div></th>
...
$link_encryptado = $row[0];

//$link_encryptado_pg = encrypt('ID='.$row[0].'&tipo=1');
$link_encryptado_pg = $row[0];
...
<tr bgcolor=<?=$color?>> 
        ...
        <table border="0">
            <tr>
                ...
                <?php 
                $href = (($id_user == '87' ? "../novoFinanceiro/view/edicao.saidas.php?ID=$row[0]" : "../novoFinanceiro/view/edicao.saidas.php?ID=$row[0]"));?>
                <!-- <a title="Editar saida"  href="cad_edit_saida.php?ID=<?=$row[0]?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe', width: 580 } )" ><img src="imagensfinanceiro/page_edit-32.png" /></a></td>
               -->

               <a title="Editar saida"  href="cad_edit_saida.php?ID=<?=$row[0]?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe', width: 580 , height: 200} )" ><img src="imagensfinanceiro/page_edit-32.png" /></a></td>
...
<table border='0' align='center' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF' class="conteudo">
  ...
  <tr>
    <td colspan='2'><div align='center'><b>CONTROLE DE SAÍDAS DE CAIXA - <?=$row_pr3['nome']?></b></div></td>
  </tr>
  <tr>
    <td colspan='2'><table width="100%" align='center' cellpadding="3" cellspacing="1" id="tableOrden">
      <tr bgcolor="#999999">
        <th width="4%">&nbsp;</th>
        <th width="3%"><div align='center'><font size=1 face=Arial><b>CÓDIGO SAÍDA</b></font></div></th>
        <th width="5%"><div align='center'><font size=1 face=Arial><b>DATA</b></font></div></th>
		<th width="28%"><div align='center'><font size=1 face=Arial><b>NOME DO DÉBITO</b></font></div></th>
		<th width="16%"><div align='center'><font size=1 face=Arial><b>CADASTRADA POR</b></font></div></th>
        <th width="13%"><div align='center'><font size=1 face=Arial><b>ESPECIFICAÇÃO</b></font></div></th>
...
<tr bgcolor=<?=$color?>>
        ...
        <td class=border2><font size=1 face=Arial>R$ <?=$adicional?></font></td>
        <td class=border2><font size=1 face=Arial>R$ <?=  $row[0].' ** '.$row['valor']?></font></td>
      </tr>
<?php
...
?>
      <tr>
        <td colspan='8'><div align='right' class='style12'>TOTAL DE SAÍDAS DO CAIXINHA <?=$data_ini?> a <?=$data_fim?>:</div></td>
...
<table border='0' align='center' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF' class="conteudo">
  ...
  <tr>
	...
	<table width="100%" align='center' cellpadding="3" cellspacing="1" id="tableOrden">
      <tr bgcolor="#999999">
       <th>&nbsp;</th>
       <th><div align='center'><font size=1 face=Arial><b>CÓDIGO ENTRADA</b></font></div></th>
       <th><div align='center'><font size=1 face=Arial><b>DATA DE </b></font></div></th>
       <th><div align='center'><font size=1 face=Arial><b>NOME DO CRÉDITO</b></font></div></th>
       ...
       <th><div align='center'><font size=1 face=Arial><b>DESCRIÇÃO</b></font></div></th>
...
<table width="100%" align='center' cellpadding='0' cellspacing='0' id="tableOrden">
  <tr>
    <td colspan='12'><div align='center'><b>CONTROLE DE SAIDA </b></div></td>
      ...
      <tr bgcolor="#999999">
        <th >&nbsp;</th>
       <th ><div align='center'><font size=1 face=Arial>CÓDIGO SAÍDA</font></div></th>
       <th><div align='center'><font size=1 face=Arial>DATA DE RECEBIMENTO</font></div></th>
       <th><div align='center'><font size=1 face=Arial>NOME DO CRÉDITO</font></div></th>
       <th><div align='center'><font size=1 face=Arial>CONTA DEBITADA</font></div></th>
       <th><div align='center'><font size=1 face=Arial>TIPO DE SAÍDA</font></div></th>
       ...
       <th><div align='center'><font size=1 face=Arial>DESCRIÇÃO</font></div></th>
...
<tr bgcolor=<?=$color?>>
  <td class=border2>
  	<table border="0">
        	...
        	<td>
                 ...
                 ////ESTE ARRAY CONTÉM OS TIPOS DE SAÌDA QUE SÒ PODEM SER EDITADO A DATA DE VENCIMENTO Ex: RESCISÔES QUE VEM DOS "PAGAMENTOS" NA 
                    //GESTÃO DE RH
                     ...
                     $array_nao_editaveis = array(168,167,169, 170,175,156,154,32, 31, 30,29,171, 260);
        ...
        <td class=border2><font size='1' face=Arial> <?= $row2[0].' / '.$row2['valor']?></font></td>
      </tr>
<?php
...
?>
      <tr>
        <td colspan='11'><div align='right' class='style12'>TOTAL DE SAÍDAS</div></td>
...
<table border='0' align='center' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF' class="conteudo">
  ...
  <tr>
    <td colspan='2'><table width="100%" align='center' id="tableOrden">
      <tr bgcolor="#999999">
      	<th>&nbsp;</th>
      <th><div align='center'><font size=1 face=Arial>CÓDIGO ENTRADA</font></div></th>
       <th><div align='center'><font size=1 face=Arial>DATA DE RECEBIMENTO</font></div></th>
        <th><div align='center'><font size=1 face=Arial>NOME DO CRÉDITO</font></div></th>
