                ...
                <div class="col-lg-12">
                    ...
                    <div class="bs-component" role="tablist">
                        <ul class="nav nav-tabs nav-justified" style="margin-bottom: 20px;">
                            <li class="active"><a class="contabil" href="#conciliacao" data-toggle="tab">Lançamentos</a></li>
                            ...
                            <form action="classificacao_controle.php" method="post" name="form_consulta_conciliacao" id="form_consulta_conciliacao" class="form-horizontal top-margin">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-footer text-right">
                                        <!--<button type="button" class="btn btn-info btn-sm disabled" id="btn_editar"><i class="fa fa-pencil"></i> Alterar Lançamentos</button>-->
                                        <button type="button" class="btn btn-success btn-sm add_lancamento"><i class="fa fa-plus"></i> Lançamento</button>
