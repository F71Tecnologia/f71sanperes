...
//        // calcula o numero de publicação pegando como base a data de abertura da empresa
//        $this->mn = 2016 - 2012;
//        
//    }
}
...
$texto = "Este Livro Contém {nb} Folhas Numeradas de 1 a {nb}, emitidas por processo eletrônico de dados, de acordo com a lei número 8.981/95, art. 45, parágrafo único e servirá de Livro Diário de movimentação numérica 4 da empresa o numero NIRE: 00.0.0000000-0, em 31/05/2012. Pela Junta Comercial do Estado de São Paulo. Do período de 01 de Janeiro de " .$ano. " a 31 de dezembro de $ano. Com folhas numeradas apenas no averso.";
...
$pdf->Cell(9.5, .5, "SÓCIO ADMINISTRADOR",0,0,'C');
$pdf->Ln();
...
$pdf->Ln();
$pdf->SetFont('Arial','',8);
$pdf->Cell(19,.8,"Outubro /2015 à Dezembro /2015 ",0,0,'C');
...
$pdf->SetFont('Arial','B',12);
$pdf->Cell(19,.3,"Demonstrativo de Resultado do Exercício",0,0,'C');
$pdf->Ln();
$pdf->SetFont('Arial','',9);
//$pdf->Cell(19,.8,"Mês: " . mesesArray($mes) . "/{$ano}",0,0,'C');
$pdf->Cell(19,.8,"Outubro /2015 à Dezembro /2015 ",0,0,'C');
