...
$breadcrumb_config = array("nivel" => "../", "key_btn" => "38", "area" => "Gestão Contabil", "ativo" => "Importar Plano de Contas", "id_form" => "frmplanodeconta");
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body div-lista-filtro">
                            <legend>Selecionar projeto a qual as contas serão importadas</legend>
