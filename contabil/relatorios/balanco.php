...
if (isset($_REQUEST['ano']) && isset($_REQUEST['projeto']) && isset($_REQUEST['filtrar']) && $_REQUEST['projeto'] > 0) {
    $array = $objClassificador->balanco($projeto, $ano, 12, true);
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <?php if (isset($_REQUEST['ano']) && isset($_REQUEST['projeto']) && isset($_REQUEST['filtrar']) && $_REQUEST['projeto'] > 0) { ?>
