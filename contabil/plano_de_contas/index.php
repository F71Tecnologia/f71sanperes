...
$nome_pagina = "Plano de Contas ( SPED )";
$breadcrumb_config = array("nivel" => "../../", "key_btn" => "38", "area" => "Gestão Contabil", "ativo" => $nome_pagina, "id_form" => "formplanodecontas");
...
<html lang="pt">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header box-contabil-header"><h2><span class="fa fa-align-right"></span> - Plano de Contas Padrão SPED</h2></div>
                    <div class="bs-component">
                        <div class="detalhes-modulo">
                            <?php echo $botoes->getHtmlBotoesModulo(47, 38) ?>
                        </div>
                    </div> 
                </div>
            </div>
