...
$OpcaoFolha = $objAssociar->consultafolha();
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header box-contabil-header">
                        <h2><span class="glyphicon glyphicon-briefcase"></span> - Contabilidade <small>- Folha de Pagamento</small></h2>
                    </div>
