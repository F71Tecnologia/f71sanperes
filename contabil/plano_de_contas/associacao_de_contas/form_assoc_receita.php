...
$OpcaoReceita = $objAssociar->consultaentrada();
$OpcaoAcesso = $objAcesso->getPlanoAcesso($_REQUEST['projeto']);

//$sqlPlanoContas = "SELECT * FROM contabil_planodecontas WHERE id_projeto = '{$_REQUEST['projeto']}' ORDER BY classificador";
$sqlPlanoContas = "SELECT * FROM contabil_planodecontas WHERE id_projeto IN(0,{$_REQUEST['projeto']}) ORDER BY classificador";
...
$contaAtivoPassivo = montaSelect($ops_contas['ativo_passivo'], NULL, 'name="conta_ap" class="form-control"');
$contaResultado = montaSelect($ops_contas['resultado'], NULL, 'name="conta_dre" class="form-control"');
?>
<!DOCTYPE html>
<html lang="pt-br">
    <head>
        ...
        <title>:: Intranet :: Associação Receita</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header box-contabil-header">
                        <h2><span class="glyphicon glyphicon-briefcase"></span> - Contabilidade <small>- Receita</small></h2>
                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <label for="" class="col-lg-2 control-label">Financeiro</label>
                                            <div class="col-lg-7">
                                                <select class="form-control" name="conta_f" id="conta_f">
                                                    <?php foreach ($OpcaoReceita as $key => $value) { ?>
                                        ...
                                        <div class="form-group">  
                                            <label class="control-label col-lg-2">Ativo / Passivo </label>
                                            <div class="col-xs-7">
                                                <?= $contaAtivoPassivo ?>
                                            </div>
                                        </div>
                                        <div class="form-group">  
                                            <label class="control-label col-lg-2">D R E</label>
                                            <div class="col-xs-7">
                                                <?= $contaResultado ?>
                                            </div>
                                        </div>                                        
