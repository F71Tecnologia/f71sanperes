...
////$optFolha["10001"] = "FÉRIAS - IR";
////$optFolha["10002"] = "FÉRIAS - INSS";
////$optFolha["10003"] = "FÉRIAS - LÍQUIDO";
////$optFolha["10004"] = "FÉRIAS - ADIANTAMENTO";
////$optFolha["20001"] = "RESCISÃO - AVISO PRÉVIO";
////$optFolha["20002"] = "RESCISÃO - IRRF SALDO DE SALÁRIO";
////$optFolha["20003"] = "RESCISÃO - SALDO";
////$optFolha["20004"] = "RESCISÃO - 13ºSAL (AVISO-PRÊVIO IDENIZADO)";
////$optFolha["20005"] = "RESCISÃO - SALDO DE SALÁRIO";
////$optFolha["20006"] = "RESCISÃO - FÉRIAS PROPORCIONAIS";
////$optFolha["20007"] = "RESCISÃO - FÉRIAS VENCIDAS";
////$optFolha["20008"] = "RESCISÃO - 1/3 CONSTITUCIONAL DE FÉRIAS";
////$optFolha["20009"] = "RESCISÃO - 13º SALÁRIO";
////$optFolha["20010"] = "RESCISÃO - GRATIFICAÇÕES";
////$optFolha["20011"] = "RESCISÃO - INSALUBRIDADE";
////$optFolha["20012"] = "RESCISÃO - PREVIDÊNCIA SOCIAL (INSS SALDO DE SALÁRIO)";
////$optFolha["20013"] = "RESCISÃO - PREVIDÊNCIA 13º SALÁRIO";
//while($rowFolha = mysql_fetch_assoc($qryFlPagamento)){
//    $optFolha[(int) $rowFolha['cod']] = $rowFolha['descicao']. ' ( '.$rowFolha['cod'].' )';
//}

$sqlTipos = "SELECT id_entradasaida, nome FROM entradaesaida WHERE grupo >= 5 ORDER BY grupo, nome";
...
$sqlPlanoContas ="SELECT A.id_conta, A.tipo, A.classificador, A.descricao, A.sped, B.nome 
                    FROM contabil_planodecontas A
                    LEFT JOIN projeto B ON(B.id_projeto = A.id_projeto)
                    WHERE (data_fim >= DATE(NOW()) OR data_fim = '0000-00-00') AND A.id_projeto IN(" . implode(', ', $inProjetos) . ") AND A.status = 1 
