<ul class="nav nav-tabs nav-justified hidden-print" style="margin-bottom: 20px;">
    ...
    <li><a class="contabil" href="#contas_empresas" data-toggle="tab">Contas Empresas</a></li>
    <li><a class="contabil" href="#contas_sped" data-toggle="tab">Contas ( SPED )</a></li>
</ul>

<div class="tab-content"> 

    <div class="tab-pane" id="contas_empresas">
        <form action="planodecontas_controle.php" method="post" name="form_planocontas_empresa" id="form_planocontas_empresa" class="form-horizontal top-margin" enctype="multipart/form-data">
            <div class="panel panel-default hidden-print">
                <div class="panel-body">
                    ...
                    <div class="col-lg-2">
                        <button type="submit" class="btn btn-default" id="empresa_planoconta" name="empresa_planoconta" value="empresa_planoconta">
    ...
    <div class="tab-pane" id="contas_sped">
                ...
                <div class="panel-body">
                    <div class="col-lg-12">
                        ...
                        foreach ($nivel as $value) {
                            list($key1, $key2, $key3, $key4, $key5, $key6, $key7) = explode('.', $value['classificador']);
                            if ($value['nivel'] == 2 && $k[1] == '') {
                                $key1 = '';
                            }
                            if ($value['nivel'] == 3 && $k[2] == '') {
                                $key2 = '';
                            }
                            if ($value['nivel'] == 4 && $k[3] == '') {
                                $key3 = '';
                            }
                            if ($value['nivel'] == 5 && $k[4] == '') {
                                $key4 = '';
                            }
                            if ($value['nivel'] == 6 && $k[5] == '') {
                                $key5 = '';
                            }
                            if ($value['nivel'] == 7 && $k[6] == '') {
                                $key6 = '';
                            }
                            ...
                            <div class="panel panel-<?= $cor ?> margin_b5 <?= ($value['nivel'] == 1) ? 'pointer nivel' : null ?> n<?= $classeN ?>" data-n="<?= $value['nivel'] ?>" data-k1="<?= $key1 ?>" data-k2="<?= $key2 ?>" data-k3="<?= $key3 ?>" data-k4="<?= $key4 ?>" data-k5="<?= $key5 ?>" data-k6="<?= $key6 ?>" data-k7="<?= $key7 ?>" style="display: <?= ($value['nivel'] > 1) ? 'none' : null ?>">
                                <div class="panel-heading" style="padding-left: <?= 30 * $value['nivel'] ?>px;"><?= $value['classificador'] . ' - ' . $value['descricao'] ?></div>
                            </div>
                            <?php
                            $k[1] = $key1;
                            $k[2] = $key2;
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="descricao" id="descricao" maxlength="70" class="col-lg-8 text text-left form-control validate[required]"> 
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-lg-2 control-label">Código Reduzido</label>
                        <div class="col-lg-3">
                    ...
                    <div class="form-group">
                        <label for="" class="col-lg-2 control-label">Saldo Inicial</label>
                        <div class="col-lg-3">
                            <input type="text" name="saldo_inicial" id="saldo_inicial" maxlength="20" class="valor text-uppercase text-left form-control"> 
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-inline">
                            <label class="text-slim text-danger col-lg-2"><input type="radio" name="natureza" id="natureza" value="C" class="validate[required]">Credora</label>
                        </div> 
                        <div class="radio-inline">
                            <label class="text-slim text-info"><input type="radio" name="natureza" id="natureza" value="D" class="validate[required]">Devedora</label>
                        </div>
                    </div>
                </div>
