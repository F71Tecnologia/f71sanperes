...
<table align="center" width="100%" cellspacing="0" cellpadding="12" style="font-size:13px; line-height:22px;">
  ...
  <div style="border-bottom:2px solid #F3F3F3; margin-top:10px;">
       <h2 style="float:left; font-size:18px;">VISUALIZAR <span class="clt">CLT</span></h2>
       <p style="float:right;">
       <?php if($_GET['sucesso'] == 'cadastro') { ?>
  ...
  <td colspan="2" class="menu">
    ...
    ?>
    <!-- linha 1 -->
    <p><a href="alter_clt.php?clt=<?=$row['0']?>&pro=<?=$id_pro?>&pagina=<?=$pagina?>" class="botao">Editar</a>
       <a href="../tvsorrindo.php?bol=<?=$row['id_antigo']?>&clt=<?=$row['0']?>&pro=<?=$id_pro?>&tipo=2" target="_blank" class="botao">TV Sorrindo</a>
       <a href="../rendimento/index.php?clt=<?=$row['0']?>&pro=<?=$id_pro?>&id_reg=<?=$id_reg?>" class="botao" target="_blank" style="font-size:12px;">Informe de Rendimento</a></p>
    <!-- linha 2 -->
    <p><a href="../ctps.php?regiao=<?=$id_reg?>&id=1&clt=<?=$row['0']?>" target="_blank" class="botao">Receber CTPS</a>
       <a href="<?=$link_ctps?>" target="_blank" class="botao">Entregar CTPS</a>
       <a href="solicitapis_pdf.php?pro=<?=$id_pro?>&id_reg=<?=$id_reg?>&clt=<?=$row['0']?>" target="_blank" class="botao" style="display:<?=$statusBotao?>">Cadastro PIS</a></p>
    <!-- linha 3 -->
    ...
    <p><a href="../rh/notifica/advertencia.php?clt=<?=$row['0']?>&tab=bolsista<?=$id_pro?>&pro=<?=$id_pro?>&id_reg=<?=$id_reg?>" target="_blank" class="botao">Advertência</a>
       <a href="../rh/notifica/form_suspencao.php?clt=<?=$row['0']?>&tab=bolsista<?=$id_pro?>&pro=<?=$id_pro?>&id_reg=<?=$id_reg?>" target="_blank" class="botao">Suspenção</a>
       <a href="../relatorios/fichafinanceira.php?reg=<?=$id_reg?>&pro=<?=$id_pro?>&tipo=2&tela=2&id=<?=$row['0']?>" target="_blank" class="botao">Ficha Financeira</a></p>
    <!-- linha 6 -->
