...
$result_bolsista = mysql_query("SELECT * FROM bolsista$projeto where id_bolsista = '$row_vale[id_bolsista]'");
...
$result_bolsista2 = mysql_query("SELECT * FROM bolsista$projeto where id_bolsista = '$row_vale2[id_bolsista]'");
