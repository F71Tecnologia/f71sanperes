...
<div id="corpo">
  ...
  <br>
        ...
        <tr height="32">
          ...
          <form action="direcaoadmefin.php" method="post" name="form1">
          ...
          <br /><br />
            <div align="center">
              <p>APÓS ANÁLISE DOS ANEXOS CITADOS ACIMA ENCAMINHO PARA O SETOR DE COMPRAS.</p>
<p>&nbsp;</p>
              <p>
...
mysql_query("UPDATE compra2 SET acompanhamento='5' where id_compra = '$pedido' LIMIT 1") or die ("<center>ERRO!<br> tente novamente mais tarde<br><br>".mysql_error());


header("Location: ver_direcaoadmefin.php?compra=$pedido&regiao=$regiao ");
}
