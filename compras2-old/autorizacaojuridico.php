...
<div id="corpo">
  ...
  <br>
        ...
        <tr height="32">
          ...
          <form action="autorizacaojuridico.php" method="post" name="form1">
...
mysql_query("UPDATE compra2 SET acompanhamento='3' where id_compra = '$pedido' LIMIT 1") or die ("<center>ERRO!<br> tente novamente mais tarde<br><br>".mysql_error());


header("Location: ver_autorizacaojuridico.php?compra=$pedido&regiao=$regiao ");
}
