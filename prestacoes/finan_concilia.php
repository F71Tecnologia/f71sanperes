...
if (isset($_REQUEST['uploadArquivos']) && !empty($_REQUEST['uploadArquivos'])) {
    ...
    if (isset($_FILES['cc'])) {
        ...
        if ($enviar['erro']) {
            echo "<div id='message-box' class='message-red'>Erro ao enviar o arquivo de Conta Corrente. Descrição do erro: {$enviar['erro']}";
            exit;
        } else {
    ...
    if (isset($_FILES['cp'])) {
        ...
        if ($enviar['erro']) {
            echo "<div id='message-box' class='message-red'>Erro ao enviar o arquivo de conta Poupança. Descrição do erro: {$enviar['erro']}";
            exit;
        } else {
...
<?php if (!empty($result)) { ?>
                    ...
                    <table id="tbRelatorio" border="0" cellpadding="0" cellspacing="0" width="900" class="grid">
                        <thead>
                            ...
                            <tr>
                                <th colspan="4">CONCILIAÇÃO BANCÁRIA</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="subtitulo">
                            ...
                            <tr class="subtitulo">
                                <td class="txright">Período de Referencia:</td>
                            ...
                            <tr class="titulo">
                                <td colspan="4" class="txcenter">A - SALDO CONFORME EXTRATO BANCÁRIO EM <?php echo $ultimoDiaMes ?></td>
                            </tr>
                            <tr class="subtitulo">
                                <td colspan="3" class="txcenter">DESCRIÇÃO:</td>
    ...
    if ($showValues) {
        ...
        ?><input type="text" name="a2" id="a2" value="" size="10" class="valor"/><?php } ?> </td>
                            ...
                            <tr class="titulo">
                                <td colspan="4" class="txcenter">B - AVISOS DE CRÉDITO NÃO LANÇADOS NO EXTRATO</td>
                            </tr>
                            <tr>
                                <td colspan="4">
                                    <!-- SUBTABELA -->
    ...
    ?>
                            ...
                            <tr class="titulo">
                                <td colspan="4" class="txcenter">C - CHEQUES EMITIDOS E NÃO DESCONTADOS</td>
                            </tr>
                            <tr>
                                <td colspan="4">
                                    <!-- SUBTABELA -->
                            ...
                            <tr class="titulo">
                                <td colspan="4" class="txcenter">D - AVISOS DE DÉBITO NÃO LANÇADOS NO EXTRATO</td>
                            </tr>
                            <tr>
                                <td colspan="4">
                                    <!-- SUBTABELA -->
                            ...
                            <!-- SALDO TOTAL -->
                            <tr class="titulo">
                                <td colspan="3" class="txright-i">E- SALDO CONTÁBIL (A3+B1-C1-D1)</td>
