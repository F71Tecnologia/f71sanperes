                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <form action="associacaocontas.php" method="post" name="form1" id ="form1" class="form-horizontal">
                            ...
                            <hr>
                            <div class="form-group text-semibold text-center">
                                <label class="col-lg-12 control-label">Despesas</label>
                            </div>
                            <div class="form-group">
...
<!--                                <input class="btn btn-primary" type="submit"  name="consultal" id="cancelar" value="Cancelar"/>                                 -->
                            </div>
                        </form>  
                    </div>
                    <div id="resposta"></div>
