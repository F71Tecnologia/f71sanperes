...
$nome_pagina = "Integração Sistema Prosoft";
...
<html lang="pt">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header box-contabil-header"><h2><span class="fa fa-briefcase"></span> - Integração com sistema Prosoft</h2></div>
                    <div class="bs-component">
                        <div class="detalhes-modulo">
                            <?php echo $botoes->getHtmlBotoesModulo(44,38) ?>
                        </div>
                    </div>
                </div>
            </div>
