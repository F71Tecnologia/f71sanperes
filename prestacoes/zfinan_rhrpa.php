...
if (isset($_REQUEST['projeto'])) {
    ...
    if ($historico === false) {
        ...
        $qr = "SELECT *, conselho AS numconselho, num_rpa AS id_rpa, categoria_prof AS nomeCbo, cargo AS funcao, cbo AS cod, valor AS valor_liquido  FROM prestacoes_contas_rhrpa WHERE id_prestacao = {$historico}";
//        print_r($qr);exit;
    }
        ...
        <div id="content">
            <form action="" method="post" name="form1" id="form1">
                ...
                <fieldset class="noprint">
                    ...
                    <p id="mensal" ><label class="first">Mês:</label> <?php echo montaSelect($meses, $mesR, "id='mes' name='mes' class='validate[custom[select]]'") ?>  <?php echo montaSelect($anos, $anoR, "id='ano' name='ano' class='validate[custom[select]]'") ?></p>
                        ...
                        <tbody>
                            ...
                            ?>                                
                                <tr>
                                    ...
                                    <td>RPA</td>
                                    <td>
                                        <?php if($row['hora_mensal'] == "" && $row['hora_mensal'] == 0){ ?>
