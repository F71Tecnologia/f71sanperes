...
$breadcrumb_config = array("nivel"=>"../", "key_btn"=>"36", "area"=>"PrestaÁ„o de Contas", "ativo"=>"Gerar Zip Rescis„o","id_form"=>"form1");
        ...
        <div class="container">
            ...
            <div id="content">
                <form action="" method="post" name="form1" id="form1" class="form-horizontal top-margin1">
                    ...
                    <fieldset>
                        <legend>GERAR ARQUIVO ZIP DE RECIS’ES</legend>                        
                        <div class="form-group" id="mensal">
                            ...
                            <div class="col-lg-4">
                                ...
                                <p class="help-block">(MÍs da PrestaÁ„o Finalizada)</p>
                            </div>
                        </div>
