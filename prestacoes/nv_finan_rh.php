...
$breadcrumb_config = array("nivel"=>"../", "key_btn"=>"36", "area"=>"Prestação de Contas", "ativo"=>"RH Contratado","id_form"=>"form1");
...
if (isset($_REQUEST['projeto'])) {
    ...
    //    
//    $qr_rpa = "SELECT *, CAST(valor_liquido * qnt AS DECIMAL(13,2)) AS salario_categoria
//                FROM(
//                    SELECT COUNT(B.valor_liquido) AS qnt, A.nome, A.cpf, A.conselho, B.id_rpa, E.cbo_nome, E.nome AS funcao, E.cbo_codigo, E.hora_mes,D.id_saida, B.valor_liquido, (B.valor_inss + B.valor_ir) AS encargos
//                    FROM autonomo AS A
...
//                    WHERE D.id_projeto = '{$id_projeto}' AND MONTH(B.data_geracao) = '{$mes2d}' AND YEAR(B.data_geracao) = '{$_REQUEST['ano']}' AND C.tipo_vinculo = 1 AND D.status = 2
//                    GROUP BY B.valor_liquido ORDER BY A.nome 
//                ) as tmp";
    ...
    if ($historico === false) {
        ...
        if($historico != 2014 && $historico != 2013 && $historico != 2012){        
...
<!--                <div id="headerPrint">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <?php echo montaSelect(PrestacaoContas::carregaProjetos($master), $projetoR, "id='projeto' name='projeto' class='validate[custom[select]] form-control'") ?>                            
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            ...
                            <p class="help-block">(Mês de Folha de Pagamento)</p>
                        </div>
                    </div>
                    <div class="form-group <?php echo $rcterceiro; ?>" id="pterceiro">
                        <label for="select" class="col-lg-2 control-label">Décimo Terceiro?</label>
                        <div class="col-lg-2">
                            <input type="radio" name="terceiro" id="terceiroS" value="1" <?php echo ($rterceiro == 1) ? "checked='checked'" : ""; ?>/> Sim
                            <input type="radio" name="terceiro" id="terceiroN" value="0" <?php echo ($rterceiro == 0) ? "checked='checked'" : ""; ?>/> Não       
                        </div>
                    </div>
                    <div class="form-group hide">
                        <label for="select" class="col-lg-2 control-label">Retificadora</label>
                        <div class="col-lg-2">
                            <input type="hidden" name="reti" id="reti" value="<?php echo $retiR ?>" /> Sim
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="select" class="col-lg-2 control-label">Percentual de Encargos</label>      
                        <div class="col-lg-2">
                            <input type="hidden" name="percent" id="percent" value="<?php echo $percentR ?>" size="4" /> <?php echo $percentR ?>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <?php if (!empty($result) && mysql_num_rows($result) > 0) { ?>
                    ...
                    <p style="text-align: right;">                        
                        <button type="button" onclick="tableToExcel('rhTableGeral', 'Folha')" class="btn btn-success exportarExcel"><span class="fa fa-file-excel-o"></span>&nbsp;&nbsp;Exportar para Excel</button>
                    </p>
                    ...
                    <table id="rhTableGeral" class="table table-hover table-striped">
                        <tr><td>
                                <table id="rhTable" class="grid table table-bordered table-hover table-striped">
                                    <thead>                                        
                                        <tr>
                                            <th colspan="10" class="text-center fundo_titulo">RH CONTRATADO</th>
                                        </tr>
                                        <tr>
                                            ...
                                            <th colspan="5" class="text-center">R$</th>
                                        </tr>
                                        <tr>
                                            <th>SALÁRIO BASE</th>
                                            <th>ENCARGOS</th>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysql_fetch_assoc($result)) {
                                            if($row['tipocontrato'] == "CLT"){
                                                ...
                                                if(isset($row['id_curso']) && ($row['id_curso']==2269)){
                                                    $row['horas_mes'] = 44; //gambi
                                                }
                        ...
                        <tr><td>
                                <?php if (!empty($result_rpa) && mysql_num_rows($result_rpa) > 0) { ?>
                                    <table id="rhTable_rpa" class="grid table table-bordered table-hover table-striped">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            $totalCategoria = "";
                                                ...
                                                while ($row_rpa = mysql_fetch_assoc($result_rpa)) {
                                                    ...
                                                    $totalProfissional += $row_rpa['valor_liquido'];
                                                    $totalCategoria += $row_rpa['salario_categoria'];

                                                    echo "<td style='width:366px'>";
                                                    if (empty($row_rpa['funcao'])) {
                                                        echo "AUTÔNOMO SEM FUNÇÃO";
                                                    } else {
                                                        echo $row_rpa['funcao'];
                                                    }
                                                    echo "</td>";
                                                    ...
                                                    echo "<td>";
                                                    if ($historico === false) {
                                                        if (empty($row_rpa['horas_semanais'])) {
                                                            echo "<div class='ocultar_campo' data-key='" . $row_rpa['id_curso'] . "'>
                                                                <input type='text' name='hora_semanal' class='j_horario' style='border: 1px solid #ccc; padding: 5px 13px; width:70px ' />
                                                                <input type='button' name='enviar_horario' value='ok' class='j_cadastrar' />
                                                                <input type='hidden' name='id_curso' value='" . $row_rpa['id_curso'] . "' id='id_curso' />
                                                            </div>";
                                                        } else {
                                                            echo $row_rpa['horas_semanais'];
                                                        }
                                                    }else{
                                                        echo $row_rpa['horas_semanais'];
                                                    }
                                                    ...
                                                    echo"</td>";
                                                    echo "<td class=\"txright\">" . number_format($row_rpa['valor_liquido'], 2, ",", ".") . "</td>";
                                                    echo "<td class=\"txright\">" .number_format($row_rpa['encargos'], 2, ",", "."). "</td>";
                                        ...
                                        <tfoot>
                                            <tr class="info">
                                                ...
                                                <td class="text-right"><?php echo number_format($totalProfissional, 2, ",", ".") ?></td>
                                                <td class="text-right"><?php echo number_format($totalCategoria, 2, ",", ".") ?></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </td></tr>        
                    ...
                    <?php }else{
                        echo "<div class='alert alert-danger'><p>Não foram encontrado RPAs Pagos</p></div>";
                    } ?>
