           	...
           	<table width="505" align="center">
                ...
                <tr class="prestador_campos" >
                  ...
                  <td colspan="2">
                    ...
                    <?php 
						$regioes_prestador = mysql_query("SELECT regioes.id_regiao,regioes.regiao,master.nome FROM regioes INNER JOIN master ON regioes.id_master = master.id_master WHERE regioes.status = '1'  AND master.status = '1'");
                ...
                <tr class="prestador_campos" >
                  ...
                  <td colspan="2"><select name="Projeto-prestador"  id="Projeto-prestador">
                    <?php 
				   	$qr_projeto = mysql_query("SELECT id_projeto,nome FROM projeto WHERE id_regiao = '$row_saida[id_regiao]'");
                ...
                <tr class="prestador_campos" > 
                  ...
                  <td colspan="2">
                    ...
                    <?php $query_prestador = mysql_query("SELECT * FROM  prestadorservico WHERE id_regiao = '$row_saida[id_regiao]' AND status = '1'"); 
                ...
                <tr>
                  <td colspan="3"><div id="comprovantes">
                    <div class="bloco_comprovantes">
