...
if (isset($_POST['cadastrar']) or isset($_POST['atualizar'])) {
    ...
    $arr = array(
        ...
        "COD BARRA CONSUMO" => $campos_cod_barra_consumo,
        "COD BARRA GERAL" => $campos_cod_barra_gerais,
        "REFERENCIA" => $id_referencia,
        "BENS" => $id_bens,
        "TIPO DE PGT" => $id_tipo_pag_saida,
        "GRUPO" => $grupo,
        "SUBGRUPO" => $subgrupo,                                                
        "N∫ DOCUMENTO" => $n_documento,
        "LINK NFE" => $link_nfe,
        "MES REF." => $mes_competencia,
        "ANO REF." => $ano_competencia,
        ...
        "REGIAO PRESTADOR" => $regiao_interno,
        "PROJETO PRESTADOR" => $projeto_interno,
...
if (isset($_POST['atualizar'])) {
    if($tipo != 0){    
        ...
        $sql = "UPDATE saida SET 
                                    ...
                                    id_tipo_pag_saida =  '$id_tipo_pag_saida',  entradaesaida_subgrupo_id = '$subgrupo', tipo_empresa = '$tipo_empresa', 
