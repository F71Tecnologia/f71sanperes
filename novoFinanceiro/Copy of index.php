      ...
      <tr>
        ...
        <tr>
           ...
           <?php // Visualizando Regiões
                ...
                $ids_administracao = array('5','9','27','28','33','64','71','77','24','82', '24');
                ...
                $ids_desativadas = array('1','5','9','27','57','64','68','51','77','75','87','24','71');
 ...
 <!-- INICIO DO CONTROLE DE COMBUSTIVEL -->
      <?php
		...
		// or $id_user == '27'  or $id_user == '1'
  		if($id_user == '27' or $id_user == '52' or $id_user == '5' or $id_user == '1' or $id_user == '65' or $id_user == '9' or $id_user == '64' or $id_user == '77' or $id_user == '75'){?>
        <div id="apDiv2" >
        <fieldset>
