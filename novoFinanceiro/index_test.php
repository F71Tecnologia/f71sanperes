            ...
            <div id="conteudo">
                <div id="topo">
                    ...
                    if ($_COOKIE['logado'] == "179") {
                        echo "<div id='message-box' class='message-red'>";
                        if (isset($_SESSION['msgError']) && $_SESSION['msgError'] != "") {
                            echo $_SESSION['msgError'];
                            echo "<input type='hidden' name='msgError' id='msgError' value='" . $_SESSION['msgError'] . "' /> ";
                        }
                        echo "<a href='javascript:closeMessageBox();' id='bt-message-close' class='bt-message-red'></a></div>";
                    }
                    ?>
                                                            ...
                                                            <td>
                                                                ...
                                                                if ($row_saida['tipo'] != '51' or $row_saida['tipo'] != '170') : // se tipo for dirente de rescisao.
                                                                    ...
                                                                    if ($tipo == 'saida' and !empty($num_saida_file)):
                                                                        ?>
                                                                        <?php $link_encryptado = encrypt('ID=' . $id . '&tipo=0'); echo '##'.$id.' <br>'; ?>
