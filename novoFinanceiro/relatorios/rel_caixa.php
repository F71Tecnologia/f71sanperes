				...
				$('#select_regiao'). change(function(){
					...
					$.ajax({
						...
						success: function(link_encriptado){
							...
							location.href="rel_caixa.php?enc="+link_encriptado;	
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  id="conteudo"> 
   ...
   <tr>
    ...
    <div align="left">&nbsp;&nbsp;<span class="style2"><img src="../../financeiro/imagensfinanceiro/caixa-32.png" alt="fornecedor" width="32" height="32" align="absmiddle">&nbsp;<span class="style3">CAIXA</span></span></div>
    </td>
