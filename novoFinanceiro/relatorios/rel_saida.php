	...
	$('#select_regiao'). change(function(){
		...
		$.ajax({
			...
			success: function(link_encriptado){
				...
				location.href="rel_saida.php?enc="+link_encriptado;	
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  id="conteudo"> 
  ...
  <tr>
    <td height="26" align="center" valign="middle" bgcolor="#E8E8E8" colspan="2">      
    <div align="center" class="style6"> 
        <div align="left">&nbsp;&nbsp;<span class="style2"><img src="../../financeiro/imagensfinanceiro/saida-32.png" alt="fornecedor" width="32" height="32" align="absmiddle">&nbsp;<span class="style3">SA&Iacute;DAS</span></span></div>
      </div></td>
  ...
  <tr>
    <td height="16" valign="top">
      <td height="16" valign="top" align="center">
          ...
          <form action="../../relfinanceiro2.php?enc=<?php echo $linkEnc;?>" method="post" name="for2">
          &nbsp;&nbsp;&nbsp;&nbsp;<br>
