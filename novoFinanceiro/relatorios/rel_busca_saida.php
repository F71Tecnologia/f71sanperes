        ...
        <div id="content">
            <form action="" method="post" name="form1" id="form1" enctype="multipart/form-data" >
                ...
                if($cont>0){ ?>
                        ...
                        <br/>
                        <p style="text-align: right;"><input type="button" onclick="tableToExcel('tabela_relatorio', 'Relatório CNES')" value="Exportar para Excel" class="exportarExcel"></p>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="grid" width="100%" id="tabela_relatorio">
                            ...
                            while($row = mysql_fetch_array($query)){ ?>
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <td class="center">
                                        <?php if(!empty($row['id_saida'])){ //if(!empty($row['tipo_saida_file'])) ?> 
                                    ...
                                    <td class="center">ok<a href="../cad_edit_saida.php?regiao=45&id=<?= $row['r_id_saida']; ?>&popup=1" title="Editar" ><img src="/intranet/imagens/icones/icon-edit-dis.gif" alt="Editar " /></a></td>
                                </tr>
                           <?php } ?>
                            </tbody>
                        </table>
