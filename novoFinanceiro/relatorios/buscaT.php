                ...
                $('#select_regiao').change(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(link_encriptado) {
                            ...
                            location.href = "rel_busca_saida.php?enc=" + link_encriptado;
                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  id="conteudo"> 
                            ...
                            <tr>
                                <td height="32" colspan="2" bgcolor="#E8E8E8">
                                    <div align="left"><span class="style2"> &nbsp;&nbsp;<img src="../../financeiro/imagensfinanceiro/saida-32.png" alt="fornecedor" width="32" height="32" align="absmiddle"><span class="style31">&nbsp;</span></span><span class="style3">BUSCAR SAI&#769;DAS</span></div>           
                            </tr>
                            </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <?php
                                    $array_user = array(5, 71, 22, 87, 89);

                                    if ($regiao == 47 and in_array($_COOKIE['logado'], $array_user)) {
                                        include "busca.php";
                                    } else if ($regiao == 47) {

                                        echo '<div style="width:100%; height:auto; text-align:center; display:block;padding:30px;">Voc&ecirc; n&atilde;o possui permiss&atilde;o para pesquisar nesta regi&atilde;o.</div>';
                                    }
                                    if ($regiao != 47) {
                                        include "buscaT2.php";
                                    }
                                    ...
                                    <hr>
                                        <p>
                                            ...
                                            <div id="geral">
                                                ...
                                                <form action="../../financeiro/relatorio.gerencial.php" method="get" name="relatorio">
                                                    <table align="center">
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="4" align="center">
                                                                <input name="button" type="submit" class="submit-go" id="button" value="       GERAR RELATORIO       "></td>
                                                        </tr>
                                                    </table>
                                               </form>
                                           </div>
