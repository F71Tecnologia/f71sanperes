...
$result_folha_pro = mysql_query("SELECT * FROM folha_autonomo WHERE id_folha = '$folha' and tipo_pg = '$rowTipoPg[0]' and status = '3' or (id_folha = '$folha' and banco = '0' and status = '3') or (id_folha = '$folha' and agencia = '' and status = '3') or (id_folha = '$folha' and conta = '' and status = '3')");	
}else{
$result_folha_pro = mysql_query("SELECT * FROM folha_cooperado WHERE id_folha = '$folha' and tipo_pg = '$rowTipoPg[0]' and status = '3' or (id_folha = '$folha' and banco = '0' and status = '3') or (id_folha = '$folha' and agencia = '' and status = '3') or (id_folha = '$folha' and conta = '' and status = '3')");	
}
...
<table width="95%" border="0" align="center">
  <tr>
    <td align="center" valign="middle" bgcolor="#FFFFFF"><br />
      ...
      <?=$mes_da_folha?> / <?=$row_folha['mes']?></span><br />
      <span class="title"><br />
    </span>
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="12%" align="right" valign="middle" bgcolor="#CCCCCC" class="style23"> L&iacute;quido</td>
        </tr>
        <?php
          $cont = "0";
		  ...
		  $REparti = mysql_query("SELECT * FROM autonomo where id_autonomo = '$row[id_autonomo]' ORDER BY nome");
