      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <?=$row_folha['data_proc2']?></span><br><br>
...
<!--    <? echo "SELECT * FROM folha_cooperado WHERE id_folha = '$folha' AND status IN('3','4') ORDER BY banco, nome";
		...
		$tiposDePagamentos = mysql_query("SELECT * FROM tipopg WHERE id_regiao = '$regiao' and campo1 = '2' and id_projeto = '$row_projeto[0]'");
	     $rowTipoPg = mysql_fetch_array($tiposDePagamentos);
		  ...
		  if ($rowTipoPg[0] == $pgEmCheque){
			...
			<input type='hidden' name='id' value='$row[id_autonomo]'>
			<input type='hidden' name='id_folha' value='$folha'>
			</form>
			</div>";

		  print"
		  <tr height='20' class='linhadois' bgcolor=$color>
          <td align='center' valign='middle' $bord>&nbsp; $rowP[campo3]</td>
          <td align='lefth' valign='middle' $bord>&nbsp; $alink $nomeT</a> $divTT</td>
          <td align='right' valign='middle' $bord>&nbsp; $nomeBanco</td>
          <td align='right' valign='middle' $bord>&nbsp; $agencia</td>
          <td align='right' valign='middle' $bord>&nbsp; $conta</td>
		  <td align='right' valign='middle' $bord>&nbsp; $cpf</td>
          <td align='right' valign='middle' $bord>&nbsp; $tipoConta</td>
          <td align='right' valign='middle' $bord>&nbsp; ".number_format($valor,2,',','.')."</td>
		  </tr>";
