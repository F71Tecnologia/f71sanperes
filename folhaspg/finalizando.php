...
$REContas = mysql_query("SELECT * FROM folha_autonomo where id_folha = '$folha' and status = '3' and banco = '$banco' and tipo_pg='$rowTipoPg[id_tipopg]'");
...
while($row = mysql_fetch_array($REContas)){
	...
	mysql_query("UPDATE folha_autonomo SET status = '4' WHERE regiao = '$regiao' and id_folha = '$folha' and projeto = $id_projeto and banco = '$banco' and id_autonomo = '$row[id_autonomo]'")or die(mysql_error());
}
