<?
					...
					$handle = fopen('BANCOS/ITAU/CONTA_SALARIO/'.$CONSTANTE."_"."SALARIO"."_".$DD."_".$MM."_".$ANO.".txt", "w+");
					...
					$FORMA_LANCAMENTO = '60'; //CARTÃO SALÁRIO
					...
					$handle = fopen('BANCOS/ITAU/CONTA_SALARIO/'.$CONSTANTE."_"."SALARIO"."_".$DD."_".$MM."_".$ANO.".txt", "a");
