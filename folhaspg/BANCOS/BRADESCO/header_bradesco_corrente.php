<?
			$numeroSequencialCorrente = 1;
			/////////////////////////////////////////
			//	REGISTRO DE HEADER BANCO BRADESCO //
			///////////////////////////////////////
			...
			$COD_EMPRESA ='86532';	//INSERIR CÓDIGO DO CLIENTE NO BANCO. PARA CADA CONTA, DEVE HAVER UM CÓDIGO
			$COD_EMPRESA = sprintf("%05d",$COD_EMPRESA);
			
			
			$NOME_EMPR = $Gnome;	//NOME DA EMPRESA CONVENIADA AO BANCO
			...
			$NUMERO_SEQ = sprintf("%06d", $numeroSequencialCorrente);
			
			$handle = fopen('BANCOS/BRADESCO/CONTA_CORRENTE/'.$CONSTANTE."_".$DD."_".$MM."_".$NUM_ARQUIVO."_".$TIPO.".txt", "w+");
