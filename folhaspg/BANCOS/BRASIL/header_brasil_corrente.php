<?
					...
					/////////////////////////////////
					$handle = fopen('BANCOS/BRASIL/CONTA_CORRENTE/'.$CONSTANTE."_".$DD."_".$MM."_".$ANO.".txt", "w+");
					//CONTROLE
					$BANCO = '001';
					...
					$NUMERO_INSCRICAO_EMPRESA = $Gcnpj;
					$remover = array(".", "-", "/",",");
					...
					$NOME_EMPRESA = $Gnome;	//NOME DA EMPRESA CONVENIADA AO BANCO;
					...
					$AGENCIA = $row_banco['agencia'];#$Gnome;	//NOME DA EMPRESA CONVENIADA AO BANCO;					
 					$AGENCIA = substr($AGENCIA, 0, 4); 
					$AGENCIA = sprintf("%05d",$AGENCIA);
					fwrite($handle, $AGENCIA, 5);
