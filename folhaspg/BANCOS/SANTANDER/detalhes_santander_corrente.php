<?
				...
				$NUMERO_CONTAF = substr($NUMERO_CONTAT, 0, 9);							//NUMERO DA CONTA SEM O DIGITO
		...
		//		$DV_AGENCIA_FAVORECIDO = ' ';
			//	$DV_AGENCIA_FAVORECIDO = sprintf("% 1s",$DV_AGENCIA_FAVORECIDO);
				...
				$NUMERO_CONTA_FAVORECIDO = sprintf("%09d",$NUMERO_CONTA_FAVORECIDO); // retirei o zero antes do nove
			...
			//	$DV_CONTA_FAVORECIDO = $ultimoDigitoConta;
				...
				fwrite($handle, $NUMERO_CONTA_FAVORECIDO , 9); //mais 2 digitos
				
				$RESERVADO_BRANCOS = sprintf("% 6s"," "); //menos 2 branco retirado
				...
				fwrite($handle, $NUMERO_CONTA, 9);//mais 2 digitos
				
				$RESERVADO_BRANCOS = sprintf("% 31s"," ");//menos 2 branco retirado
