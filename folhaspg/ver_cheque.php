...
///$result_folha_pro = mysql_query("SELECT * FROM folha_autonomo where id_folha = '$folha' and status = '3' and tipo_pg = '$cheq' or id_folha = '$folha' and status = '3' and banco = '0' and tipo_pg = '$depo'");
...
$result_folha_pro = mysql_query("SELECT * FROM folha_autonomo WHERE id_folha = '$folha' and tipo_pg = '$rowTipoPg[0]' and status = '3' or (id_folha = '$folha' and banco = '0' and status = '3') or (id_folha = '$folha' and agencia = '' and status = '3') or (id_folha = '$folha' and conta = '' and status = '3')ORDER BY nome ASC");	
}else{
$result_folha_pro = mysql_query("SELECT * FROM folha_cooperado WHERE id_folha = '$folha' and tipo_pg = '$rowTipoPg[0]' and status = '3' or (id_folha = '$folha' and banco = '0' and status = '3') or (id_folha = '$folha' and agencia = '' and status = '3') or (id_folha = '$folha' and conta = '' and status = '3') ORDER BY nome ASC");	
}
    ...
    <td align="center" valign="middle" bgcolor="#FFFFFF"><br />
      ...
      <tr>
        <td width="100%" height="92" align="center" valign="middle" bgcolor="#666666" class="title"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="62%" bgcolor="e2e2e2">
            <span class="style3">
              <?=$row_master['razao']?><br>
              CNPJ : <?=$row_master['cnpj']?><br>
            </span>
            </td>
      ...
      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="7%"  align="center" valign="middle" bgcolor="#CCCCCC" class="style23">CPF</td>
          <td width="8%"  align="right"  valign="middle" bgcolor="#CCCCCC" class="style23">Base</td>
          ...
          <td width="14%" align="right"  valign="middle" bgcolor="#CCCCCC" class="style23">Banco</td>
          <td width="10%" align="right"  valign="middle" bgcolor="#CCCCCC" class="style23">Agencia</td>
          <td width="8%"  align="right"  valign="middle" bgcolor="#CCCCCC" class="style23">Conta</td>
          <td width="12%" align="right"  valign="middle" bgcolor="#CCCCCC" class="style23">L&iacute;q.</td>
        </tr>
        <?php
          $cont = "0";
		  ...
		  $qr_tipo_pg = mysql_query("SELECT tipopg FROM tipopg WHERE id_tipopg = '$row[tipo_pg]'");
		 @$tipo_pg    = mysql_result($qr_tipo_pg,0);
          ...
          <td align='right'  valign='middle' $bord>&nbsp;$rowP[nome_banco]</td>
		  <td align='right'  valign='middle' $bord>&nbsp;$rowP[agencia]</td>
		  <td align='right'  valign='middle' $bord>&nbsp;$rowP[conta]</td>
        ...
        <tr>
          ...
          <td colspan="3" align="right" valign="bottom" class="style23">&nbsp;</td>
...
if($row_folha['contratacao'] == 1){
	$link = "ver_folha.php?enc=$linkvolt";
}else{
...
<br></td>
  ...
  <tr>
    ...
    <b><a href='<?=$link?>' style="text-decoration:none; color:#000">VOLTAR</a></b>
    </td>
  </tr>
</table>
<p>&nbsp;</p>
