...
$result_verifica = mysql_query("SELECT * FROM rh_doc_status WHERE tipo = '23' and id_clt = '$id_bolsista'");
$num_row_verifica = mysql_num_rows($result_verifica);
if($num_row_verifica == "0"){
	mysql_query("INSERT INTO rh_doc_status(tipo,id_clt,data,id_user) VALUES ('23','$id_bolsista','$data_cad', '$user_cad')");
}else{
	mysql_query("UPDATE rh_doc_status SET data = '$data_cad', id_user = '$user_cad' WHERE id_clt = '$id_bolsista' and tipo = '23'");
}
//-------------GRAVANDO NA TABELA DOCUMENTOS GERADOS
...
$data_entrada_bolsista = $row_bol['data_entrada2'];

 $d = explode ("/", $data_entrada_bolsista);          //tira a barra

 $ano_bolsista = "$d[2]";               //
 $mes_bolsista = "$d[1]";               // //separa as datas $d[2] = ano $d[1] = mes etc...
 $dia_bolsista = "$d[0]";               //
...
<body bgcolor='#FFFFFF'>
<center>
<table bgcolor='#FFFFFF' border='0' cellpadding='5' cellspacing='0' width='70%'>
  ...
  align='center' valign='middle'><img src='";$img->imagem2(); print "' width='120' height='86' align='left' />
      <p ><img src='imagens/cobrinha.gif' width='99' height='123' align='right' /><b>INSTITUTO SORRINDO PARA A VIDA</p>
  ...
  <tr>
    <td colspan='5'><p align='justify' class='style13'>Celebram o presente <strong>TERMO DE BOLSA-AUX&Iacute;LIO</strong>, conforme condi&ccedil;&otilde;es a
        seguir:</p>
  ...
  <tr>
    <td colspan='5'><p align='justify' class='style13'>Celebram o presente <strong>TERMO ;
	  ...
	  <u>Cl&aacute;usula 8&ordm;</u>. O <strong>BOLSISTA</strong> receber&aacute; como <strong>BOLSA-AUX&Iacute;LIO</strong> e pela
        complementa&ccedil;&atilde;o educacional, o valor refer&ecirc;ncia igual a <span class='style1'> $valor_curso</span> mensais,
     ...
     <br>
      ...
      <p class='style15'>$row_reg[regiao], $dia_bolsista de $mes de $ano_bolsista. </p></td>
  </tr>
  <tr>
