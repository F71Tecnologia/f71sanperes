...
echo bloqueio_administracao($row['id_regiao']);
...
<table cellpadding="0" cellspacing="1" class="secao">
			...
			while($row_grupo = mysql_fetch_array($qr_grupo)) { 
				$salario = number_format($row_grupo['salario'],2,',','.');
  				if($row_grupo['id_curso'] == "$row_curso[id_curso]") {
                                        $id_curso_horario = $row_grupo['id_curso'];
  ...
  <?php 
        $qr_horarios = mysql_query("SELECT * FROM rh_horarios WHERE funcao = '$id_curso_horario' and id_regiao = '{$row['id_regiao']}'");
        $rs_horario = mysql_fetch_assoc($qr_horarios);
  ?>
    <tr> 
        <td class="secao">Horas Semanais</td>
        <td><input type="text" id="horas_semanais" name =" horas_semanais" value="<?php echo $rs_horario['horas_semanais']; ?>" disabled="disabled" size="15">&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="<?php echo 'bolsista_horario_alterar.php?regiao=' . $row[id_regiao] . '&curso=' . $id_curso_horario; ?>" target="_blank"> EDITAR</a>

        </td>   
    </tr>
    <tr> 
        <td class="secao">Horas Mensais</td>
        <td><input type="text" id="horas_mensais" name =" horas_mensais" value="<?php echo $rs_horario['horas_mes']; ?>" disabled="disabled" size="15">&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="<?php echo 'bolsista_horario_alterar.php?regiao=' . $row[id_regiao] . '&curso=' . $id_curso_horario; ?>" target="_blank"> EDITAR</a>
        </td>   
    </tr>
  <tr>
...
<td>
  ...
  <tr>
  	<td>E-mail:</td>
    <td colspan="5">  <input name="email" type="text" id="email" size="35" value="<?=$row['email']?>" /></td>
  </tr>
  --->
...
$queryCPF = mysql_query("SELECT id_autonomo FROM autonomo WHERE cpf = '$cpf' AND id_projeto = '$id_projeto' AND id_regiao = '$regiao' AND tipo_contratacao = 1");
...
//} else {
    ...
    print_r("update autonomo set localpagamento = '$localpagamento', locacao = '$lotacao', nome = '$nome', sexo = '$sexo', endereco = '$endereco', bairro = '$bairro', cidade = '$cidade', uf = '$uf', cep = '$cep', tel_fixo = '$tel_fixo',
...
, olhos = '$olhos', defeito = '$defeito', cipa = '$cipa', ad_noturno = '$ad_noturno', plano = '$plano', assinatura = '$assinatura', distrato = '$assinatura2', outros = '$assinatura3', pis = '$pis', dada_pis = '$data_pis1', data_ctps = '$data_ctps', serie_ctps = '$serie_ctps', uf_ctps = '$uf_ctps', uf_rg = '$uf_rg', fgts = '$fgts', insalubridade = '$insalubridade', transporte = '$transporte', medica = '$medica', tipo_pagamento = '$tipopg', nome_banco = '$nome_banco', num_filhos = '$filhos', observacao = '$observacao', foto = '$foto_banco', id_cooperativa = '$cooperativa', dataalter = '$data_hoje', useralter = '$id_user', email = '$email', tipo_sanguineo = '$tipo_sanguineo' WHERE id_autonomo = '$id_bolsista' LIMIT 1");
    exit;
...
//tel_cel = '$tel_cel', tel_rec = '$tel_rec', data_nasci = '$data_nasci2', naturalidade = '$naturalidade', nacionalidade = '$nacionalidade', civil = '$civil', rg = '$rg', orgao = '$orgao', data_rg = '$data_rg2', cpf = '$cpf', titulo = '$titulo', zona = '$zona', secao = '$secao', pai = '$pai', nacionalidade_pai = '$nacionalidade_pai', mae = '$mae', nacionalidade_mae = '$nacionalidade_mae', estuda = '$estuda', data_escola = '$data_escola', escolaridade = '$escolaridade', instituicao = '$instituicao', curso = '$curso', banco = '$banco', agencia ='$agencia', conta = '$conta',tipo_conta = '$tipoDeConta',  status = '$status', data_saida = '$desativacao', campo3 = '$codigo', tipo_contratacao = '$tipo_contratacao', id_curso = '$id_curso', apolice = '$apolice', data_entrada = '$data_entrada2', campo2 = '$dependente', campo1 = '$trabalho',
// data_exame = '$exame_data', reservista = '$reservista', etnia = '$etnia', deficiencia = '$deficiencia', cabelos = '$cabelos', peso = '$peso', altura = '$altura'
//, olhos = '$olhos', defeito = '$defeito', cipa = '$cipa', ad_noturno = '$ad_noturno', plano = '$plano', assinatura = '$assinatura', distrato = '$assinatura2', outros = '$assinatura3', pis = '$pis', dada_pis = '$data_pis1', data_ctps = '$data_ctps', serie_ctps = '$serie_ctps', uf_ctps = '$uf_ctps', uf_rg = '$uf_rg', fgts = '$fgts', insalubridade = '$insalubridade', transporte = '$transporte', medica = '$medica', tipo_pagamento = '$tipopg', nome_banco = '$nome_banco', num_filhos = '$filhos', observacao = '$observacao', foto = '$foto_banco', id_cooperativa = '$cooperativa', dataalter = '$data_hoje', useralter = '$id_user', email = '$email', tipo_sanguineo = '$tipo_sanguineo' WHERE id_autonomo = '$id_bolsista' LIMIT 1") or die ("Erro no UPDATE:<br><br><font color=red> ".mysql_error());
