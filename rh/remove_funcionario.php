...
$breadcrumb_config = array("nivel" => " ../", "key_btn" => "3", "area" => "Recursos Humanos", "id_form" => "form-lista", "ativo" => "Remover Funcionário");
...
<html>
    <head>
        ...
        <title>:: Intranet :: Remover Funcionário</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - RECURSOS HUMANOS<small> - Remover Funcionário</small></h2></div>
                            ...
                            <form action="" class="form-horizontal" role="form" id="form" method="post" autocomplete="off">
                                ...
                                <div class="panel panel-default hidden-print">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label for="nome_centrocusto" class="col-lg-2 control-label">Contratação:</label>
                                            <div class="col-lg-9">
                                ...
                                <?php while ($row = mysql_fetch_assoc($qr)) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="javascript:;" title="Remover Funcionário" class="btn btn-danger btn-sm deletar delete" id="<?php echo $row['id']; ?>">
