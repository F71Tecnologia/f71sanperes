...
//                        }
    ...
    echo "<span style='font-style: italic; color:  #999999'>* Para trocar de função use a Transferência</span>";number_format
    ?>
                                    ...
                                    <tr class="plantao">
                                        ...
                                        <td width="100%" class="novo_plantao">
                                            ...
                                            <label>Valor Fixo Plantão: <input name="valor_fixo_plantao" id="valor_fixo_plantao" type="text" class="reset required" size="10px" value="<?php echo $row['valor_fixo_plantao'];?>"/></label>
                                        </td>
                                    </tr>
                                    <tr>
...
//                                                    $result_horarios = mysql_query("SELECT * FROM rh_horarios WHERE funcao = '$id_curso' AND id_regiao = '$row[id_regiao]'"); no lugar de  $id_curso {$_REQUEST['id']}
    ...
    <!--                                                <a href="<?php // echo 'rh_horarios_alterar.php?regiao=' . $row[id_regiao] . '&horario=' . $row_horarios[id_horario];               ?>" target="_blank"> EDITAR</a>-->
                                    ...
                                    <tr>
                                        ...
                                        <td><?= montaSelect($arraySetor, $row['id_setor'], 'name="id_setor" id="id_setor" class=""') ?></td>
                                    </tr>
                                    <tr>
    ...
    <?php ?>
                                            <?php if ($regUnid == 1) { ?> 
                                                <?php echo montaSelect($arr_unidade, $row['id_unidade'], 'name="unidades_assoc[]" class="unid1 validate[required]" disabled'); ?>
                                                <input type="text" name="unidades_porcentagem[]" class="porcentagem porc1" placeholder="00%" disabled value="<?php echo $unidade_assoc[0]['porcentagem'] . '%' ?>"/>
                                            <?php } else { ?>
                                                <?php echo montaSelect($arr_unidade, $row['id_unidade'], 'name="unidades_assoc[]" class="unid1 validate[required]" '); ?>
                                                <input type="text" name="unidades_porcentagem[]" class="porcentagem porc1" placeholder="00%" value="<?= $unidade_assoc[0]['porcentagem'] ?>"/>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                    <tr>
    ...
    <?php if ($regUnid == 1) { ?> 
        ...
        ?>
                                                                ...
                                                                <input disabled type="hidden" class="change_unidade" name="id_assoc_unidade[]" value="<?= $unidade_assoc[2]['id_assoc'] ?>"/>
        <?php echo montaSelect($arr_unidade, $unidade_assoc[2]['id_unidade'], 'disabled name="unidades_assoc[]" class="unid3 change_unidade"'); ?>
                                                                <input disabled type="text" name="unidades_porcentagem[]" class="porcentagem porc3" placeholder="00%" value="<?= $unidade_assoc[2]['porcentagem'] ?>"/>
                                                                </td>
                                                                </tr>
                                                                <?php } else { ?>
                                                                <tr>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <input name="emissao_crt" type="text" size="12" maxlength="10" id="emissao_crt"
                                                                                                                               onkeyup="mascara_data(this);
                                                                                   pula(10, this.id, reservista.id)" value="<?php echo date('d/m/Y',strtotime($row['emissao_crt'])); ?>"/>    
                                                                                                                    </td>
                                                                                                                    <td class="secao">Validade CRT:</td>
                                                                                                                    <td>
                                                                                                                        <input name="validade_crt" type="text" size="12" maxlength="10" id="validade_crt"
                                                                                                                               onkeyup="mascara_data(this);
                                                                                   pula(10, this.id, reservista.id)" value="<?php echo date('d/m/Y',strtotime($row['validade_crt'])); ?>"/>    
                                                                                                                    </td>
                                                                                                                    <td colspan="2"></td>
                                                                                                                </tr>
                                                                                                                <tr>
    ...
    <?php } ?>
                                                                            ...
                                                                            //                                                    $sql_vt_valores = mysql_query($qry_vt_valores) or die("ERRO qry_vt_valores");
                                                                                                                                ...
                                                                                                                                while ($res_vt_linhas = mysql_fetch_assoc($sql_vt_linhas)) { 
                                                                                                                                    switch ($qtd_val) {
                                                                                                                                        case 1: $linha = $row_vale['id_linha1']; break;
                                                                                                                                        case 2: $linha = $row_vale['id_linha2']; break;
                                                                                                                                        case 3: $linha = $row_vale['id_linha3']; break;
                                                                                                                                        case 4: $linha = $row_vale['id_linha4']; break;
                                                                                                                                        case 5: $linha = $row_vale['id_linha5']; break;
                                                                                                                                    }
                                                                                                                                    $selLinha = '';
//                                                                                                                                    echo "<!--";
...
//                                                                                                                            } ?>
                                                                                                                ...
                                                                                                                $(function () {
                                                                                                                    ...
                                                                                                                    $("body").on("click", ".add_favorecido", function () {
                                                                                                                        ...
                                                                                                                        <tr>\n\
                                                                                                                            ...
                                                                                                                            <td colspan='6'>\n\
                                                                                                                                <span><input type='checkbox' name='incide_ferias' /> Férias</span>\n\
                                                                                                                                <span><input type='checkbox' name='incide_rescisao' /> Rescisão</span>\n\
                                                                                                                                <span><input type='checkbox' name='incide_13' /> Décimo Terceiro</span>\n\
                                                                                                                            </td>\n\
                                                                                                                        </tr>\n\
                                                                                                                        </tbody>");
    ...
    <?php if (mysql_num_rows($query_dados_pensao) > 0) { ?>
            ...
            while ($rowsVerificaBasePensao = mysql_fetch_assoc($sqlVerificaBasePensao)) {
                ...
                if ($rowsVerificaBasePensao['sobreSalLiquido'] == 1) {
                    $base = 1;
                } else if ($rowsVerificaBasePensao['sobreSalBruto'] == 1) {
                    $base = 2;
                } else if ($rowsVerificaBasePensao['sobreSalMinimo'] == 1) {
                    $base = 3;
                } else if ($rowsVerificaBasePensao['umTercoSobreLiquido'] == 1) {
                    $base = 5;
                } else if ($rowsVerificaBasePensao['valorfixo'] > 0 &&
                        $rowsVerificaBasePensao['sobreSalLiquido'] == 0 &&
                        $rowsVerificaBasePensao['sobreSalBruto'] == 0 &&
                        $rowsVerificaBasePensao['sobreSalMinimo'] == 0 &&
                        $rowsVerificaBasePensao['umTercoSobreLiquido'] == 0) {
                    $base = 4;
                    $valorFixo = $rowsVerificaBasePensao['valorfixo'];
                }
            ...
            ?>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td class="secao">Incide Em:</td>
                                                                                                                                <td colspan="6">
                                                                                                                                    <span><input type="checkbox" name="incide_ferias[]" <?php if ($incide_ferias == 1) {
                                                                                                                                echo "checked";
                                                                                                                            } else {
                                                                                                                                echo "";
                                                                                                                            } ?> /> Férias</span>
                                                                                                                                    <span><input type="checkbox" name="incide_rescisao[]"  /> Rescisão</span>
                                                                                                                                    <span><input type="checkbox" name="incide_13[]" <?php if ($incide_13 == 1) {
                                                                                                                                echo "checked";
                                                                                                                            } else {
                                                                                                                                echo "";
                                                                                                                            } ?> /> Décimo Terceiro</span>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                        </tbody>
        <?php } ?>
    <?php } else { ?>
                                                                                                            ...
                                                                                                            <table cellpadding="0" cellspacing="1" class="secao">
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td colspan="3"><input name="gratificacao" type="text" id="gratificacao" placeholder="00%" class="porcentagem" value="<?php echo $row['gratificacao'] ?>" /></td>
                                                                                                                </tr> 
                                                                                                            </table>
                                                                                                                                                                                        <!-- AQUI VIADO -->
    <?php ?>
                                                                                                               ...
                                                                                                               //COLOCAR PARA CARREGAR OS FAVORECIDOS PARA O CLT
                                                                                                                ...
                                                                                                                mysql_query("INSERT INTO rh_vt_valores_assoc(id_clt, id_valor1, id_valor2, id_valor3, id_valor4, id_valor5, qtd1, qtd2, qtd3, qtd4, qtd5,
                                                                                                                            ...
                                                                                                                            ('$id_clt','$vt_valor1','$vt_valor2','$vt_valor3', '$vt_valor4', '$vt_valor5', '$vt_qtd1','$vt_qtd2','$vt_qtd3', '$vt_qtd4', '$vt_qtd5',
                                                                                                                             '$vt_linha1', '$vt_linha2', '$vt_linha3', '$vt_linha4', '$vt_linha5', '$vt_card1', '$vt_card2', '$vt_card3', '$vt_card4', '$vt_card5')") or die("Erro de digitação no INSERT dos vales query: " . mysql_error());
                                                                                                                } else {
...
// FOTO
                        ...
                        WHERE id_clt = '{$id_clt}'");
                                                                                                                    ...
                                                                                                                    $insFavorecido = mysql_query("INSERT INTO entradaesaida_nomes (nome,cpfcnpj,id_entradasaida) VALUES ('{$_REQUEST['nome_favorecido']}','{$_REQUEST['cpf_favorecido']}','154')");
                                                                                                                }
                                                                                                                ...
                                                                                                                foreach ($_REQUEST['salario_outra_empresa'] as $key => $sal_outra_empresa) {
                                                                                                                    ...
                                                                                                                    if ($_REQUEST['id_inss'][$key] > 0) {
                                                                                                                        ...
                                                                                                                        $query = "INSERT INTO rh_inss_outras_empresas (id_clt,salario,desconto,inicio,fim,status,data_cad,cnpj_outro_vinculo) VALUES ('$id_clt','$sal_outra_empresa','{$desconto_inss}','{$inicio_inss}','{$fim_inss}',1,NOW(),'$cnpj');";
                                                                                                                    }
