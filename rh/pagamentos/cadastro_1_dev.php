...
$tipo_guia = $_REQUEST['tipo_guia'];  // 1-gps, 2-fgts, 3-pis, 4-ir, 5 - RECÁLCULO, 6 - VALE TRANSPORTE, 7 VALE ALIMENTAÇÃO, 8 - SINDICATO
...
<html>
    ...
    <body>
        <form name="form1" id="form1" action="cadastro_1_dev.php" method="post" enctype="multipart/form-data">
