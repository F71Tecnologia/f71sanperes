                            ...
                            <!--         e                           <tr>
                                        ...
                                        <tr class="<?php echo ($cor++ % 2 == 0) ? "even" : "odd"; ?>"> 
                                            ...
                                            <td align="center" class="<?= $color['re'] ?>">
                                                ...
                                                <?php } else { ?>
                                                    <a href="zvisualizar_resc_ferias.php?id_clt=<?php echo $row_resci['clt'] ?>&mes=<?php echo $mes; ?>&ano=<?php echo $ano; ?>&id_rescisao=<?php echo $row_resci['id_recisao'] ?>&regiao=<?php echo $regiao; ?>&tipo=2&keepThis=true&TB_iframe=true&width=930" class="thickbox" > 
                                            ...
                                            <td align="center" class="<?= $color['mu'] ?>">
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <a href="zvisualizar_resc_ferias.php?id_clt=<?php echo $row_resci['clt'] ?>&mes=<?php echo $mes; ?>&ano=<?php echo $ano; ?>&id_rescisao=<?php echo $row_resci['id_recisao'] ?>&regiao=<?php echo $regiao; ?>&tipo=3&keepThis=true&TB_iframe=true&width=930" class="thickbox" > 
                                                        <img border="0px" src="../folha/imagens/verfolha.gif" width="18" height="18" />
                                                    </a>
                                                <?php } ?>
                                                        ...
                                                        foreach ($rescisao as $idRescisao => $cores) {
                                                            ...
                                                            <div class="<?= $cores; ?>" style="float:left; width:100%" align="center">
                                                                ...
                                                                <?php } else { ?>
                                                                    ...
                                                                    <a href="zvisualizar_resc_ferias.php?id_clt=<?php echo $row_resci['clt'] ?>&mes=<?php echo $mes; ?>&ano=<?php echo $ano; ?>&id_rescisao=<?php echo $idRescisao; ?>&regiao=<?php echo $regiao; ?>&tipo=4&keepThis=true&TB_iframe=true&width=930" class="thickbox" > 
                                                                        <img border="0px" src="../folha/imagens/verfolha.gif" width="18" height="18" />
                                                                    </a>
                                                        ...
                                                        foreach ($multaComplementar as $idRescisao => $cores) {
                                                            ...
                                                            <div class="<?= $cores; ?>" style="float:left; width:100%" align="center">
                                                                ...
                                                                <?php } else { ?>
                                                                    ...
                                                                    <a href="zvisualizar_resc_ferias.php?id_clt=<?php echo $row_resci['clt'] ?>&mes=<?php echo $mes; ?>&ano=<?php echo $ano; ?>&id_rescisao=<?php echo $idRescisao; ?>&regiao=<?php echo $regiao; ?>&tipo=5&keepThis=true&TB_iframe=true&width=930" class="thickbox" > 
                                                                        <img border="0px" src="../folha/imagens/verfolha.gif" width="18" height="18" />
                                                                    </a>
                                    ...
                                    while ($row = mysql_fetch_assoc($result)) {
                                        ...
                                        <tr class="<?php echo ($cor++ % 2 == 0) ? "even" : "odd"; ?>">
                                            ...
                                            <td align="center" class="<?= $color['ferias'] ?>">
                                                ...
                                                <?php } else { ?>                                            
                                                    <a href="zvisualizar_resc_ferias.php?id_clt=<?php echo $row['id_clt'] ?>&mes=<?php echo $mes; ?>&ano=<?php echo $ano; ?>&id_ferias=<?php echo $row['id_ferias']; ?>&regiao=<?php echo $regiao; ?>&tipo=1&keepThis=true&TB_iframe=true&width=930" class="thickbox" > 
                                                        <img border="0px" src="../folha/imagens/verfolha.gif" width="18" height="18" />
                                                    </a>
