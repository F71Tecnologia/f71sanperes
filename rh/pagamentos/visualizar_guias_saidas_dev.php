...
$mes = $_GET['mes'];
$ano = $_GET['ano'];
$tipo_guia = $_GET['tipo_guia']; // 1 - gps, 2 - fgts, 3- PIS, 4 -IR
...
$nomes = array('1' => 'GPS', 2 => 'FGTS', 3 => 'PIS', 4 => 'IR');
...
$qr_saida = mysql_query("SELECT A.tipo_descricao, A.id_pg, B.id_saida, B.estorno,B.estorno_obs,
