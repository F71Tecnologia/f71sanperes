...
<html>
    <head>
        ...
        <script>
            $(function() {
                ...
                $("tr").mouseout(function() {
                    var key = $(this).data("key");
                    $("#detalhes_" + key).css({width: "30px", height: "23px", opacity: "0.6", background: "url('imagens/icones/icon-docview.gif')", backgroundSize: "26px", backgroundPositionX: "1px"}).hide();
                    $("#detalhes_" + key + " div").hide();
                });
        ...
        <style>
            ...
            .detalhes{ position: absolute; top: 0px; right: 0px; width: 30px; height:23px; z-index: 99999; opacity: 0.6; cursor: pointer; background: url("imagens/icones/icon-docview.gif"); background-size: 26px; background-position-x: 1px; display: none;}
