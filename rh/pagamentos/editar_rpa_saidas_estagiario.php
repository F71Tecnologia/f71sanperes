...
//    $qr_EditSaida = mysql_query("UPDATE saida SET valor = '$novoVal', data_vencimento = '$novaData' WHERE id_saida = $id_saida AND status = 1 LIMIT 1;") or die("Erro ao atualizar dados da saída.");
    $qr_rpaSaidaAssoc = mysql_query("SELECT A.id_rpa_estagiario
    ...
    print_r("UPDATE rpa_estagiario SET valor_liquido = '$novoVal' WHERE id_rpa_estagiario = {$row_rpaSaidaAssoc['id_rpa_estagiario']} LIMIT 1;");
    exit;
