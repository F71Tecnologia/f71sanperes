                      ...
                      <div >
                                ...
                                <div style="display: none" >
									<table width="100%" bgcolor="#FFFFFF"  cellspacing="1" cellpadding="5">
                                    	<tr bgcolor="#CCCCCC">
                                        	...
                                        	<td ><span class="cabecalho">Região</span></td>
                                           ...
                                           <?php //if($_COOKIE['logado'] == 87){ ?>
                                            <td><span class="cabecalho">IR Autônomo</span></td>
                                            <?php //}?>
                                        </tr>
								<?php 
								...
								?>
                                        ...
                                        <tr class="linha_<?php if($cor2++%2==0) { ?>um<? } else { ?>dois<? } ?>">
                                            ...
                                            <span class="dados">
                                            <a href="cadastro.php?gps&tipo=CLT&mes=<?=$mes?>&ano=<?=$ano?>&projeto=<?=urlencode($row_folha['nome'])?>&folha=<?=$row_folha['id_folha']?>&regiao=<?php echo $regiao?>" onClick="return hs.htmlExpand(this, { objectType: 'iframe', height: '400', width: '400' } )">
                                            ...
                                            <?php if($row_controle['status'] == 0):?>
                                            <span class="dados"><a href="cadastro.php?fgts&tipo=CLT&mes=<?=$mes?>&ano=<?=$ano?>&projeto=<?=urlencode($row_folha['nome'])?>&folha=<?=$row_folha['id_folha']?>&regiao=<?php echo $regiao?>" onClick="return hs.htmlExpand(this, { objectType: 'iframe', height: '400', width: '400'  } )" ><img src="../imagensrh/log_fgts.jpg"/></a></span>
                                            <?php else: ?>
                                            ...
                                            <span class="dados"><a href="cadastro.php?pis&tipo=CLT&mes=<?=$mes?>&ano=<?=$ano?>&projeto=<?=urlencode($row_folha['nome'])?>&folha=<?=$row_folha['id_folha']?>&regiao=<?php echo $regiao?>" onClick="return hs.htmlExpand(this, { objectType: 'iframe', height: '400', width: '400'  } )"><img src="../imagensrh/pis.jpg"/></a></span>
                                             <?php else: ?>
                                            ...
                                            <span class="dados"><a href="cadastro.php?ir&tipo=CLT&mes=<?=$mes?>&ano=<?=$ano?>&projeto=<?=urlencode($row_folha['nome'])?>&folha=<?=$row_folha['id_folha']?>&regiao=<?php echo $regiao?>" onClick="return hs.htmlExpand(this, { objectType: 'iframe', height: '400', width: '400'  } )"><img src="../imagensrh/ir.jpg"/></a></span>
                                            <?php else: ?>
                                          ...
                                          <?php //if($_COOKIE['logado'] == 87){ ?>
                                            <td align="center">
                                                 <span class="dados"><a href="index_1_1.php?ir&tipo=CLT&mes=<?=$mes?>&ano=<?=$ano?>&projeto=<?=$row_folha['projeto']?>&regiao=<?php echo $row_folha['id_regiao'];?>&folha=<?=$row_folha['id_folha']?>" onClick="return hs.htmlExpand(this, { objectType: 'iframe', height: '600', width: '600', fullExpandOpacity: 1 } )"><img src="../../imagens/ver_anexo.gif" width="20" height="20"/></a></span>
                                           </td>
                                         <?php //} ?>
                                        </tr>
                      ...
                      <div >
								...
								?>
                                        ...
                                        <?php 
                                            ...
                                            <span class="dados"><a href="cadastro.php?gps&tipo=COOP&mes=<?=$mes?>&ano=<?=$ano?>&projeto=<?=urlencode($row_folha_coop['nome'])?>&folha=<?=$row_folha_coop['id_folha']?>&regiao=<?php echo $row_folha_coop['id_regiao'];?>" onClick="return hs.htmlExpand(this, { objectType: 'iframe', height: '400' } )"><img src="../imagensrh/gps.jpg"/></a></span>
                                            <?php else: ?>
                                            <span class="dados"><img src="../imagensrh/gps.jpg"/></span>
                                            <?php endif;?>
                                            </td>
                                            ...
                                            <?php if(empty($color[1])):?>
                                            <span class="dados"><a href="cadastro.php?ir&tipo=COOP&mes=<?=$mes?>&ano=<?=$ano?>&projeto=<?=urlencode($row_folha_coop['nome'])?>&folha=<?=$row_folha_coop['id_folha']?>&regiao=<?php echo $row_folha_coop['id_regiao'];?>" onClick="return hs.htmlExpand(this, { objectType: 'iframe', height: '400' } )"><img src="../imagensrh/ir.jpg"/></a></span>
                                             <?php else: ?>
                                            <span class="dados"><img src="../imagensrh/ir.jpg"/></span>
                                            <?php endif;?>
                                            </td>
...
for($ano=2009; $ano<=date('Y')+1; $ano++):
	...
	foreach($meses as $nome_mes => $mes):
		...
		$qr_recisao = mysql_query("SELECT recisao.id_clt,recisao.id_recisao, clt.nome AS nome_clt, recisao.total_liquido, regioes.id_regiao, regioes.regiao, 
		...
		$row_controle = mysql_fetch_assoc($query_controle);
               ...
               $query_saida_multa = mysql_query("SELECT * FROM saida_files as a 
                                                    ...
                                                    WHERE b.id_clt = '$row_recisao[id_clt]' AND b.tipo IN(167,170) AND a.multa_rescisao = 1");
		...
		$query_string['tipo'] =  '2';
		$query_string['id_rescisao'] =  $row_recisao['id_recisao'];
		...
		unset($string,$string,$query_string);
			...
			if(empty($num_saida)){
				print '<a href="detalhes.php?'.$link.'" onClick="return hs.htmlExpand(this, { objectType: \'iframe\', height: \'400\' } )" title="Anexar Rescisão">
							<img border="0px" src="imagens/saida-32.png" width="18" height="18" />
					   </a>';
                        }else {
                             
                            echo  '<a href="action.ver_multa_rescisao.php?rescisao=1&'.$link.'" onClick="return hs.htmlExpand(this, { objectType: \'iframe\', height: \'400\' } )" title="Visualizar rescisão">
							<img border="0px" src="../../imagens/ver_anexo.gif" width="18" height="18" />
					   </a>';
                         }
			...
			print '</td>';
                        ...
                        print '<td align="center" '.$color_multa.' >';
                         ...
                         if(empty($num_saida_multa)){                      
                            print '<a href="rescisao_multa.php?'.$link.'" onClick="return hs.htmlExpand(this, { objectType: \'iframe\', height: \'400\' } )" title="Anexar multa">
							<img border="0px" src="imagens/saida-32.png" width="18" height="18" />
					   </a>';
                         } else {
                             
                            echo  '<a href="action.ver_multa_rescisao.php?multa=1&'.$link.'" onClick="return hs.htmlExpand(this, { objectType: \'iframe\', height: \'400\' } )" title="Visualisar multa">
							<img border="0px" src="../../imagens/ver_anexo.gif" width="18" height="18" />
					   </a>';
                         }
