<?
	...
	$numSequenciaLote = $numSequencia-1; //NUMERO SEQUENCIAL MENOS OS REGISTO DE HEADER DE ARQUIVO
	...
	/*
	$handle = fopen('BANCOS/SANTANDER/CONTA_SALARIO/'.$CONSTANTE."_".$DD."_".$MM."_".$ANO.".txt", "a");	
