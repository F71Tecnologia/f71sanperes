...
<br />
      ...
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
       ...
       <?php 
			...
			$handle = fopen('BANCOS/HSBC/CONTA_CORRENTE/'.$CONSTANTE."_".$DD."_".$MM."_".$NUM_ARQUIVO."_".$TIPO.".txt", "a");
		  ...
		  if (($tipoContaCorrente01 =='corrente') and ($banco == '1')){
			...
			include "BANCOS/HSBC/detalhes_hsbc_corrente.php";
					...
					$VALOR = sprintf("%013d",$VALOR);
			  		...
			  		include "BANCOS/HSBC/detalhes_hsbc_poupanca.php";
...
if (($statusContaCorrente =='corrente') AND ($banco == '1')){
	...
	include "BANCOS/HSBC/trailler_hsbc_poupanca.php";
