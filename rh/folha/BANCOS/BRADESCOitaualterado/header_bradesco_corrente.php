<?
					...
					$NUMERO_CONTAF = substr($NUMERO_CONTAT, 0, 5);							//NUMERO DA CONTA SEM O DIGITO
					$DAC_AGENCIA_CONTA_DEBITADA = substr($NUMERO_CONTAT, 5, 6);				//DIGITO DA CONTA
					...
					$handle = fopen('BANCOS/BRADESCO/CONTA_CORRENTE/'.$CONSTANTE."_"."CORRENTE"."_".$DD."_".$MM."_".$ANO.".txt", "w+");
					...
					fwrite($handle, $BRANCOS, 69);	//VALOR REAL fwrite($handle, $BRANCOS, 69);
					fwrite($handle, "\r\n");
					...
					$handle = fopen('BANCOS/BRADESCO/CONTA_CORRENTE/'.$CONSTANTE."_"."CORRENTE"."_".$DD."_".$MM."_".$ANO.".txt", "a");
