<?
					...
					$handle = fopen('BANCOS/BRADESCO/CONTA_SALARIO/'.$CONSTANTE."_"."SALARIO"."_".$DD."_".$MM."_".$ANO.".txt", "w+");
					...
					$handle = fopen('BANCOS/BRADESCO/CONTA_SALARIO/'.$CONSTANTE."_"."SALARIO"."_".$DD."_".$MM."_".$ANO.".txt", "a");
