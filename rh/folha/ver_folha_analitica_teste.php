...
if ($data > date('2010-06-09')) {
    ...
    /*$objFolha->getFichaFinanceira(7820, $row_folha['ano'], $row_folha['mes']);
    
    $qrCredito = $objFolha->getMovCredito();    
    while($mov = mysql_fetch_assoc($qrCredito)){   
      $MovCredito[] = $mov['cod'] ;      
  }
    $qrDebito= $objFolha->getMovDebito();    
    while($mov = mysql_fetch_assoc($qrDebito)){   
      $MovDebito[] = $mov['cod'] ;      
  }
  $movimentosRendDesc = $objFolha->getDadosFicha();
    echo '<pre>';
            //print_r($movimentosRendDesc);echo $movimentosRendDesc['0001'][ref];
    echo '</pre>';*/
...
LEFT JOIN curso AS C ON (IF(folha.para IS NOT NULL,C.id_curso=folha.para, IF(folha.de IS NOT NULL,C.id_curso=folha.de,C.id_curso=folha.id_curso)))
    ...
    <html>
        ...
        ?>
                                ...
                                <a href="../contracheque/geracontra_4.php?enc=<?= $contracheque ?>" target="_blank" class="participante" title="Gerar contracheque de <?= $row_participante['nome'] ?>">
                                    <span class="
                                    <?php
                                ...
                                <table width="100%"  class="sem_borda">                                    
                                    ...
                                    if ($row_participante['valor_rescisao'] != 0) {
                                        /*
                                          ...
                                          <td align="left" width="50%">RESCISÃO</td>
                                            ...
                                            if ($row_participante[$indice] != 0) {
                                                ...
                                                <tr class="font" height="35">
                                                    ...
                                                    <td align="left" width="33%"><?php
                                                        ...
                                                        if ($data_entrada > $data_inicio) {
                                                            //CALCULA TOTAL DE RENDIMENTO PARA ADMISSÃO
                                                            ...
                                                            //CALCULA TOTAL DE RENDIMENTO PARA FÉRIAS
                                ...
                                <table width="100%"  class="sem_borda">
                                    ...
                                    if ($row_participante['valor_pago_rescisao'] != 0) {
                                        /*
                                          ...
                                          echo '  <tr class="font" height="35">
                                          <td align="left" width="50%">IRRF RESCISÃO</td>
    ...
    <?php foreach ($totalizadores_valor as $chave => $valor) { ?>
            ...
            echo 'um';
                    ...
                    $qr_movimentos_faltas = mysql_query("SELECT cod_movimento, nome_movimento, SUM(valor_movimento) as total ,tipo_movimento, id_mov 
                                                                                                             ...
                                                                                                             WHERE id_movimento IN({$row_folha['ids_movimentos_estatisticas']}) 
                                                                                                              AND id_mov  = 62
    ...
    ?>
	  ...
	  (status = '3' or status = '4') GROUP BY id_banco");
		  ...
		  align='absmiddle' border='0'></td>";
                        ...
                        echo "<td aliddle' width='10%' $bord><a href='ver_cheque.php?enc=$linkcheque'>
