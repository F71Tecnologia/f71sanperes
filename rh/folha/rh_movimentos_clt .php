            ...
            <tr>
              <td colspan="13">
                  ...
                  <div>
                      ...
                      <p style="text-align: right; margin-top: 20px"><input type="button" onclick="tableToExcel('folha', 'Folha de Pagamento')" value="Exportar para Excel" class="exportarExcel"></p>    
                  </div>
    ...
    <tr class="linha_<?php if($linha++%2==0) { echo 'um'; } else { echo 'dois'; } ?> destaque ">
            ...
            <td  align="left">
                ...
                <?php }else{ ?>
                    ...
                    <a href="../recisao/<?php echo $link_nova_rescisao; ?>" onClick="return hs.htmlExpand(this, { objectType: 'iframe' } )" class="participante" title="Ver relatório de <?=$row_clt['nome']?>">
                        <span class="
                            <?php 		
