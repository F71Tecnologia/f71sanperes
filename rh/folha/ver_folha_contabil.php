...
if ($data > date('2010-06-09')) {
    ...
    while ($row_participante = mysql_fetch_array($qr_participantes)) {
        ...
        ?>
                        ...
                        ?> destaque">
                            <td width="70"><?= $row_participante['id_clt'] ?></td>
        ...
        ?>
                                ...
                                <a title="Atualizar Cadastro" href="../alter_clt.php?clt=<?= $row_participante['id_clt'] ?>&amp;pro=<?= $projeto ?>&amp;pagina=/intranet/rh/folha/ver_folha.php?enc=<?= $_REQUEST['enc'] ?>" onclick="return hs.htmlExpand(this, {objectType: 'iframe'})">
                                    <img src="../../imagens/icone_lapis.png" width="16" height="16" border="0">
                                </a>

                                <a title="Alterar Forma de Pagamento para Este Movimento" href="../view/alt_tipo_pag.php?regiao=<?= $regiao ?>&amp;projeto=<?= $projeto ?>&amp;folha=<?= $folha ?>&amp;id_clt=<?= $row_participante['id_clt'] ?>&amp;tipo_pg=<?= $row_participante['tipo_pg'] ?>" onclick="return hs.htmlExpand(this, {objectType: 'iframe'})" class=" ">
                                    <img src="../../imagens/btn-forma-de-pagamento.png" width="16" height="16" border="0">
                                </a>

        <?php
        if ($_COOKIE['logado'] == 87 || $_COOKIE['logado'] == 255 || $_COOKIE['logado'] == 260) {
    ...
    if (!empty($row_folha['ids_movimentos_estatisticas'])) {
        ...
        while ($movimento = mysql_fetch_array($qr_movimentos)) {
            ...
            /// print_R($movimento['cod_movimento']);
    ...
    ?>
                    <div id="conteudo_para_esconder">
                        ...
                        <!---MODO ANTIGO 17/10/2014        <table cellspacing="1">
                                <tr>
    ...
    foreach ($movimentos_valor as $chave => $valor) {
        if (!empty($valor) and $valor != 0.00) {
            ...
            ?>">
                                    ...
                                    <?php /*
                                      if ($movimentos_codigo[$chave] == 4007) {

                                      switch ($movimentos_nome[$chave]) {

                                      case 'RESCIS&Atilde;O': $link_detalhes = "<a href='calc_rescisao_folha.php?tipo=1&folha=$folha'  onClick=\"return hs.htmlExpand(this, { objectType: 'iframe'})\">  <img src=\"sintetica/seta_um.gif\"></a>";
                                      break;

                                      case 'VALOR PAGO NA RESCIS&Atilde;O': $link_detalhes = "<a href='calc_rescisao_folha.php?tipo=2&folha=$folha'  onClick=\"return hs.htmlExpand(this, { objectType: 'iframe' } )\">  <img src=\"sintetica/seta_um.gif\"></a>";
                                      break;

                                      case'INSS SOBRE RESCIS&Atilde;O': $link_detalhes = "<a href='calc_rescisao_folha.php?tipo=3&folha=$folha'  onClick=\"return hs.htmlExpand(this, { objectType: 'iframe' } )\">  <img src=\"sintetica/seta_um.gif\"></a>";
                                      break;
                                      case 'IRRF SOBRE RESCIS&Atilde;O': $link_detalhes = "<a href='calc_rescisao_folha.php?tipo=4&folha=$folha'  onClick=\"return hs.htmlExpand(this, { objectType: 'iframe' } )\">
                                      <img src=\"sintetica/seta_um.gif\"></a>";
                                      break;
                                      }
                                      }
                                     * 
                        ...
                        <td class="movimento"><?= $movimentos_nome[$chave] . $link_detalhes ?></td>
                                    <?php unset($link_detalhes); ?>
                    ...
                    <tr class="totais">
                        ...
                        <td>&nbsp;</td>
                            ...
                            <table cellspacing="1" widht="50%">
                                <tr>
                                    <td colspan="5" class="secao_pai">Resumo por Movimentos </td>
                                </tr>
                                <tr class="secao">
                                    <td>COD</td>
...
//                                        echo "</pre>";
    ...
    if ($data_inicio > '2013-12-31') {
        /* ?>   
          <tr>
          <td>PIS SOBRE FOLHA DE PAGAMENTO</td>
          <td><?php echo ?></td>
          </tr>
          <tr>
          <td>PIS ZERADO BASE INSS</td>
          <td>PIS ZERADO INSS</td>
          </tr>
    ...
    while ($row_bancos = mysql_fetch_array($qr_bancos)) {
        ...
        ?>
            ...
            <?php } ?>
                                            ...
                                            <input type="hidden" name="loteContabil" value="<?= $row_banco['id_banco']."-".$numero_banco ?>">
