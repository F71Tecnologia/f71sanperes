    ...
    <html>
        ...
        <body>
            <div id="corpo">
                ...
                <?php 
                if($_COOKIE[logado] == 255 OR $_COOKIE[logado] == 257){
                    echo '<input type="button" onclick="tableToExcel(\'tabelaToda\', \'Folha Analitica\')" value="Exportar para Excel" class="exportarExcel">
                <table id="tabelaToda"><tr><td>';
                }
                    ?>
...
-->
    ...
    <?php } ?>
<?php if($_COOKIE[logado] == 255 OR $_COOKIE[logado] == 257){echo '</td></tr></table>';}?>
