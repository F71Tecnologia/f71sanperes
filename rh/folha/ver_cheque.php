    ...
    <body class="novaintra">       
          ...
          <div id="content">
            ...
            <p style="text-align: right;">
                    <a name="pdf" data-title="Relatório de Pagamentos em Cheque" data-id="tbRelatorio" id="pdf" value="Gerar PDF" style="cursor: pointer"><i class="fa fa-file-pdf-o"></i> Gerar PDF</a></p>
