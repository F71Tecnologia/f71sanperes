...
if (!empty($_REQUEST['data_xls'])) {
    ...
    echo "  <head>";
    echo "  <title>Folha Analítica</title>";
...
//    }
    ...
    if ($ano >= 2011 AND $ano <= 2014) {
        ...
        if($row_folha['projeto'] == 3305){ // VIAMÃO
    ...
    @media print {
        ...
        <body>
            <div id="corpo">
                ...
                <div style="margin-botton: 15px;margin-top: 10px"><p style="text-align: center" class="printDocBlock esconde"><?= 'Gerado em '.date('d/m/Y').' às '.date('h:i:s').' por '.$usuario['nome'].' - F71 Sistemas Web' ?></p></div>
                            ...
                            <td> 
                                ...
                                <table width="100%"  class="sem_borda">                                    
                                    ...
                                    if ($row_participante['valor_rescisao'] != 0) {
                                         ...
                                         * FEITO EM: 15/19/2016
                                         * 
                                         * FORÇANDO PARA APARECER O VALOR DE FERIAS QUE VEM 
                                         * DO METODO GETFICHAFINANCEIRA E NÃO O QUE FOI GRAVADO 
                                         * NO FOLHA_PROC
                                         */
...
//                                            }
    ...
    <?php } ?>
                     ...
                     <div style="margin-top: 15px"><p style="text-align: center" class="printDocBlock esconde"><?= 'Gerado em '.date('d/m/Y').' às '.date('h:i:s').' por '.$usuario['nome'].' - F71 Sistemas Web' ?></p></div>
                 </div>
