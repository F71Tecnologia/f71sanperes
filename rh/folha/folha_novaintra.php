                                ...
                                while($row_folhas3 = mysql_fetch_array($result_folhas3)) {
                                    ...
                                    <?php }
                                                        ...
                                                        <tr bgcolor="<?=$cor_agora3?>">
                                                            <td width="5%" class="center valign-middle">
                                                                <?php
                                                                if($ACOES->permissoes_folha(5,$regiao)) {///permissão para VER FOLHA ?>
                                                            ...
                                                            <td width="5%" class="center valign-middle">
                                                                ...
                                                                if($data_folhaFin == $data_atualFin){
                                                                    if($ACOES->permissoes_folha(8,$regiao)) { // permissão para DESPROCESSAR folha ?>
                                                                        <a class="btn btn-xs btn-danger" href="desprocessar.php?folha=<?=$row_folhas3['id_folha']?>" title="Desprocessar Folha" onClick="return window.confirm('Você tem certeza que quer desprocessar esta folha?');"><!--img src="../imagensrh/deletar.gif" /--><i class="fa fa-ban"></i></a>
                                                                    <?php }
                                                                } ?>
                                                            </td>
                                                        </tr>
