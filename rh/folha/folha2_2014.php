...
$encinc = encrypt("$row_folha[regiao]&$folha&2"); 
$encinc = str_replace("+","--",$encinc);        
header("Location: folha2.php?enc=$encinc");
exit;
/* ATÉ AKI */
    ...
    <form action="" method="post" name="Form" onSubmit="return ValidaForm()">
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr class="novo_tr_dois">
          ...
          <td  align="center" valign="middle" bgcolor="#CCCCCC" class="style23">Atividade</td>
          <td align="center" valign="middle" bgcolor="#CCCCCC" class="style23">Unidade</td>
          <td  align="center" valign="middle" bgcolor="#CCCCCC" class="style23">Data de Admissão</td>
          <td  align="center" valign="middle" bgcolor="#CCCCCC" class="style23">Data de Demissão</td>
