<?php
      ...
      if(!empty($ids_movimentos_update_individual)) {
	   ...
	   $update_movimentos_individual['5029']  = "a5029  = '".formato_banco($decimo_terceiro_credito_final)."'";
	   ...
	   $update_movimentos_individual['50492'] = "a50492 = '".$filhos_irrf."'";
           $update_movimentos_individual['6006'] = "a6006 = '".$insalubridade_20."'";
	   //$update_movimentos_individual['insalubridade_40'] = "insalubridade_40 = '233.09'";
