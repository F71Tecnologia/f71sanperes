                        ...
                        <div class="panel sanf acord_sefip">
                            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion-example" href="#mes_<?php echo $res['mes']; ?>">
                                <div class="panel-heading">
                                        <?= ($res['terceiro'] == 2) ? mesesArray($res['mes']) : 'DÉCIMO TERCEIRO' ?>
                                        <!-- <?php if($res['terceiro'] == 1) { if($res['tipo_terceiro'] == 1) { echo '1ª PARCELA'; } else if($res['tipo_terceiro'] == 2) { echo '2ª PARCELA'; } else { echo 'INTEGRAL'; } }?>-->
