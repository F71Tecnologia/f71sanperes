...
<html>
<form name="cadastro" action="cadastroavaliacao_clt.php" method="post" onSubmit="return validaForm()">
<table width="100%" cellpadding="15" cellspacing="0">
<tr>
<td colspan="2" align="center" bgcolor="#666666"><font color="FFFFFF"><b>FICHA CRITÉRIOS DE AVALIAÇÃO</b></font></td>
</tr>
<tr>
...
<input type="hidden" name="clt" value="<? echo $clt; ?>">
