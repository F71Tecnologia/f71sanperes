...
<table cellpadding="0" cellspacing="1" class="secao">
  ...
  <tr>
    ...
    <td>
      <input name="pis" type="text" id="pis" size="12" maxlength="11" onkeyup="pula(11,this.id,data_pis.id)">
    </td>
...
$qrCpf = mysql_query("SELECT COUNT(id_clt) AS total FROM rh_clt WHERE cpf = '$cpf' AND id_projeto = '$id_projeto'");
...
data_nasc_avo_h, data_nasc_avo_m, data_nasc_bisavo_h, data_nasc_bisavo_m,municipio_nasc,uf_nasc,data_emissao, verifica_orgao, tipo_sanguineo ) 
VALUES
