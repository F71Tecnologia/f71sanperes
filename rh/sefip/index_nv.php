                                                     ...
                                                     while ($folha = mysql_fetch_assoc($qr_folha)) {
                                                         ...
                                                         if (!empty($verifica_sefip)) {
                                                             if($btn->verifica_permissao(196)){
                                                                ...
                                                                echo "<a href='../sefip_novo/controle.php?mes=" . $mes . "&ano=" . $ano . "&regiao=" . $regiao . "&projeto=" . $projeto . "&folha=" . $folha['id_folha'] . "' onClick='return false' class='dataSefip' title='Gerar SEFIP F71'>" . $nome_projeto . " - " . $nome_regiao . " (" . $total_participantes . ")</a>";
                                                             ...
                                                             echo "<a href='../sefip_novo/controle.php?mes=" . $mes . "&ano=" . $ano . "&regiao=" . $regiao . "&projeto=" . $projeto . "&folha=" . $folha['id_folha'] . "' onClick='return false' class='dataSefip' title='Gerar SEFIP*'>" . $nome_projeto . " - " . $nome_regiao . " (" . $total_participantes . ")</a>";
                                                             echo "<div style='display:none;'>
							        <input type='text' name='date' class='date' size='7'/>
