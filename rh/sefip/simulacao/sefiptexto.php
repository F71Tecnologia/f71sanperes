...
$qr_folha3 = mysql_query("SELECT * FROM rh_folha WHERE id_folha = '$id_folha'");
$row_folha3 = mysql_fetch_assoc($qr_folha3);

$regiao  = $row_folha3['regiao'];
$projeto = $row_folha3['projeto'];
...
// Buscando Ids
$qr_folha    = mysql_query("SELECT * FROM rh_folha WHERE status = '3' AND mes = '$mes' AND ano = '$ano' AND regiao != '36' AND regiao IN($regiao)");
