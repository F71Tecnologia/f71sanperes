...
$qr_regioes = mysql_query("SELECT * FROM regioes WHERE id_master = '$row_funcionario[id_master]' AND id_regiao != '36' ");
...
// Buscando Ids
$qr_folha    = mysql_query("SELECT * FROM rh_folha WHERE status = '3' AND mes = '$mes' AND ano = '$ano' AND regiao IN($regioes) AND terceiro != 1 ")or die(mysql_error());
