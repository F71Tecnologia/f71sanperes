        ...
        <form action="" method="post" name="form1">
            <div id="content">
                ...
                <fieldset>
                    ...
                    <p class="controls" style="margin-top: 10px;">O arquivo desta competência já foi gerado!</p>                   
                    <?php }?>
                </fieldset>  
        </form>
                <br/>
			...
			$tipo       = mysql_result($qr_tipodemi,0);
                ...
                <table class="grid" width="30%">
                    ...
                    <tr>
                        <td align="center">
                            <a href='Arquivos/download.php?file=CGD_$_REQUEST[regiao]_$_REQUEST[projeto]_".$mes."_".$ano.".m' class='baixar'>
