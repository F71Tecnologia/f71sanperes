...
if (empty($_REQUEST['update'])) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if (!empty($verifica_curso)) {
                                                ...
                                                print "<select name='idcursos' id='idcursos' onChange='location.href=this.value;' class='validate[required]'>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if (!empty($verifica_unidade)) {
                                                print '<select name="locacao" id="locacao" class="validate[required]">
       				    <option style="margin-bottom:3px;" value="" selected disabled>--Selecione--</option>';
                                ...
                                <table cellpadding="0" cellspacing="1" class="secao">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5">
                                            <input name="nome" type="text" id="nome" size="75" onChange="this.value = this.value.toUpperCase();" onKeyPress="return(verificanome(this, event));" class="validate[required]" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="secao">Data de Nascimento:</td>
                                        <td>
                                            <input name="data_nasc" type="text" id="data_nasc" size="15" maxlength="10" class="validate[required]"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5"><input name="cep" type="text" id="cep" maxlength="9" class="validate[required]"> <span></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="secao">Endereço:</td>
                                        <td>
                                            <input name="endereco" type="text" id="endereco" size="32" class="validate[required]" 
                                                   onchange="this.value = this.value.toUpperCase()"/>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="bairro" type="text" id="bairro" size="16" class="validate[required]" 
                                                   onchange="this.value = this.value.toUpperCase()"/>
                                        </td>
                                        <td class="secao">Cidade:</td>
                                        <td><input name="cidade" type="text" id="cidade" size="16"  onchange="this.value = this.value.toUpperCase()" class="validate[required]" /></td>
                                        <td class="secao">UF:</td>
                                        <td>   <select name="uf" id="uf" class="validate[required]" >
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="tel_fixo" type="text" id="tel_fixo" class="tel" />
                                        </td>
                                        <td class="secao">Celular:</td>
                                        <td><input name="tel_cel" class="tel" type="text" id="tel_cel" />
                                        </td>
                                        <td class="secao">Recado:</td>
                                        <td><input name="tel_rec" type="text" class="tel" id="tel_rec" />
                                        </td>
                                    </tr>
                                ...
                                <table cellpadding="0" cellspacing="1" class="secao">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="rg" type="text" id="rg" size="13" maxlength="14" class="validate[required]"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="cpf" type="text" id="cpf" size="17" maxlength="14" class="validate[required,funcCall[verificaCPF]]" />
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="trabalho" type="text" id="trabalho" size="15" class="validate[required]" />
                                        </td>
                                        <td class="secao">Série:</td>
                                        <td>
                                            <input name="serie_ctps" type="text" id="serie_ctps" size="10" class="validate[required]" />		  
                                        </td>
                                        <td class="secao">UF:</td>
                                        <td>
                                            <select name="uf_ctps" id="uf_ctps" class="validate[required]" >
                                                <option value=""></option>
                                                <?php
                                                $qr_uf = mysql_query("SELECT * FROM uf");
                                                while ($row_uf = mysql_fetch_assoc($qr_uf)) {
		...
		$row_conce[nome]</option>";
                                ...
                                <table cellpadding="0" cellspacing="1" class="secao">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="data_entrada" type="text" size="12" maxlength="10" id="data_entrada" class="validate[required]"
                                                   onkeyup="mascara_data(this);
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <select name="tipo_contrato" id="tipo_contrato">
                                                <option value="1" selected="selected">1 - Prazo Indeterminado</option>
                                                <option value="2">2 - Prazo Determinado</option>
                                                <option value="3">3 - Temporário (Casos Especiais)</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
    ...
    $query = "select cpf from rh_clt where cpf ='{$_REQUEST['cpf']}' and id_projeto = '{$_REQUEST['projeto']}'";
...
// Dados Financeiros
    ...
    //valida dados no php
    if(empty($id_curso) || empty($locacao_nome) || empty($nome) || empty($data_nasc) || empty($cep)){
        echo "
        <html>
            <head>
                <title>:: Intranet ::</title>
            ...
            <body>
                <script type='text/javascript'>
                    alert('Favor, verifique os campos Curso, Unidade, Nome, Data de Nascimento e CEP, eles não podem ser vazios');
                    history.back();
                </script>
            </body>
        </html>";
        exit();
    }elseif(empty($endereco) || empty($bairro) || empty($cidade) || empty($rg) || empty($cpf)){
        echo "
        <html>
            <head>
                <title>:: Intranet ::</title>
            ...
            <body>
                <script type='text/javascript'>
                    alert('Favor, verifique os campos Endereço, Bairro, Cidade, Nº do RG, CPF, eles não podem ser vazios');
                    history.back();
                </script>
            </body>
        </html>";
        exit();
    }elseif(empty($campo1) || empty($serie_ctps) || empty($uf_ctps)){
        echo "
        <html>
            <head>
                <title>:: Intranet ::</title>
            ...
            <body>
                <script type='text/javascript'>
                    alert('Favor, verifique os campos Nº Carteira de Trabalho, Série, UF da CTPS, eles não podem ser vazios');
                    history.back();
                </script>
            </body>
        </html>";
        exit();
    }elseif(empty($data_entrada) || empty($localpagamento) || empty($tipo_admissao) || empty($pis)){
        echo "
        <html>
            <head>
                <title>:: Intranet ::</title>
            ...
            <body>
                <script type='text/javascript'>
                    alert('Favor, verifique os campos Data de entrada, PIS, Local de Pagamento e Tipo de admissao, eles não podem ser vazios');
                    history.back();
                </script>
            </body>
        </html>";
...
// Request referente ao sindicato do funcionário
     ...
     * sobrescrita pela função no wfunction.php
     */
...
//    }
    ...
    $data_filho_1 = (!empty($data_filho_1)) ? ConverteData($data_filho_1) : '';
    $data_filho_2 = (!empty($data_filho_2)) ? ConverteData($data_filho_2) : '';
    $data_filho_3 = (!empty($data_filho_3)) ? ConverteData($data_filho_3) : '';
    $data_filho_4 = (!empty($data_filho_4)) ? ConverteData($data_filho_4) : '';
    $data_filho_5 = (!empty($data_filho_5)) ? ConverteData($data_filho_5) : '';
    $data_filho_6 = (!empty($data_filho_6)) ? ConverteData($data_filho_6) : '';
    $data_nasc = (!empty($data_nasc)) ? ConverteData($data_nasc) : '';
    $data_rg = (!empty($data_rg)) ? ConverteData($data_rg) : '';
    $data_escola = (!empty($data_escola)) ? ConverteData($data_escola) : '';
    $data_entrada = (!empty($data_entrada)) ? ConverteData($data_entrada) : '';
    $pis_data = (!empty($pis_data)) ? ConverteData($pis_data) : '';
    $exame_data = (!empty($exame_data)) ? ConverteData($exame_data) : '';
    $trabalho_data = (!empty($trabalho_data)) ? ConverteData($trabalho_data) : '';

    $data_nasc_pai = (!empty($data_nasc_pai)) ? ConverteData($data_nasc_pai) : '';
    $data_nasc_mae = (!empty($data_nasc_mae)) ? ConverteData($data_nasc_mae) : '';
    $data_nasc_conjuge = (!empty($data_nasc_conjuge)) ? ConverteData($data_nasc_conjuge) : '';
    $data_nasc_avo_h = (!empty($data_nasc_avo_h)) ? ConverteData($data_nasc_avo_h) : '';
    $data_nasc_avo_m = (!empty($data_nasc_avo_m)) ? ConverteData($data_nasc_avo_m) : '';
    $data_nasc_bisavo_h = (!empty($data_nasc_bisavo_h)) ? ConverteData($data_nasc_bisavo_h) : '';
    $data_nasc_bisavo_m = (!empty($data_nasc_bisavo_m)) ? ConverteData($data_nasc_bisavo_m) : '';
    $data_emissao = (!empty($data_emissao)) ? ConverteData($data_emissao) : '';
...
//(id_projeto,id_regiao,localpagamento,locacao,id_unidade,nome,sexo,endereco,numero,complemento,bairro,cidade,uf,cep,tel_fixo,tel_cel,tel_rec,
...
//data_nasc_avo_h, data_nasc_avo_m, data_nasc_bisavo_h, data_nasc_bisavo_m,municipio_nasc,uf_nasc,data_emissao, verifica_orgao, tipo_sanguineo, ano_contribuicao, ano_chegada_no_pais, cod_pais_rais, tipo_contrato ) 
//VALUES
//('$id_projeto','$regiao','$localpagamento','$locacao_nome','$locacao_id','$nome','$sexo','$endereco','$numero','$complemento','$bairro','$cidade','$uf',
...
//    '$municipio_nasc','$uf_nasc', '$data_emissao', '$verifica_orgao', '$tiposanguineo', '$ano_contribuicao', '$ano_chegada_pais','$cod_nacionalidade', '$tipo_contrato')") or die("$mensagem_erro<br><BR>" . mysql_error());
