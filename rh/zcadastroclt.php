                ...
                $(document).ready(function() {
                    ...
                    $('#horario').change(function() {
                        if ($('#horario').val() != '') {
                            ...
                            console.log($('#horas_semanais').val());
                        }
                    });
       				    ...
       				    <option style='margin-bottom:3px;$var_disabled' value='' selected disabled>--Selecione--</option>";
                                                ...
                                                while ($row_curso = mysql_fetch_array($qr_curso)) {
                                                    ...
                                                    if ($row_curso['0'] == $idcurso) {
                                                        ...
                                                        print "<option value='{$_SERVER['PHP_SELF']}?regiao=$id_regiao&projeto=$projeto&idcursos=$row_curso[0]'$var_margem>$row_curso[0] - $row_curso[campo2] (Valor: $salario)</option>";
                                                    }
                                                }
       				    ...
       				    <option style="margin-bottom:3px;" value="" selected disabled>--Selecione--</option>';
                                ...
                                <table cellpadding="0" cellspacing="1" class="secao">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="municipio_nasc" type="text" id="municipio_nasc" size="15" class="municipio"  />
                                            <input type="text" readonly="readonly" name="cod_municipio_nasc" id="cod_municipio_nasc" size="4"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr id="ano-chegada">
                                        ...
                                        <td>
                                            <input name="ano_chegada_pais" id="ano_chegada_pais" type="text" size="15" maxlength="10" class="validate[required]"
                                                   onkeyup="mascara_data(this);"/>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="cidade" type="text" id="cidade" size="16"  onchange="this.value = this.value.toUpperCase()" class="validate[required] municipio"  />
                                            <input type="text" readonly="readonly" name="cod_cidade" id="cod_cidade" size="4"/>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table cellpadding="0" cellspacing="1" class="secao">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="data_nasc_pai" id="data_nasc_pai" onkeyup="mascara_data(this);" /></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="data_nasc_mae" id="data_nasc_mae" onkeyup="mascara_data(this);"/> </td>
                                    </tr>
                                    ...
                                    <tr>          
                                        ...
                                        <td colspan="3"><input type="text" name="data_nasc_avo_h" id="data_nasc_avo_h" onkeyup="mascara_data(this);"/> </td>
                                    </tr>
                                    ...
                                    <tr>            
                                        ...
                                        <td colspan="3"><input type="text" name="data_nasc_avo_m" id="data_nasc_avo_m" onkeyup="mascara_data(this);"/> </td>
                                    </tr>
                                    ...
                                    <tr>            
                                        ...
                                        <td colspan="3"><input type="text" name="data_nasc_bisavo_h" id="data_nasc_bisavo_h" onkeyup="mascara_data(this);"/> </td>
                                    </tr>
                                    ...
                                    <tr>              
                                        ...
                                        <td colspan="3"><input type="text" name="data_nasc_bisavo_m" id="data_nasc_bisavo_m" onkeyup="mascara_data(this);" /> </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input name="data_nasc_conjuge" type="text" id="data_nasc_conjuge" size="15" 
                                                   onchange="this.value = this.value.toUpperCase()" onkeyup="mascara_data(this);"/>	
                                        </td>
                                    </tr> 
                                    <tr>
...
id_estado_civil, id_municipio_nasc, id_municipio_end, id_pais_nasc, id_pais_nacionalidade ) 
VALUES
...
$data_nasc_pai, $data_nasc_mae,$data_nasc_conjuge,'$conjuge', '$avo_h', '$avo_m', '$bisavo_h', '$bisavo_m', $data_nasc_avo_h,$data_nasc_avo_m, $data_nasc_bisavo_h, $data_nasc_bisavo_m,
    '$municipio_nasc','$uf_nasc', $data_emissao, '$verifica_orgao', '$tiposanguineo', '$ano_contribuicao', $ano_chegada_pais,'$cod_nacionalidade', '$tipo_contrato', '$prazoExp', '$estCivilId', '$cod_muni_nasc','$cod_cidade', '$cod_pais_nasc', '$cod_pais_nacionalidade')") or die("$mensagem_erro<br><BR>" . mysql_error());
