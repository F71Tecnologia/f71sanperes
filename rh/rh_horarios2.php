        ...
        while ($row_horarios = mysql_fetch_assoc($result_horarios)) {
            ...
            <tr>
                ...
                <td class="valign-middle center">
                    <a class="btn btn-xs btn-warning" href='rh_horarios_alterar2.php?regiao=<?=$regiao?>&horario=<?=$row_horarios[id_horario]?>'>
            ...
            $(function () {
                ...
                $(".tab").on("click",function(){
                    ...
                    if ( $("div[class='tab-pane "+ key +"']").length == 0){
                        ...
                        $.post("rh_horarios2.php", {bugger:Math.random(), ajaxProjeto:key}, function(resultado){
