...
///VERIFICANDO SE O CLT ESTA EM ALGUMA FOLHA
    ...
    if (isset($_REQUEST['method']) && !empty($_REQUEST['method'])) {
        if ($_REQUEST['method'] == "removerFavorecido") {
            ...
            $query = mysql_query("UPDATE favorecido_pensao_assoc SET status_reg = 1 WHERE id = '{$_REQUEST['id']}'") or die('Erro ao remover favorecido');
            if ($query) {
        ...
        if ($_REQUEST['method'] == "removendoFavorecidos") {
            $retorno = array("status" => 0);
            $query = mysql_query("UPDATE favorecido_pensao_assoc SET status_reg = 1 WHERE  id_clt = '{$_REQUEST['id_clt']}'") or die('Erro ao remover favorecido');
            if ($query) {
                $retorno = array("status" => 1);
            }
...
//                                                                        }
                                                                                            ...
                                                                                            <table cellpadding="0" cellspacing="1" style="background-color: white;" class="secao" id="tablevale" <?= $disable_vale ?>>
                                                                                                <tr>
    ...
    <?php } ?>
                                        ...
                                        <!--                                                        <tr>
                                                                                            ...
                                                                                            <table cellpadding="0" cellspacing="1" class="secao" id="tablePensao" <?= $disable_pensao ?>>
                                                                                                ...
                                                                                                <?php $query_dados_pensao = mysql_query("SELECT * FROM favorecido_pensao_assoc WHERE id_clt  = '{$id_clt}' AND reg_status = 1"); ?>
                                                                                                <?php $rows = ""; ?>
    <?php if (mysql_num_rows($query_dados_pensao) > 0) {  $cont = 0; 
        ...
        <?php while ($rows_pensao = mysql_fetch_assoc($query_dados_pensao)) { ?>
                                                                                                        <tbody class="rows_pensao_<?php echo $rows_pensao['id']; ?> remover_<?php echo $rows_pensao['id']; ?>" data-key="<?php echo $rows_pensao['id']; ?>">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td colspan="1">
                                                                                                                    <input type="text" name="nome_favorecido[]" id="nome_favorecido"  value="<?php echo isset($rows_pensao['favorecido']) ? $rows_pensao['favorecido'] : ""; ?>" />
