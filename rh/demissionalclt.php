...
$result_verifica = mysql_query("SELECT * FROM rh_doc_status WHERE tipo = '13' and id_clt = '$id_clt'");
$num_row_verifica = mysql_num_rows($result_verifica);
if($num_row_verifica == "0"){
	mysql_query("INSERT INTO rh_doc_status(tipo,id_clt,data,id_user) VALUES ('13','$id_clt','$data_cad', '$user_cad')");
}else{
	mysql_query("UPDATE rh_doc_status SET data = '$data_cad', id_user = '$user_cad' WHERE id_clt = '$id_clt' and tipo = '13'");
}
//-------------GRAVANDO NA TABELA DOCUMENTOS GERADOS
?>
    ...
    <table width="650" height="100" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF" class="bordaescura1px">
        ...
        <tr>
            ...
            <td><p align="center">&nbsp;</p>
                ...
                <p align="center">&nbsp;</p>
                <p>&nbsp;</p>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Apresentamos o (a) Senhor (a) <strong><?php print "$row[nome]"; ?> </strong>portador(a) do RG<strong> <?php print "$row[rg]"; ?> </strong>para ser submetido (a) a exame m&eacute;dico demissional,  ao qual ocupavao cargo de<strong> <?php print "$row_curso[campo2]"; ?></strong>.</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
