            ...
            <div class="col-lg-6 col-sm-6 col-xs-12 col-xxs-12">
                <div class="smallstat pointer" data-url="../relatorios/relatorio_pers.php">
                    ...
                    <div class="h-50 display-table">
                        <div class="vcenter">
                            <a href="../relatorios/relatorio_pers.php" target="_blank" class="value text-success" style="">Relatório Personalizado</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <?php foreach ($arr_rel as $relatorio) { 
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-12 col-xxs-12">
                        <div class="smallstat pointer" data-url="<?=$rel_link;?>" data-id="<?=$relatorio['id_relatorio']?>">
                            ...
                            <div class="h-50 display-table">
                                <div class="vcenter">
                                    <a href="<?=$rel_link;?>" target="_blank" class="value text-success" style=""><?=$relatorios->relatorioNovo($relatorio['id_relatorio'])?> <?=str_replace('Relatório de ','',$relatorio['nome'])?></a>
                                </div>
                            </div>
                        </div>
                    </div>
