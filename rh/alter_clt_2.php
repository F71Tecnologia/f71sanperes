...
///VERIFICANDO SE O CLT ESTA EM ALGUMA FOLHA
    ...
    <?php if (!isset($_GET['folha'])) { ?>
                                            ...
                                            <p>&nbsp;</p>
                                            <form action="alter_clt_2.php" method="post" id="form1" name="form1" onSubmit="return validaForm()" enctype="multipart/form-data">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select name="locacao" id="locacao">
                                                                <?php
                                                                $result_unidade = mysql_query("SELECT * FROM unidade WHERE id_regiao = $row[id_regiao] ORDER BY unidade");
                                                                while ($row_unidade = mysql_fetch_array($result_unidade)) {
                                                                    if ($row_unidade['unidade'] == "$row[locacao]") {
                                                                        print "<option selected value='".$row_unidade[unidade]." // ".$row_unidade[id_unidade]."'>$row_unidade[id_unidade] - $row_unidade[unidade]</option>";
                                                                    } else {
    ...
    <?php } ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input name="tel_cel" type="text" id="tel_cel" size="16" value="<?= $row['tel_cel'] ?>" /></td>
    ...
    <?php if (!empty($row['desconto_inss'])) {
        echo 'checked';
    } ?> /></label>
                                                                                                </td>
                                                                                        ...
                                                                                        <table cellpadding="0" cellspacing="1" class="secao" id="desconto_inss" <?php if (empty($row['desconto_inss'])) {
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <label><input name="tipo_desconto_inss" type="radio" class="reset" onClick="document.getElementById('valor_desconto_inss').style.display = 'none';" value="isento"
                                                                                                               <?php if ($row['tipo_desconto_inss'] == 'isento' or empty($row['tipo_desconto_inss'])) {
                                                                                                                   echo 'checked';
                                                                                                               } ?>>
    ...
    <?php if ($row['tipo_desconto_inss'] == 'parcial') {
        echo 'checked';
    } ?>>Parcial</label>
    ...
    <?php if ($row['trabalha_outra_empresa'] == 'sim') {
        echo 'checked';
    } ?>>Sim</label>
                                                                                                    <label><br />
    ...
    <?php if ($row['trabalha_outra_empresa'] == 'nao') {
        echo 'checked';
    } ?>>Não</label>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr id="outra_empresa" <?php if ($row['trabalha_outra_empresa'] == 'nao' or empty($row['trabalha_outra_empresa'])) {
                                                                                                        echo 'style="display:none;"';
                                                                                                    } ?>>
...
// Habilita ou desabilita o formulário "Selecionar" Sindicato
                                                                                        ...
                                                                                        <table cellpadding="0" cellspacing="1" class="secao">
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td width="80%">
                                                                                                    ...
                                                                                                    <label><input name="radio_sindicato" type="radio" class="reset" onClick="document.getElementById('trsindicato').style.display = 'none';" value="nao" <?= $checked_nao ?>>Não</label>
                                                                                                </td>
                                                                                            </tr>
    ...
    ?>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td width="80%">
                                                                                                    <label><input name="radio_contribuicao" type="radio" class="reset" onClick="document.getElementById('trcontribuicao').style.display = '';" value="sim" <?php if (!empty($row['ano_contribuicao'])) {
        echo 'checked="checked"';
    } ?>>Sim</label>
                                                                                                    <label><input name='radio_contribuicao' type='radio' class="reset" onClick="document.getElementById('trcontribuicao').style.display = 'none';" value='nao' <?php if (empty($row['ano_contribuicao'])) {
                                                                                                        echo 'checked="checked"';
                                                                                                    } ?> >Não</label>
                                                                                                </td>
                                                                                            </tr>
...
///VERIFICANDO SE O CLT ESTA EM ALGUMA FOLHA
                                    ...
                                    WHERE B.id_clt = $id_clt AND B.status IN(2, 3)"));
                                                                                                                                    ...
                                                                                                                                    mysql_query("UPDATE rh_clt SET  $sql_curso localpagamento = '$localpagamento', locacao = '$locacao_nome', id_unidade = '$locacao_id', nome = '$nome', sexo = '$sexo', endereco = '$endereco',numero = '$numero', bairro = '$bairro', cidade = '$cidade', uf = '$uf', cep = '$cep', tel_fixo = '$tel_fixo',
...
data_nasc_avo_h = '$data_nasc_avo_h', nome_avo_m = '$avo_m', data_nasc_avo_m = '$data_nasc_avo_m', nome_bisavo_h = '$bisavo_h', data_nasc_bisavo_h = '$data_nasc_bisavo_h',
    nome_bisavo_m = '$bisavo_m', data_nasc_bisavo_m = '$data_nasc_bisavo_m', municipio_nasc = '$municipio_nasc', uf_nasc = '$uf_nasc', data_emissao = '$data_emissao', verifica_orgao = '$verifica_orgao', tipo_sanguineo = '$tipo_sanguineo', ano_contribuicao = '$ano_contribuicao', ano_chegada_no_pais = '$ano_chegada_pais', cod_pais_rais = '$cod_nacionalidade'
