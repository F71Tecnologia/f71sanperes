...
VALUES ('$funcionario[0]', '$funcionario[id_regiao]', '$funcionario[tipo_usuario]', '$funcionario[grupo_usuario]', '$local_banco', NOW(), '$ip', '$acao_banco')") or die("Erro Inesperado1<br><br>" . mysql_error());
...
$posts_sefip = array($_POST['codigo'], $_POST['nome'], formata($_POST['data_nasc']), str_replace('"', ' ', str_replace("'",'',$_POST['trabalho'])),
...
for ($b = 0; $b <= 8; $b++) {
    if ($colunas_sefip[$b] != $posts_sefip[$b]) {
        mysql_query("INSERT INTO log (id_user, id_regiao, tipo_user, grupo_user, local, horario, ip, sefip, sefip_ano, sefip_mes, sefip_id, sefip_tipo, sefip_codigo, sefip_valor) VALUES ('$funcionario[0]', '$funcionario[id_regiao]', '$funcionario[tipo_usuario]', '$funcionario[grupo_usuario]', '$local_banco', NOW(), '$ip', '1', '$ano_sefip', '$mes_sefip', '$_REQUEST[id_clt]', '2', '$codigos_sefip[$b]', '$posts_sefip[$b]')") or die("Erro Inesperado2<br><br>INSERT INTO log (id_user, id_regiao, tipo_user, grupo_user, local, horario, ip, sefip, sefip_ano, sefip_mes, sefip_id, sefip_tipo, sefip_codigo, sefip_valor) VALUES ('$funcionario[0]', '$funcionario[id_regiao]', '$funcionario[tipo_usuario]', '$funcionario[grupo_usuario]', '$local_banco', NOW(), '$ip', '1', '$ano_sefip', '$mes_sefip', '$_REQUEST[id_clt]', '2', '$codigos_sefip[$b]', '$posts_sefip[$b]')" . mysql_error());
    }
}
// Fim do Log
