...
//                                            echo $verifica_curso;
    ...
    <!--                                        <td class="secao">Dependente:</td>
                                    ...
                                    <tr>
                                        <td class="secao">Proporcionalidade de INSS:</td>
                                ...
                                <table cellpadding="0" cellspacing="1" class="secao" id="desconto_inss" style="display:none;">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <label><input name="trabalha_outra_empresa" type="radio" class="reset" onClick="$('.outra_empresa').fadeIn();$('#novo_inss').fadeIn();" value="sim">Sim</label>
                                                <label><input name="trabalha_outra_empresa" type="radio" class="reset" onClick="$('.outra_empresa').FadeOut();$('#novo_inss').fadeOut();" value="nao" checked>Não</label>
                                            </td>
...
id_estado_civil, id_municipio_nasc, id_municipio_end, id_pais_nasc, id_pais_nacionalidade, vale_refeicao, vale_alimentacao, pensao_alimenticia, carteira_sus ) 
VALUES
('$id_projeto','$id_setor','$id_plano_saude','$regiao','$localpagamento','$locacao_nome','$locacao_id','$nome','$sexo','$endereco','$tipo_endereco', '$numero','$complemento','$bairro','$cidade','$uf',
...
$data_nasc_pai, $data_nasc_mae,$data_nasc_conjuge,'$conjuge', '$avo_h', '$avo_m', '$bisavo_h', '$bisavo_m', $data_nasc_avo_h,$data_nasc_avo_m, $data_nasc_bisavo_h, $data_nasc_bisavo_m,
    '$municipio_nasc','$uf_nasc', $data_emissao, '$verifica_orgao', '$tiposanguineo', '$ano_contribuicao', $ano_chegada_pais,'$cod_nacionalidade', '$tipo_contrato', '$prazoExp', '$estCivilId', '$cod_muni_nasc','$cod_cidade', '$cod_pais_nasc', '$cod_pais_nacionalidade','$vale_refeicao', '$vale_alimentacao', '$pensao_percentual','$carteira_sus')";
    ...
    foreach ($_REQUEST['salario_outra_empresa'] as $key => $sal_outra_empresa) {
        ...
        $query = "INSERT INTO rh_inss_outras_empresas (id_clt,salario,desconto,inicio,fim,status,data_cad) VALUES ('$row_id_participante','$sal_outra_empresa','{$desconto_inss}','{$inicio_inss}','{$fim_inss}',1,NOW());";
