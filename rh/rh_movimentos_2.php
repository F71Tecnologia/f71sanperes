...
//            AND status = 1 AND id_clt = $id_clt AND id_mov = $id_mov</pre>";
    ...
    header('Location: rh_movimentos_2.php?clt='.$id_clt);
    exit;
}
...
$breadcrumb_pages = array("Gestão de RH"=>"../", "Movimentos"=>"rh_movimentos2.php");
        ...
        <div class="container">
            ...
            <form class="form-inline" role="form" id="form1" method="post">
                ...
                <div class="col-lg-12 page-header">
                    ...
                    <input type="submit" class="btn btn-primary center" name="confirmar" value="Confirmar">
                </div>
            </form>
                            ...
                            <!--table class="table table-hover table-striped text-sm table-condensed"-->
                                ...
                                foreach ($movLancado['CREDITO'] as $movimentos) { ?>
                                    <tr  style="background-color: <?=$cor?>">
                                        ...
                                        <td><i class="fa fa-trash excluir pointer" rel="<?=$movimentos['id_movimento']?>" ></i></td>
                                    <tr>                     
                                <?php } ?>
                                </tbody>
                            </table>
