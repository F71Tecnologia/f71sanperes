...
$('#horas_mes, #dias_mes').blur(function(){
...
<td><?php echo $row_horarios['entrada_1']?></td>
<td><?php echo $row_horarios['saida_1']?></td>
<td><?php echo $row_horarios['entrada_2']?></td>
<td><?php echo $row_horarios['saida_2']?></td>
