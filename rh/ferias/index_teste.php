...
if($regiao == '15') :
					...
					$status++;
					if($row_regiao['id_regiao'] == '15') continue;
					
					$mostrar_regiao=0;
					
					       $total_clt = NULL;
                                          $qr_projetos = mysql_query("SELECT * FROM projeto WHERE id_regiao = '$row_regiao[id_regiao]' AND status_reg = '1' OR status_reg = '0' ORDER BY nome ASC");
                                          while($projetos = mysql_fetch_assoc($qr_projetos)) {
                                        ...
                                        <table width="95%" align='center' style="margin-top:5px;">
                                              <tr>
                                                <td colspan="7">
                                                <a href="<?php echo $row_regiao['id_regiao']; ?>" class="regiao" onclick="return false" style="text-decoration:none;"> <?php echo $row_regiao['regiao'];  ?></a>
                                        ...
                                        <table width="100%" border='0' cellpadding='8' cellspacing='0' bgcolor='#f5f5f5' align='center' style="margin-top:20px; ">
                                          <tr>
                                            <td colspan="7" class="show" >
                                                &nbsp;<span class="seta">&#8250;</span> <?php echo $projetos['nome']; ?> 
                                            </td>
