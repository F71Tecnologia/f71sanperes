                            ...
                            <tr>
                                <td>
                                    <div id="tela2">
                                        ...
                                        <?php
                                        // Verificando número de periodos disponiveis
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td rowspan="3">
                                                                <?php if (in_array($_COOKIE['logado'], array('5', '9', '68', '75', '82', 87))) { ?>
                                                                    <a href="index.php?deletar=true&id=<?php echo $id_ferias; ?>&enc=<?php echo $_GET['enc']; ?>&id_clt=<?php echo $id_clt; ?>" title="Desprocessar Férias" onclick="return window.confirm('Você tem certeza que quer desprocessar esta férias?');"><img src="../imagensrh/deletar.gif" /></a>
                                                                <?php } ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
