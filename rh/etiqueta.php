...
<HTML>
    ...
    <BODY onload="print();">
        <div class="etiquetaPrincipal">
            ...
            <div class="divDados">
                <b>Empregador:</b> <?php echo $row_master['razao'];?> <b>CNPJ/MF:</b> <?= $row_master['cnpj']; ?><br/>
                <b>Rua:</b> <?= $row_master['endereco']; ?> <br/><br/>
                <b>Nome:</b> <?= $row_clt['nome']; ?> <b>Cargo:</b> <? echo $row_curso['nome']; ?><br/>
                <b>CBO n°:</b> <?= $row_curso['cbo_codigo'];; ?> <b>Data admissão:</b> <?= $row_clt['data_entrada']; ?> <b>Registro n°:</b> <?= $row_clt['matricula']; ?><br/>
