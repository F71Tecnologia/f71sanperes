   ...
   $qr_folha = mysql_query("SELECT  *,(total_inss+total_fgts+total_pis) as total_guias
                           ...
                           FROM 
                                   (SELECT *, 
                                                           ...
                                                           */
                                                           ...
                                                           (SELECT A.id_folha, A.regiao, A.projeto, A.data_inicio, A.data_fim,A.terceiro, A.tipo_terceiro, if(A.terceiro = 1, 13, A.mes) as mes_folha,
                                                           SUM(B.sallimpo_real) as total_base,
                                                           SUM(B.rend) as total_rend,
                                                           SUM(B.valor_pago_rescisao) as valor_pago_rescisao,
                                                           SUM(B.valor_ferias) as valor_ferias, 
                                                           ...
                                                           GROUP BY  mes_folha, A.ano) as folha
    ...
    while ($row = mysql_fetch_assoc($qr_folha)) {
           ...
           //CRIANDO OS  ARRAYS DE VALORES MENSAIS
            ...
            $valores['RENDIMENTOS'][$mes]                  =   $row['total_rend'] - $row['valor_ferias'] - $row['valor_pago_rescisao'] + $total_saldoSalario;
