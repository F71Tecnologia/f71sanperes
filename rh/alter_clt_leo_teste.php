...
//                                    if($_COOKIE['logado']==202){ 
                                ...
                                ?>>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <label><input name="trabalha_outra_empresa" type="radio" class="reset" onClick="$('.outra_empresa').fadeIn();$('#novo_inss').fadeIn();" value="sim"
                                                    <?php
                                                    ...
                                                    ?>/>Sim</label>
                                                <label><br />
                                                    <input name="trabalha_outra_empresa" type="radio" class="reset" onClick="$('.outra_empresa').fadeOut();$('#novo_inss').fadeOut();" value="nao"
                                                    <?php
                                ...
                                <script>
                                    $(function () {
                                        ...
                                        $("body").on("click", ".add_favorecido", function () {
                                            ...
                                            $(seletor).after("<tr class='rows_pensao_" + contador + "' >\n\
                                                ...
                                                <td><input type='text' name='aliquota_favorecido[]' id='aliquota_favorecido_" + contador + "'  value='' /></td>\n\\n\
                                                <td class='remover'><a href='javascript:;' class='remover_favorecido' data-count='" + contador + "'>-</a></td>\n\
                                            </tr>");
    ...
    //                                        });
                                ...
                                <table cellpadding="0" cellspacing="1" class="secao" id="tablePensao" style="display:none;"  <?= $disable_pensao ?>>
                                    <tr>
                                    ...
                                    <?php if (mysql_num_rows($query_dados_pensao) > 0) { ?>
                                        <?php while ($rows_pensao = mysql_fetch_assoc($query_dados_pensao)) { ?>
                                            <tr class="rows_pensao_<?php echo $rows_pensao['id']; ?> remover_<?php echo $rows_pensao['id']; ?>" data-key="<?php echo $rows_pensao['id']; ?>">
                                                <td class="secao" width="235px">Nome Favorecido:</td>
                                                ...
                                                <td class="secao">Aliquota:</td>
                                                <td colspan="1"><input type="text" name="aliquota_favorecido[]" id="aliquota_favorecido"  value="<?php echo isset($rows_pensao['aliquota']) ? $rows_pensao['aliquota'] : ""; ?>" /></td>
                                        ...
                                        <?php } ?>
                                    <?php } else { ?>
                                        <tr class="rows_pensao remover_<?php echo (isset($rows_pensao['id'])) ? $rows_pensao['id'] : ""; ?>">
                                            <td class="secao" width="235px">Nome Favorecido:</td>
                                            <td colspan="1"><input type="text" name="nome_favorecido[]" id="nome_favorecido"  value="<?php echo isset($rows_pensao['favorecido']) ? $rows_pensao['favorecido'] : ""; ?>" /></td>
                                            <td class="secao">CPF Favorecido:</td>
                                            <td colspan="1"><input type="text" name="cpf_favorecido[]" id="cpf_favorecido"  value="<?php echo isset($rows_pensao['cpf']) ? $rows_pensao['cpf'] : ""; ?>" /></td>
...
///VERIFICANDO SE O CLT ESTA EM ALGUMA FOLHA
        ...
        if (mysql_query($query_remove_pensao)) {
             ...
             */
            $query_pensao = "INSERT INTO favorecido_pensao_assoc (id_clt,favorecido,cpf,aliquota) VALUES ";
            for ($i = 0; $i < count($_REQUEST['nome_favorecido']); $i++) {
                $query_pensao .= "('{$id_clt}','{$_REQUEST['nome_favorecido'][$i]}','{$_REQUEST['cpf_favorecido'][$i]}','{$_REQUEST['aliquota_favorecido'][$i]}'),";
            }
        ...
        $query = "UPDATE rh_clt SET  $sql_curso localpagamento = '$localpagamento',nome = '$nome',id_setor = '$id_setor', id_plano_saude='$id_plano_saude', sexo = '$sexo', endereco = '$endereco', tipo_endereco='$tipo_endereco', numero = '$numero', bairro = '$bairro', cidade = '$cidade', uf = '$uf', cep = '$cep', tel_fixo = '$tel_fixo', complemento = '$complemento',
            ...
            pensao_alimenticia = '$pensao_percentual'    
...
//
        ...
        if (empty($row_cont1)) {
            ...
            mysql_query("INSERT INTO dependentes (id_regiao, id_projeto, id_bolsista, contratacao, nome, data1, nome1, data2, nome2, data3, nome3, data4, nome4, data5, nome5, data6, nome6, ddir_pai, ddir_mae, ddir_conjuge, portador_def1,portador_def2, portador_def3, portador_def4, portador_def5, portador_def6, dep1_cur_fac_ou_tec, dep2_cur_fac_ou_tec, dep3_cur_fac_ou_tec, dep4_cur_fac_ou_tec, dep5_cur_fac_ou_tec, dep6_cur_fac_ou_tec,ddir_avo_h, ddir_avo_m, ddir_bisavo_h, ddir_bisavo_m)
        VALUES
        ('$regiao', '$id_projeto', '$referencia', '2', '$nome', $data_filho_1, '$filho_1', $data_filho_2, '$filho_2', $data_filho_3, '$filho_3', $data_filho_4, '$filho_4', $data_filho_5, '$filho_5', $data_filho_6, '$filho_6', '$ddir_pai', '$ddir_mae', '$ddir_conjuge', '$portador1', '$portador2', '$portador3', '$portador4', '$portador5', '$portador6', '$dep1_cur_fac_ou_tec', '$dep2_cur_fac_ou_tec', '$dep3_cur_fac_ou_tec', '$dep4_cur_fac_ou_tec', '$dep5_cur_fac_ou_tec', '$dep6_cur_fac_ou_tec', '$ddir_avo_h', '$ddir_avo_m', '$ddir_bisavo_h', '$ddir_bisavo_m')") or die("Insert de Dependentes: " . mysql_error());
        } else {

            $query = "UPDATE dependentes SET contratacao = '2', data1 =$data_filho_1, nome1 = '$filho_1', data2 = $data_filho_2, nome2 = '$filho_2', data3 = $data_filho_3, nome3 = '$filho_3', data4 = $data_filho_4, nome4 = '$filho_4', data5 = $data_filho_5, nome5 = '$filho_5', data6 = $data_filho_6, nome6 = '$filho_6',
                        ddir_pai = '$ddir_pai', ddir_mae = '$ddir_mae', ddir_conjuge = '$ddir_conjuge', portador_def1 = '$portador1',portador_def2 = '$portador2', portador_def3 = '$portador3', portador_def4 = '$portador4', portador_def5 = '$portador5', portador_def6 = '$portador6', dep1_cur_fac_ou_tec = '$dep1_cur_fac_ou_tec', dep2_cur_fac_ou_tec = '$dep2_cur_fac_ou_tec', dep3_cur_fac_ou_tec = '$dep3_cur_fac_ou_tec', dep4_cur_fac_ou_tec = '$dep4_cur_fac_ou_tec', dep5_cur_fac_ou_tec = '$dep5_cur_fac_ou_tec', dep6_cur_fac_ou_tec = '$dep6_cur_fac_ou_tec', ddir_avo_h = '$ddir_avo_h', ddir_avo_m = '$ddir_avo_m', ddir_bisavo_h = '$ddir_bisavo_h', ddir_bisavo_m = '$ddir_bisavo_m' 
