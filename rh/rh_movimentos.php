...
switch($tela) {
    ...
    <p style="text-align: left; margin-top: 20px">
        <input type="button" onclick="tableToExcel('tbRelatorio', 'Relatório')" value="Exportar para Excel" class="exportarExcel">        
  ...
  <?php while($row_clt = mysql_fetch_array($result_clt)) {
		...
		$row_curso = mysql_fetch_array($result_curso);
                ...
                ///USADO NA PAGIANÇÂO DOS MOVIMENTOS
                $pagina = 0;
        ...
        <tr>
          ...
          <table width="97%" border="0" cellspacing="0" cellpadding="0" class="style7 linhastabela1" id="tabeladebito" align="center">
            ...
            <tr>
               ...
               DESCONTO VALE ALIMENTAÇÃO</label>
                </td>
            	  <td width="27%" align="center">
                  <label>
...
if($cod_movimento == 195  or $cod_movimento == 202 ){ /////DESCONTO AUXILIO DISTÂNCIA
