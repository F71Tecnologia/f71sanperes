                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            foreach ($status as $status_reg => $tipo) {
                                ...
                                $qr_projetos = mysql_query("SELECT * FROM projeto WHERE id_regiao = '$regiao' and status_reg = '$status_reg' ORDER BY id_projeto ASC");
                                $qr_projetos2 = mysql_query("SELECT * FROM projeto WHERE id_regiao = '$regiao' and status_reg = '$status_reg' ORDER BY id_projeto ASC");
                                                ...
                                                <div class="info-box <?php echo $class ?> pointer no-padding-hr" data-proj="<?=$row['id_projeto']?>">
                                                    ...
                                                    <div class="h-100 display-table">
                                                        <div class="text-lg vcenter">
                                                            ...
                                                            <div style='<?php echo (strlen($row['nome']) > 40) ? 'font-size: 17px;' : null ?>'><?=$row['nome']?></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <ul class="nav nav-tabs margin_b10">
                                    <!--li class="active"><a href=".projEstatistica" data-toggle="tab">Estat?stica</a></li-->
                            ...
                            <div class="tab-pane active projParticipante">
                                <div class="row">
                                    <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 btn-group btn-group-vertical">
                                        <h4 class="text-danger">EDI??O DE PARTICIPANTES</h4>
                                        <hr class="hr-danger">
                                        <div class="">
                                            
                                            
                                            <a href="../rh_novaintra/bolsista.php?regiao=<?=$regiao?>&projeto=<?=$projeto?>" class="btn btn-lg btn-block btn-primary margin_b5">Visualizar Participantes</a>
                                            
                                            <!--INATIVANDO O C?DIGO A PEDIDO DE SABINO, NO DIA 27/10/2016-->
...
<!--                                            <div class="col-lg-4 col-md-6 center">
                                                <a href="../cooperativas/cadcooperado.php?regiao=<?= $regiao ?>&pro=<?= $projeto ?>&tipo=3" class="btn btn-lg btn-block btn-primary margin_b5" target="_blank">Cadastrar Cooperado</a>
                                            </div>-->
                                            <div class="col-lg-4 col-md-6 center">
                                            ...
                                            <div class="col-lg-4 col-md-6 center">
                                                <a href="../rh/cadastro_estagiario.php?regiao=<?= $regiao ?>&pro=<?= $projeto ?>" class="btn btn-lg btn-block btn-info margin_b5" target="_blank">Cadastrar Estagiário</a>
                                            </div>
<!--                                            <div class="col-lg-4 col-md-6 center">
                            ...
                            <div class="tab-pane projRelatorio">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h4 class="text-danger">RELAT?RIOS</h4>
                                        <hr class="hr-danger">
                                    </div>
                                </div>
