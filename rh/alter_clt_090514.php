...
///VERIFICANDO SE O CLT ESTA EM ALGUMA FOLHA
                                    ...
                                    WHERE B.id_clt = $id_clt AND B.status IN(2, 3)"));
                                                                                                                                    ...
                                                                                                                                    mysql_query("UPDATE rh_clt SET  $sql_curso localpagamento = '$localpagamento', locacao = '$lotacao', nome = '$nome', sexo = '$sexo', endereco = '$endereco',numero = '$numero', bairro = '$bairro', cidade = '$cidade', uf = '$uf', cep = '$cep', tel_fixo = '$tel_fixo',
