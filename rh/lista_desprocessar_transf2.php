                        ...
                        <fieldset class="noprint">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    ...
                                    <input type="submit" class="btn btn-primary pull-right" name="gerar" value="Gerar" id="gerar"/>
                                </div>
                            </div>
                        </fieldset>
                    </div><!-- /.col-lg-12 -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <?php if (!empty($qr_relatorio) && isset($_POST['gerar']) || isset($_REQUEST['todos_projetos'])) { ?>
                        ...
                        <table id="tbRelatorio" class="table table-hover table-condensed" style="page-break-after:auto;">
                            <thead>
                                <tr>
                                    <th>NOME</th>
                                    <th>CPF</th>
                            ...
                            <tbody>
                                <?php while ($row_rel = mysql_fetch_assoc($qr_relatorio)) { ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="rh_transferencia_desprocessar2.php?clt=<?=$row_rel['id_clt']?>&AMP;tela=1" title="Desprocessar">
