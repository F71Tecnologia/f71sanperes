...
$Recodigos = mysql_query("SELECT distinct(cod),descicao,categoria FROM rh_movimentos WHERE cod != '0001' AND cod != '5024'  AND cod != '9991'  ORDER BY cod ASC");
...
for($i=0; $i<$qnt; $i++) {
	...
	if($Row['campo'] != '0') {
		...
		if($ARcodigosVER[$i] != '5049' and $ARcodigosVER[$i] != '6005') {
