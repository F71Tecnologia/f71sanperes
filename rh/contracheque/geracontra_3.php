...
$pdf->Cell($largura_celula,$altura_celula,$row_empresa['razao'],1,'0','C');
$pdf->Cell($distancia,$altura_celula,'',0,'0','C');
$pdf->Cell($largura_celula,$altura_celula,$row_empresa['razao'],1,'0','C');
$pdf->Ln($altura_celula);
...
$pdf->Text(2.8, 2.4,$row_empresa['cnpj']);
...
$pdf->Text(2.9 + $largura_celula+ $distancia, 2.4,$row_empresa['cnpj']);
...
$pdf->SetFont('Arial','B',7);
$pdf->Text(6.6 + $largura_celula, 3.2,$row_clt['nome']);
$pdf->Cell(9.5,$altura_celula + 0.3,'' ,1,'0','L');
$pdf->SetFont('Arial','',7);
...
$pdf->SetFont('Arial','',9);
$pdf->Text(1.2 , 4.8,  $row_funcao['nome']);
$pdf->SetFont('Arial','',7);
...
$pdf->SetFont('Arial','',9);
$pdf->Text(3.2 + $largura_celula, 4.8, $row_funcao['nome']);
$pdf->SetFont('Arial','',7);
...
$pdf->SetFont('Arial','',9);
$pdf->Text(8.3 , 5.6, $row_clt['agencia']);
$pdf->SetFont('Arial','',7);
...
$pdf->SetFont('Arial','',9);
$pdf->Text(12.2 , 5.6, $row_clt['conta']);
$pdf->SetFont('Arial','',7);
...
$pdf->SetFont('Arial','',9);
$pdf->Text(10.3+ $largura_celula, 5.6,$row_clt['agencia']);
$pdf->SetFont('Arial','',7);
...
$pdf->SetFont('Arial','',9);
$pdf->Text(14.2 + $largura_celula, 5.6, $row_clt['conta']);
$pdf->SetFont('Arial','',7);
...
$pdf->Text(1.2 , 6.4, $row_clt['campo1']);

$pdf->Cell(3.5,$altura_celula + 0.3,'' ,1,'0','L');
$pdf->Text(4.6 , 6,'NÚMERO DE SÉRIE');
$pdf->Text(4.6 , 6.4, $row_clt['serie_ctps']);

$pdf->Cell(1.5,$altura_celula + 0.3,'' ,1,'0','L');
$pdf->Text(8.2 , 6,'UF');
$pdf->Text(8.2 , 6.4, $row_clt['uf_ctps']);


if($regiao == 51){
    
    $centro_custo = $row_regiao['regiao'];
} else {
    $centro_custo = $row_projeto['nome'];
}
$pdf->Cell(4.5,$altura_celula + 0.3,'' ,1,'0','L');
$pdf->Text(9.6 , 6,'CENTRO DE CUSTO');
$pdf->Text(9.6 , 6.4,$centro_custo);
...
$pdf->Text(3.2  + $largura_celula, 6.4, $row_clt['campo1']);

$pdf->Cell(3.5,$altura_celula + 0.3,'' ,1,'0','L');
$pdf->Text(6.6  + $largura_celula, 6,'NÚMERO DE SÉRIE');
$pdf->Text(6.6  + $largura_celula, 6.4, $row_clt['serie_ctps']);

$pdf->Cell(1.5,$altura_celula + 0.3,'' ,1,'0','L');
$pdf->Text(10.2  + $largura_celula, 6,'UF');
$pdf->Text(10.2  + $largura_celula, 6.4, $row_clt['uf_ctps']);

$pdf->Cell(4.5,$altura_celula + 0.3,'' ,1,'0','L');
$pdf->Text(11.6 + $largura_celula, 6,'CENTRO DE CUSTO');
$pdf->Text(11.6  + $largura_celula, 6.4, $centro_custo);
...
$altura_mov = 0.4;
$pdf->Ln( 0.6);
$pdf->Cell(1.3,$altura_mov , '' ,$borda,'0','C');
$pdf->Cell(6.2,$altura_mov , ''.$dias_trab ,$borda,'0','L');
$pdf->Cell(1.5,$altura_mov,'' ,$borda,'0','C');
...
$qr_movimentos = mysql_query("SELECT DISTINCT (cod), descicao, categoria FROM rh_movimentos WHERE  cod NOT IN('0001','5024','9991','5044','5035','9996','6006','9000','9999','9998','5012','7003','5011','9099', '50221','8006', '8005', '50222', 6004, 5049,50241,50111,50221,9500, 50243, 50242,50244,50245,50246,50247,50248) AND id_mov NOT IN(77,59)  ORDER BY cod ASC") or die(mysql_error());
...
if($RowFolhaPro['valor_ferias'] != 0){
///////CONDIÇÃO PARA MOSTRAR AS FÉRIAS NO DESCONTO
$pdf->Ln( 0.4);
$pdf->Cell(1.3,$altura_mov, '5037' ,$borda,'0','C');
$pdf->Cell(6.2,$altura_mov, 'FÉRIAS NO MÊS' ,$borda,'0','L');
$pdf->Cell(1.5,$altura_mov,'' ,$borda,'0','C');
$pdf->Cell(2,$altura_mov, '',$borda,'0','R');
$pdf->Cell(2,$altura_mov, number_format($RowFolhaPro['valor_ferias'],2,",",".") ,$borda,'0','R');
...
$total_desconto += $RowFolhaPro['valor_ferias'];

}

if($RowFolhaPro['inss_ferias'] != 0){
//////////// INSS DAS FÉRIAS////
$pdf->Ln( 0.4);
$pdf->Cell(1.3,$altura_mov, '5037' ,$borda,'0','C');
$pdf->Cell(6.2,$altura_mov, 'INSS SOBRE FÉRIAS' ,$borda,'0','L');
$pdf->Cell(1.5,$altura_mov,'' ,$borda,'0','C');
$pdf->Cell(2,$altura_mov, '',$borda,'0','R');
$pdf->Cell(2,$altura_mov, number_format($RowFolhaPro['inss_ferias'],2,",",".") ,$borda,'0','R');
