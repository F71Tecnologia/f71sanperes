...
//    }
    ...
    $pdf->Cell(6.2, $altura_mov, "SALÁRIO BASE", $borda, '0', 'L');
    $pdf->Cell(1.5, $altura_mov, 30, $borda, '0', 'C');
    $pdf->Cell(2, $altura_mov, "3.0000,00", $borda, '0', 'R');
    ...
    $pdf->Cell(1.5, $altura_mov, "8%", $borda, '0', 'C');
    $pdf->Cell(2, $altura_mov, "", $borda, '0', 'R');
    $pdf->Cell(2, $altura_mov, "10,84", $borda, '0', 'R');
    ...
    $pdf->Cell(6.2, $altura_mov, "DIFERENÇA SALARIAL MÊS ANTERIOR", $borda, '0', 'L');
    $pdf->Cell(1.5, $altura_mov, "", $borda, '0', 'C');
    $pdf->Cell(2, $altura_mov, "135,60", $borda, '0', 'R');
    $pdf->Cell(2, $altura_mov, "", $borda, '0', 'R');
...
//    $pdf->Cell(1.5, $altura_mov, "20%", $borda, '0', 'C');
//    $pdf->Cell(2, $altura_mov, "", $borda, '0', 'R');
//    $pdf->Cell(2, $altura_mov, "135,60", $borda, '0', 'R');
...
//    $pdf->Cell(2, $altura_mov, "135,60", $borda, '0', 'R');
    ...
    $pdf->Ln(0.4);
    $pdf->Cell(1.3, $altura_mov, "50249", $borda, '0', 'C');
    $pdf->Cell(6.2, $altura_mov, "FALTA", $borda, '0', 'L');
    $pdf->Cell(1.5, $altura_mov, "", $borda, '0', 'C');
    $pdf->Cell(2, $altura_mov, "", $borda, '0', 'R');
    $pdf->Cell(2, $altura_mov, "3.000,00", $borda, '0', 'R');
...
//    }
    ...
    $pdf->Text(3.4, 1.5 + $altura_ag, "R$ " . number_format("3135.60", 2, ',', '.'));
    $pdf->Text(8.7, 1.1 + $altura_ag, 'Total dos Descontos:');
    $pdf->Text(9.5, 1.5 + $altura_ag, "R$ " . number_format("3010.84", 2, ',', '.'));
    ...
    $pdf->Text(3.4 + $largura_celula + $distancia, 1.5 + $altura_ag, "R$ " . number_format("3135.60", 2, ',', '.'));
    $pdf->Text(8.7 + $largura_celula + $distancia, 1.1 + $altura_ag, 'Total dos Descontos:');
    $pdf->Text(9.5 + $largura_celula + $distancia, 1.5 + $altura_ag, "R$ " . number_format("3010.84", 2, ',', '.'));
