...
while ($RowFolhaPro = mysql_fetch_array($REfolhaproc)) {
    ...
    //INSS
    $pdf->Ln(0.6);
    $pdf->Cell(1.3, $altura_mov, '5020', $borda, '0', 'C');
    $pdf->Cell(6.2, $altura_mov, 'INSS', $borda, '0', 'L');
    $pdf->Cell(1.5, $altura_mov, $diasTrab, $borda, '0', 'C');
    $pdf->Cell(2, $altura_mov, '', $borda, '0', 'R');
    $pdf->Cell(2, $altura_mov, number_format(83.58, 2, ',', '.'), $borda, '0', 'R');
    ...
    //AJUSTE SALDO
    $pdf->Ln(0.6);
    $pdf->Cell(1.3, $altura_mov, '50257', $borda, '0', 'C');
    $pdf->Cell(6.2, $altura_mov, 'AJUSTE SALDO DEVEDOR', $borda, '0', 'L');
    $pdf->Cell(1.5, $altura_mov, $diasTrab, $borda, '0', 'C');
    $pdf->Cell(2, $altura_mov, '', $borda, '0', 'R');
    $pdf->Cell(2, $altura_mov, number_format(1135.33, 2, ',', '.'), $borda, '0', 'R');
    ...
    //INSALUBRIDADE
    $pdf->Ln(0.6);
    $pdf->Cell(1.3, $altura_mov, '6006', $borda, '0', 'C');
    $pdf->Cell(6.2, $altura_mov, 'INSALUBRIDADE 20%', $borda, '0', 'L');
    $pdf->Cell(1.5, $altura_mov, $diasTrab, $borda, '0', 'C');
    $pdf->Cell(2, $altura_mov, number_format(144.80, 2, ',', '.'), $borda, '0', 'R');
    $pdf->Cell(2, $altura_mov, '', $borda, '0', 'R');
    ...
    // ADICIONAL NOTURNO
    $pdf->Ln(0.6);
    $pdf->Cell(1.3, $altura_mov, '9000', $borda, '0', 'C');
    $pdf->Cell(6.2, $altura_mov, 'ADICIONAL NOTURNO', $borda, '0', 'L');
    $pdf->Cell(1.5, $altura_mov, $diasTrab, $borda, '0', 'C');
    $pdf->Cell(2, $altura_mov, number_format(139.29, 2, ',', '.'), $borda, '0', 'R');
    $pdf->Cell(2, $altura_mov, '', $borda, '0', 'C');
    ...
    //DSR
    $pdf->Ln(0.6);
    $pdf->Cell(1.3, $altura_mov, '9997', $borda, '0', 'C');
    $pdf->Cell(6.2, $altura_mov, 'DSR', $borda, '0', 'L');
    $pdf->Cell(1.5, $altura_mov, $diasTrab, $borda, '0', 'C');
    $pdf->Cell(2, $altura_mov, number_format(34.82, 2, ',', '.'), $borda, '0', 'R');
    $pdf->Cell(2, $altura_mov, '', $borda, '0', 'C');
    ...
    $pdf->Cell(2, $$altura_mov, '', $borda, '0', 'C');
     ...
     //vale transporte
//    $pdf->Ln(0.6);
//    $pdf->Cell(1.3, $altura_mov, '7001', $borda, '0', 'C');
//    $pdf->Cell(6.2, $altura_mov, 'VALE TRANSPORTE', $borda, '0', 'L');
//    $pdf->Cell(1.5, $altura_mov, '6%', $borda, '0', 'C');
//    $pdf->Cell(2, $altura_mov, '', $borda, '0', 'R');
//    $pdf->Cell(2, $altura_mov, number_format(54.00, 2, ',', '.'), $borda, '0', 'R');
//
//    $pdf->Cell($distancia, $altura_celula, '', 0, '0', 'C');
//
//    $pdf->Cell(1.3, $altura_mov, '7001', $borda, '0', 'C');
...
//    }
    ...
    $pdf->Text(3.4, 1.5 + $altura_ag, "R$ " . '1.218,91');
    $pdf->Text(8.7, 1.1 + $altura_ag, 'Total dos Descontos:');
    $pdf->Text(9.5, 1.5 + $altura_ag, "R$ " . '1.218.91');
    $pdf->Text(12.1, 1.1 + $altura_ag, 'Valor Líquido:');
    $pdf->Text(12.2, 1.5 + $altura_ag, "R$ " .'0,00');
    ...
    $pdf->Text(3.4 + $largura_celula + $distancia, 1.5 + $altura_ag, "R$ " . '1.218,91');
    $pdf->Text(8.7 + $largura_celula + $distancia, 1.1 + $altura_ag, 'Total dos Descontos:');
    $pdf->Text(9.5 + $largura_celula + $distancia, 1.5 + $altura_ag, "R$ " . '1.218.91');
    $pdf->Text(12.1 + $largura_celula + $distancia, 1.1 + $altura_ag, 'Valor Líquido:');
    $pdf->Text(12.2 + $largura_celula + $distancia, 1.5 + $altura_ag, "R$ " . '0,00');
    ...
    $pdf->Text(9.2, 1.3 + $altura_ag, "R$ " . '72,00');
    ...
    $pdf->Text(9.2 + $largura_celula + $distancia, 1.3 + $altura_ag, "R$ " . '72,00');
