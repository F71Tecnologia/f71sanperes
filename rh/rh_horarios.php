          ...
          <table  height="114" width="95%"align="center" cellspacing="0" class="bordaescura1px">
            <tr>
              <td height="45" bgcolor="#666666"><div align="right" class="style35">
                <div align="center" class="style27 style36">HOR&Aacute;RIOS CADASTRADADOS (<?=$dados_grupo['nome'] ?>)</div>
              </div></td>
            </tr>
            <tr>
...
$result_horarios = mysql_query("SELECT * FROM rh_horarios
								INNER JOIN curso on (curso.id_curso = rh_horarios.funcao)

 where rh_horarios.id_regiao = '$regiao' AND curso.campo3 = $dados_grupo[id_projeto]");
$cont = 0;
...
<td><a href='rh_horarios_excluir.php?regiao=<?=$regiao;?>&horario=<?=$row_horarios[0];?>'>EXCLUIR</a></td>
</tr>
...
$qry_semhor = mysql_query("SELECT * FROM rh_clt WHERE id_regiao='$regiao' AND rh_horario = 0 AND id_projeto= '$dados_grupo[id_projeto]'");
...
if($total_semhor <> 0){
?>
<td height="53"  bgcolor="#CC3333" colspan="3"><div align="center" class="style27 style36"><strong>PESSOAS CADASTRADAS SEM HORÁRIO</strong><br></div></td>
</tr>
<tr>

<td height="35" bgcolor="#A6A6A6">Nome</td>
<td height="35" bgcolor="#A6A6A6">Função</td>
<td height="35" bgcolor="#A6A6A6" width="50" align="center">EDITAR CADASTRO</td>
<?php
}
?>
</tr>
...
echo "<tr height='28' class=".$classcor.">";
echo "<td>".$dados_semhor['nome']."</td>";
echo "<td>".$dados_curso['nome']."</td>";
echo "<td align='center'><a href='alter_clt.php?clt=$dados_semhor[id_clt]&pro=$dados_semhor[id_projeto]&pagina=/intranet/rh/ver_clt.php
'>EDITAR CADASTRO</a></td>";
echo "</tr>";
$cont++;
}
?>
