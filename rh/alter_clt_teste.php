                            ...
                            <form action="alter_clt.php" method="post" id="form1" name="form1" onSubmit="return validaForm()" enctype="multipart/form-data">
                                <table cellpadding="0" cellspacing="1" class="secao">
                                    ...
                                    <tr>
                                        ...
                                        <td width="75%">
                                            <input name="codigo" type="text" id="codigo" size="3" value="<?= $row['campo3'] ?>" class="validate[required]"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr> 
                                        ...
                                        <td><input type="text" id="horas_semanais" name =" horas_semanais" value="<?php echo $row_horarios['horas_semanais']; ?>" disabled="disabled" size="15">&nbsp;&nbsp;&nbsp;&nbsp;
<!--                                                <a href="<?php echo 'rh_horarios_alterar.php?regiao=' . $row[id_regiao] . '&horario=' . $row_horarios[id_horario]; ?>" target="_blank"> EDITAR</a>-->
                                    ...
                                    <tr> 
                                        ...
                                        <td><input type="text" id="horas_mensais" name =" horas_mensais" value="<?php echo $row_horarios['horas_mes']; ?>" disabled="disabled" size="15">&nbsp;&nbsp;&nbsp;&nbsp;
                                                <a href="<?php echo 'rh_horarios_alterar.php?regiao=' . $row[id_regiao] . '&horario=' . $row_horarios[id_horario]; ?>" target="_blank"> EDITAR</a>
                                ...
                                <table cellpadding="0" cellspacing="1" class="secao">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if ($row['cod_pais_rais'] == 10) {
                                                ?>
                                                <script> $("#uf_nasc_select").show();
                                                    $("#uf_nasc_text").hide();</script>
                                                <?php
                                            } else {
                                                ?>
                                                <script> $("#uf_nasc_select").hide();
                                                    $("#uf_nasc_text").show();</script>
                                                <?php
                                            }
                                            ?>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5">
                                            <input name="ano_chegada_pais" type="text" id="ano_chegada_pais" size="5" maxlength="5" value="<?php echo $row['ano_chegada_no_pais'] ?>"/>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="uf" id="uf" class="validate[required]" >
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="cidade" type="text" id="cidade" size="35" value="<?= $row['cidade'] ?>" class="validate[required]"
                                                   onChange="this.value = this.value.toUpperCase()"/></td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <select name="tipo_contrato" id="tipo_contrato">
                                                <option <?= ($row['tipo_contrato'] == 1) ? 'selected="selected"' : '' ?> value="1">1 - Prazo Indeterminado</option>
                                                <option <?= ($row['tipo_contrato'] == 2) ? 'selected="selected"' : '' ?> value="2">2 - Prazo Determinado</option>
                                                <option <?= ($row['tipo_contrato'] == 3) ? 'selected="selected"' : '' ?> value="3">3 - Temporário (Casos Especiais)</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
...
// DATA DE DESATIVAÇÃO
    ...
    $data_entrada2 = (!empty($data_entrada)) ? ConverteData($data_entrada) : '';
    $data_rg2 = (!empty($data_rg)) ? ConverteData($data_rg) : '';
    $data_nasci2 = (!empty($data_nasci)) ? ConverteData($data_nasci) : '';
    $data_ctps = (!empty($data_ctps)) ? ConverteData($data_ctps) : '';
    $data_pis1 = (!empty($data_pis)) ? ConverteData($data_pis) : '';
    $data_exame = (!empty($data_exame)) ? ConverteData($data_exame) : '';
    $desativacao = (!empty($desativacao)) ? ConverteData($desativacao) : '';
