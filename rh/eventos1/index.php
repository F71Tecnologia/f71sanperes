...
//            $rh->Clt->setDefault()->setIdClt($clt)->onUpdate();
             ...
             * 2017-03-23
             * Leonardo
             * se a data de retorno for MENOR OU IGUAL  a data atual, vc 
             * atualiza o campo status do CLT
             */
            if($dados_evento['data_retorno'] <= date('Y-d-m')){
                $query= "UPDATE rh_clt SET status = 10 WHERE id_clt = $clt";
                mysql_query($query);
            }
