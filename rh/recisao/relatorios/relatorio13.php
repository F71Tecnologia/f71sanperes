...
$result_clt = mysql_query("SELECT *,date_format(data_saida, '%d/%m/%Y')as data_saida FROM rh_clt WHERE status >= '60' AND tipo_contratacao = '2' AND id_projeto = '$projeto' ORDER BY year(data_saida),month(data_saida),day(data_saida) DESC");
