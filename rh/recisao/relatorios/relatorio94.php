  ...
  <tr> 
	...
	default: $tabela    = 'autonomo';
		...
		$result = mysql_query("SELECT $tabela.nome,$tabela.id_curso FROM $tabela 
								...
								WHERE $status $tabela.id_regiao = '$regiao' AND $tabela.id_projeto = '$projeto' AND tipo_contratacao = '$row_contratacao[tipo_contratacao_id]' ORDER BY curso.nome,nome  ASC") or die(mysql_error());
