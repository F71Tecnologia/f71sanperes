...
<title>Relat&oacute;rio de Participantes do Projeto por Data de Entrada e Saída</title>
...
<table cellspacing="0" cellpadding="0" class="relacao" style="width:920px; border:0px; page-break-after:always;">
 <tr> 
    ...
    <td width="80%" align="center" colspan="2">
         <strong>RELAT&Oacute;RIO DE PARTICIPANTES DO PROJETO POR DATA DE ENTRADA E SAÍDA</strong><br>
         <?=$row_master['razao']?>
  ...
  <div class="descricao">Relatório de Autonômos do Projeto por Datas de Entrada e Saída</div>
...
$row_atividade = mysql_fetch_array($result_atividade); ?>
  ...
  <div class="descricao">Relatório de CLTs do Projeto por Datas de Entrada e Saída</div>
...
$row_banco2 = mysql_fetch_array($result_banco2); ?>
  ...
  <div class="descricao">Relatório de Colaboradores do Projeto por Datas de Entrada e Saída</div>
...
$row_banco3 = mysql_fetch_array($result_banco3); ?>
 ...
 <div class="descricao">Relatório de Autônomos / PJ do Projeto por Datas de Entrada e Saída</div>
