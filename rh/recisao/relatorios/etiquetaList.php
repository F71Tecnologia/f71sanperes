...
<body style="background-color:#FFF; margin-top:30px; margin-bottom:30px;">
    <form name="form1" method="POST" action="etiquetaLote.php?reg=<?php echo $regiao;?>&pro=<?php echo $projeto;?>">
    ...
    <td width="80%" align="left" colspan="2">
         ...
         <table width="500" border="0" align="left" cellpadding="4" cellspacing="1" style="font-size:12px;margin-left:30px;">
           ...
           <tr> 
            ...
            <tr>
            <td width="20%" align="left" colspan="3">
                  <strong>RELAT&Oacute;RIO DE PARTICIPANTES DO PROJETO EM ORDEM ALFAB&Eacute;TICA RESUMIDO</strong><br>
         <?=$row_master['razao']?>
            </td>
  ...
  <tr> 
   ...
   <tr>
    ...
    <?php if(!empty($num_clt)) { ?>
      ...
      <div class="descricao" style="text-align:left;font-weight:bold;">Relat&oacute;rio de CLTs do Projeto em Ordem Alfabética Resumido</div> 
