          ...
          <tr>
            ...
            <td>
              <select name="unidade" id="unidade" class="campotexto">
                <?php while($row_unidades = mysql_fetch_array($result_unidades)) { ?>
                <option value="<?=$row_unidades[0]?>">
                  <?=$row_unidades['unidade']?>
                </option>
                <?php } ?>
              </select>
            </td>
       ...
       <form action="relatorio4.php" method="post" name="form3" id="form3" style="margin-bottom:50px;">
        <table cellspacing="0" cellpadding="4" class="relacao">
          ...
          <tr>
            ...
            <?php $result_curso = mysql_query("SELECT * FROM curso WHERE campo3 = '$projeto' ORDER BY nome ASC");
