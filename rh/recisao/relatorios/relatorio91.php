...
$result = mysql_query("SELECT nome, locacao, endereco, bairro, cidade FROM rh_clt WHERE status >= '60' AND id_regiao = '$regiao' AND id_projeto = '$projeto' UNION SELECT nome, locacao, endereco, bairro, cidade FROM autonomo WHERE status <= '1' AND id_regiao = '$regiao' AND id_projeto = '$projeto' ORDER BY nome ASC");
