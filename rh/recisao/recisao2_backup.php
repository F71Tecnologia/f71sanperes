...
$qr_movimentos = mysql_query("select nome_movimento, id_mov, incidencia,
                            ...
                            WHERE id_clt = $id_clt   AND ((ano_mov = '$ano_atual' AND lancamento = 1) OR lancamento = 2) 
...
$TOTAL_OUTROS_VENCIMENTOS  = $valor_sal_familia + $valor_atraso + $valor_outro + $valor_ap_recebido_trab+$valor_insalubridade+$multa_fv+$fv_um_terco_dobro;
