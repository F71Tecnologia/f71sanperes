...
$arrayMovMediasFeriasEDt = array(  386, 387, 388, 408, 409, 410, 466, 385, 508, 509, 324);
...
//    }
    ...
    /*
     * Leonardo 2017-06-06
     * quase todas as rubricas dessa parte foram alteradas a pedido do Italo. Se
     * der problema de novo reavaliar as médias. Pode dar problemas nos 
     * plantonistas. nesse caso vai tar que flegar as rescisões dos plantonistas 
     * e criar um if nessa parte para diferneciar a forma de paresentar o 
     * cálculo.
     */
...
//    }
    ...
    // 1/3 DE MEDIA SOBRE FERIAS IDENIZADAS
    if ($row_movimentosTemp['id_mov'] == 324) {
        //$row_rescisao['ferias_aviso_indenizado'] = $row_rescisao['ferias_aviso_indenizado'] + $row_movimentosTemp['valor'];
