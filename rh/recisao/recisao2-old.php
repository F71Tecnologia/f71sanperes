...
if($_GET['voltar_aguardando'] == true){
    ...
    header("Location: rescisao2-old.php?regiao={$_GET['regiao']}");
}
...
//                    }
                ...
                $('#desprocessaFerias').click(function(){
                   ...
                   if(confirm('Tem certeza que quer desprocessar as férias?')){                       
                       $.post('rescisao2-old.php',{tela: 2, desprocFerias:1, id:id_ferias},  function(data){
                           if(data == 1){
				    ...
				    <td>AÇÃO</td>	
                                ...
                                while ($row_aguardo = mysql_fetch_array($qr_aguardo)) {
                                    ...
                                    ?>">
                                        ...
                                        {
                                        ?>
                                            <a href="rescisao2-old.php?tela=2&enc=<?= $link ?>"><?= $row_aguardo['nome'] ?></a>
                                        <?php
                                        }
                                        ?>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            if ($ACOES->verifica_permissoes(82)) 
                                            {
                                                ...
                                                <a href="rescisao2-old.php?voltar_aguardando=true&id=<?php echo $row_aguardo[0]; ?>&regiao=<?php echo $_GET['regiao']; ?>&id_clt=<?php echo $row_aguardo[0]; ?>" title="Desprocessar Aguardando Demissão" onclick="return window.confirm('Você tem certeza que quer desprocessar aguardando demissão?');"><img src="../imagensrh/deletar.gif" /></a>
                                            <?php } ?>
                                        </td>
                                    </tr>
...
//                                echo $sql_rescisao_complementar;
                                ...
                                ?>">
                                    ...
                                    <td align="center">
                                        <?php if ($ACOES->verifica_permissoes(82)){ ?> 
                                            <!--<a href="rescisao2-old.php?deletar=true&id=<?php echo $row_rescisao[0]; ?>&regiao=<?php echo $_GET['regiao']; ?>&id_clt=<?php echo $row_demissao[0]; ?>" title="Desprocessar Rescisão" onclick="return window.confirm('Você tem certeza que quer desprocessar esta rescisão?');"><img src="../imagensrh/deletar.gif" /></a>-->
                        ...
                        <form name="acao_recisao" id="acao_recisao" action="rescisao2-old.php">
...
// Calculando Saldo FGTS
                    ...
                    <form action="rescisao2-old.php" name="form1" id="form1" method="post" onsubmit="return validaForm()">
...
// Trabalhando com as Datas
                    ...
                    if($_COOKIE['logado'] == 260){
                        echo "DIAS EVENTOS: ".$dias_em_evento;
                    }
                        ...
                        if (!empty($row_folha[ids_movimentos_estatisticas])) {
                            ...
                            */
                            $qr_movimentos = mysql_query("SELECT *
                                       ...
                                       WHERE id_movimento IN($row_folha[ids_movimentos_estatisticas]) AND incidencia = '5020,5021,5023'  AND tipo_movimento = 'CREDITO' AND id_clt = $id_clt AND id_mov NOT IN(56,200,235,57) ");  ///A PEDIDO DA REJANE, COM BASE NO EMAIL ESTOU REMOVENDO O MOVIMENTO DE DIFERENÇA SALARIAL PARA O CALCULO DAS MÉDIAS #13/11/2014
...
///ARTIGO 479 e 480 PARA RESCISÃO ANTECIPADA 
                    ...
                    if ((in_array(1, $array_parcelas_decimo) && in_array(2, $array_parcelas_decimo)) || in_array(3, $array_parcelas_decimo)) {
                        ...
                        if ($aviso == 'indenizado') {
                            ...
                            $qnt_13_indenizado = 1;
                            $valor_13_indenizado = ($salario_base_limpo + $valor_insalubridade_integral + $total_rendi + $periculosidade_30_integral_dt) / 12;
...
// Encriptografando a variável
                                        ...
                                        <table width="50%" border="0" cellspacing="0" cellpadding="0">                                      
                                            ...
                                            <tr>
                                                <td><a href="rescisao2-old.php?tela=4&enc=<?= $linkir ?>" class="botao recisao_lote">Processar Rescis&atilde;o</a></td>
                                                <td><a href="rescisao2-old.php?tela=2&enc=<?= $linkvolt ?>" class="botao">Voltar</a></td>
                                            </tr>
                                        </table>
        ...
        <footer>
            <div>
                <p>Pay All Fast 3.0 build 2273 - <?=date('d/m/Y - H:i')?></p>
