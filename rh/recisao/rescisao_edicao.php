...
$dados_recisao[50] = array(
    "movimento" => 'Saldo de <span contenteditable="true" data-id="'.$id.'" data-coluna="dias_saldo" title="Editar valor" data-tipo="individual">'.$row_rescisao['dias_saldo'].'</span> dias Salário',
    "tipo" => "CREDITO",
...
$dados_recisao[63] = array(
    "movimento" => '13º Salário Proporcional <span contenteditable="true" data-id="'.$id.'" data-coluna="avos_dt" title="Editar valor" data-tipo="individual">'.$avos_dt.'</span>/12 avos',
    "tipo" => "CREDITO",
...
$dados_recisao[65] = array(
    "movimento" => 'Férias Proporcionais <span contenteditable="true" data-id="'.$id.'" data-coluna="avos_fp" title="Editar valor" data-tipo="individual">'.sprintf('%02d', $row_rescisao['avos_fp']).'</span>/12 avos<br>'.$periodo_aquisitivo_fp,
    "tipo" => "CREDITO",
...
$dados_recisao[68] = array(
    "movimento" => "Terço Constitucional de Férias Vencidas",
    "tipo" => "CREDITO",
    "valor" => $row_rescisao['umterco_fv'],
    "campo" => 'umterco_fv'
);
$dados_recisao[68.5] = array(
    "movimento" => "Terço Constitucional de Férias Proporcionais",
    "tipo" => "CREDITO",
