...
<table class="rescisao" cellpadding="0" cellspacing="1">
  ...
  <tr>
    <td colspan="2">
      ...
      <div class="valor"><?php echo (empty($row_sindicato['codigo_sindical']))? "999.000.000.00000-3" : $row_sindicato['codigo_sindical'] ; ?></div>
    </td>
    <td colspan="4">
  ...
  <tr style="border: 0px;">
    <td colspan="6" style="border: 0px;">
      <div class="campo">
          ...
          acima especificadas no corpo do TRCT, no valor líquido de R$ <VALOR LIQUIDO>, o qual devidamente rubricado pelas partes, é parte integrante
