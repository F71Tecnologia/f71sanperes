...
$VALORES['CREDITO'][51]['descricao']   = 'Comissões';
...
$VALORES['CREDITO'][60]['descricao']   = 'Multa Art. 477, § 8º/CLT';
...
$VALORES['CREDITO'][62]['descricao']   = 'Salário Familia';
...
$VALORES['CREDITO'][70]['descricao']   = '13º Salário (Aviso-Prévio Indenizado)';
...
$VALORES['CREDITO'][99]['valor']       = $row_rescisao['arredondamento_positivo'];
 ...
 $VALORES['DEBITO'][102]['descricao']   = "Adiantamento de 13º Salário";
 $VALORES['DEBITO'][102]['valor']       =  0;

 $VALORES['DEBITO'][103]['descricao']   = "Aviso Prévio Indenizado";
 ...
 $VALORES['DEBITO'][105]['descricao']   = "Empréstimo em Consignação";
 $VALORES['DEBITO'][105]['valor']       = 0;

 $VALORES['DEBITO'][112.1]['descricao']   = "Previdência Social";
 $VALORES['DEBITO'][112.1]['valor']       = $row_rescisao['inss_ss'];

 $VALORES['DEBITO'][112.2]['descricao']   = "Previdência Social - 13º Salário";
 ...
 $VALORES['DEBITO'][114.2]['descricao']   = "IRRF sobre 13º Salário";
...
<table class="rescisao" cellpadding="0" cellspacing="1">
  ...
  <tr>
    ...
    <td><span class="numero">82</span>1/3 Férias (Aviso Prévio Indenizado)</td>
  ...
  <tr>     
   ...
   <?php } else { ?>
    ...
    <?php } ?>   
     ...
     <td><span class="numero">95 </span>  Diferença de Dissídio</td>
