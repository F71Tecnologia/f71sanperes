                ...
                <table align="center" width="100%" cellspacing="0" cellpadding="12" style="font-size:13px; line-height:22px;">
                    ...
                    <tr>
                        <td colspan="2" class="menu">
                            ...
                            <?php } ?>
                            <?php if ($ACOES->verifica_permissoes(117) && ($row['status'] < 60 && $row['status'] != 200)) { ?>
                        ...
                        <td colspan="2">
                                <table width="100%" border="0" cellpadding="4" cellspacing="0" style="font-size:13px;">
                                        ...
                                        <?php foreach ($listaFeria['registros'] as $row_ferias) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="/intranet/rh_novaintra/ferias/ferias_processar.php?method=telaAvisoFerias&id_ferias=<?=$row_ferias['id_ferias']?>" class="btn btn-default btn-xs" title="Ver Aviso de F&eacute;rias" target="_blank">
                                    ...
                                    <!--                    <a href="/intranet/rh_novaintra/ferias/arquivos/ferias_<?= $row_ferias['id_clt'] ?>_<?= $row_ferias['id_ferias'] ?>.pdf" class="btn btn-default btn-xs" title="Ver PDF de Férias Novas" target="_blank">
                                                    ...
                                                    <a href="/intranet/rh_novaintra/ferias/ferias_processar.php?method=gerarPdf&id_ferias=<?=$row_ferias['id_ferias']?>&value=pdf" class="btn btn-default btn-xs" title="Ver PDF de F&eacute;rias Novas" target="_blank">
                                                        <img src="../imagens/icons/att-pdf.png" style="width: 1.5em; height: 1.5em;" alt="Ver PDF"
                                                        <i class="text-danger fa fa-file-pdf-o" alt="Ver PDF de Férias Novas"></i>
                                                    </a>
                                                </td>
