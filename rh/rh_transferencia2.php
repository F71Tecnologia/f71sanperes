...
$breadcrumb_pages = array(
    ...
    "Visualizar Projeto" => "../../ver2.php?projeto={$clt['id_projeto']}",
    "Lista Participantes" => "../../bolsista2.php?projeto={$clt['id_projeto']}",
    "Visualizar Participante" => "../ver_clt2.php?pro={$clt['id_projeto']}&clt={$id_clt}");
?>
<!DOCTYPE html>
<html>
    <head>
