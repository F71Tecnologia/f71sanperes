...
//                                                echo ($value['pericia'] == 1) ? $value['data'] . ' - ' . $value['data_retorno'] : $value['data'] . ' - ' . $value['data_retorno_final'];
                                        ...
                                        <td style="text-align:center;">
                                            <a href="index.php?tela=acao_evento&amp;clt=<?= $value['id_clt'] ?>&amp;regiao=<?= $regiao['id_regiao'] ?>" onClick="return hs.htmlExpand(this, {objectType: 'iframe'})" class="participante" title="Inserir evento para <?= $value['nome'] ?>">
