...
//                    }, 'json');
                ...
                <form action="<?= $_SERVER['REQUEST_URI'] ?>" method="post" name="form1" style="width: 100%;">
                    ...
                    <fieldset>
                        ...
                        <?php if ($row_clt['status'] != 10) { ?>
                            <p><label class="first">&emsp;</label> <button type="button" id="novo_evento">Novo Evento</button></p>
                        <?php } ?>
                        <p>
                        ...
                        <p id="row_data" <?= $class ?>>
                            ...
                            <input name="data" id="data" class="data validate[required]" type="text" size="11" maxlength="10" onKeyUp="mascara_data(this)">
                        </p>
                        <p id="row_dias" >
                            <label class="first">Duração da Ocorrência:</label>
                            <input name="dias" id="dias" class="dias" type="number" min="0" style="width:5em;" <?= $required ?>> <b>dias</b>
                        </p>
                        <p id="row_retorno">
                            <label class="first">Data de Retorno:</label><!-- Nome Anterior: Retorno da Ocorrência -->
                            <input name="data_retorno" id="data_retorno" class="data" type="text" onKeyUp="mascara_data(this)">
                        </p>
    <!--                        <p id="row_retorno_final" >
                        ...
                        <p id="row_obs" <?= $class ?>>
                            ...
                            <textarea name="observacao" id="observacao" cols="20" rows="3"></textarea>
                        </p>
