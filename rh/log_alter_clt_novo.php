...
$qr_dependentes = mysql_query("SELECT * FROM dependentes WHERE id_bolsista = '$_POST[id_clt]' ");
...
$colunas = array(
    $coluna['id_clt'],$coluna['nome'],$coluna['data_naci'],$coluna['uf_nasc'],$coluna['municipio_nas'],$coluna['civil'],$coluna['sexo'],$coluna['nacionlidade'],
    ...
    $coluna['uf_ctps'],$coluna['data_ctps'],$coluna['titulo'],$coluna['zona'],$coluna['secao'],$coluna['pis'],$coluna['data_pis'],$coluna['fgts'],
    $coluna['reservista'],$coluna['medica'],$coluna['plano'],$coluna['apolice'],$coluna['campo2'],$coluna['insalubridade'],$coluna['ad_noturno'],
    $coluna['desconto_inss'],$coluna['cipa'],$coluna['transporte'],$vale['vale1'],$vale['vale2'],$vale['vale3'],$vale['vale4'],$vale['vale5'],
    $vale['vale6'],$vale['num_cartao'],$vale['num_cartao2'],$coluna['sindicato'],$coluna['ano_contribuicao'],$coluna['banco'],$coluna['agencia'],$coluna['tipo_conta'],
    $coluna['data_entrada'],$coluna['data_exame'],$coluna['localpagamento'],$coluna['tipo_admissao'],$coluna['tipopg'],$coluna['prazoExp'],$coluna['tipo_contrato'],$coluna['observacoes'],
);

$posts = array(
    $_POST['id_clt'],$_POST['nome'],formata($_POST['data_nasc']),$_POST['uf_nasc_select'],$_POST['municipio_nasc'],$_POST['civil'],$_POST['sexo'],$_POST['nacionalidade'],
    ...
    formata($_POST['data_nasc_pai']),formata($_POST['data_nasc_mae']),formata($_POST['data_nasc_conjuge']),formata($_POST['data_nasc_avo_h']),formata($_POST['data_nasc_avo_m']),formata($_POST['data_nasc_bisavo_h']),formata($_POST['data_nasc_bisavo_m']),$_POST['ddir_pai'],
    $_POST['ddir_mae'],$_POST['ddir_conjuge'],$_POST['ddir_avo_h'],$_POST['ddir_avo_m'],$_POST['ddir_bisavo_h'],$_POST['ddir_avo_m'],$_POST['nacionalidade_pai'],$_POST['nacionalidade_mae'],
    ...
    formata($_POST['data_filho_3']),formata($_POST['data_filho_4']),formata($_POST['data_filho_5']),$_POST['portador1'],$_POST['portador2'],$_POST['portador3'],$_POST['portador4'],$_POST['portador5'],
    ...
    $_POST['desconto_inss'],$_POST['cipa'],formata2($_POST['transporte']),$_POST['vale1'],$_POST['vale2'],$_POST['vale3'],$_POST['vale4'],$_POST['vale5'],
    $_POST['vale6'],$_POST['num_cartao'],$_POST['num_cartao2'],formata3($_POST['sindicato']),$_POST['ano_contribuicao'],$_POST['banco'],$_POST['agencia'],$_POST['radio_tipo_conta'],
...
//print_r($posts);
//echo '</pre>';
//echo 'qtd colunas: '.count($colunas);
//echo '<br/>qtd posts: '.count($posts);
//echo '<br/>qtd campos: '.count($campos);
//exit();
...
$posts_sefip = array($_POST['codigo'], $_POST['nome'], formata($_POST['data_nasc']), $_POST['trabalho'], 
		             $_POST['serie_ctps'], $_POST['pis'], formata($_POST['data_entrada'], $_POST['endereco'], 
					 $_POST['bairro'], $_POST['cep'], $_POST['cidade'], $_POST['estado']));
