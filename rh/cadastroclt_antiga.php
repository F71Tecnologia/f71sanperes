...
<table cellpadding="0" cellspacing="1" class="secao">
  ...
  <tr>
   ...
   <tr>
     ...
     <td><input name="uf" type="text" id="uf" size="2" maxlength="2"/></td>
  </tr>
  <tr>
...
<table cellpadding="0" cellspacing="1" class="secao">
  ...
  <tr>
    ...
    <td colspan="3">
      <input name="conselho" type="text" id="conselho" size="17" />
    </td>
...
$total_clt_curso = mysql_result( mysql_query("SELECT COUNT(id_curso) as total_curso FROM rh_clt  WHERE id_curso = '$id_curso' AND id_regiao = '$regiao' AND id_projeto = '$id_projeto'"),0);
...
if($filhos == '' or $filhos == 0) {
	...
	mysql_query ("INSERT INTO dependentes(id_regiao,id_projeto,id_bolsista,contratacao,nome,data1,nome1,data2,nome2,data3,nome3,data4,nome4,data5,nome5,data6,nome6) VALUES
('$regiao','$id_projeto','$row_id_participante','$tipo_contratacao','$nome','$data_filho_1','$filho_1','$data_filho_2','$filho_2','$data_filho_3','$filho_3','$data_filho_4','$filho_4','$data_filho_5','$filho_5','$data_filho_6','$filho_6')") or    die ("$mensagem_erro 2.4<br><br>".mysql_error());
	$naa = "2";
}
