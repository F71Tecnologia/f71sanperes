                                         ...
                                         <td> 
												...
												$qr_folha2 = mysql_query("SELECT * FROM rh_folha 
													...
													$classe = ($j % 2) ? 'class="meses1"' : 'class="meses2"';
														...
														echo '<div '.$classe.'>';
														echo '<b>'.$meses[$mes].'</b> ('.$row_folha2['id_folha'].')';
														echo '<br>&nbsp;&nbsp;&nbsp; INSS: <b> R$ '.number_format($row_folha2['a5020'],2,',','.').'</b>';
														echo '<br>&nbsp;&nbsp;&nbsp; IR: <b> R$ '.number_format($row_folha2['a5021'],2,',','.').'</b>';
														echo '<br>&nbsp;&nbsp;&nbsp; BASE IR: <b> R$ '.number_format( $row_folha2['base_irrf'],2,',','.').'</b>';
														
														
														if($row_folha2['ferias'] == '1') {
															echo '<br>&nbsp;&nbsp;&nbsp; FÉRIAS: <b> R$ '.number_format($ferias['total_remuneracoes'] - $ferias['inss'], 2, ",", ".").'</b>';
														}														
														echo '</div>';
