...
$qr = "SELECT 
        A.nome,A.cpf,A.id_regiao,A.id_projeto,A.id_curso,A.id_regiao,A.foto,A.locacao,A.id_unidade,A.tipo_pagamento,A.banco,A.rh_sindicato,
        B.nome as projeto,
...
foreach ($reUnidade as $uni) {
    $unidadeOpt[$uni["id_unidade"] . "//" . $uni["unidade"]] = $uni['unidade'];
}
                ...
                <?php } else { ?>
                    <?php if ($tela == 1) { ?>
                        <fieldset class="border-red">
                            ...
                            <p><label class="first">Unidade:</label> <?php echo $clt['id_unidade'] . " - " . $clt['locacao'] ?></p>
