...
// Rodando os 12 meses
            for ($m = 1; $m < 13; $m++) {
                ...
                if ($tubarao == '01') {
                    ...
                    $inss_13[] = '5020';
                    $inss_13[] = 'INSS SOBRE 13º Salário';



                    $irrf_13[] = '5021';
                    $irrf_13[] = 'IRRF SOBRE 13º Salário';
                }
                $inss_13[$folha_individual_13['mes'] + 2] = $folha_individual_13['inss_dt'];
                $inss_13[15] = "DEBITO";
                $irrf_13[$folha_individual_13['mes'] + 2] = $folha_individual_13['ir_dt'];
                $irrf_13[15] = "DEBITO";
                ...
                $soma5 += $folha_individual_13['inss_dt'];
                $soma6 += $folha_individual_13['ir_dt'];
        ...
        switch ($tela) {
            case 0:
                ...
                <body>
                    <div id="corpo">
                        ...
                        <div id="conteudo">
                            ...
                            <?php } else { ?>
                                <form action="<?= ($_COOKIE['logado'] == 87) ? 'fichafinanceira_1.php' : $_SERVER['PHP_SELF']; ?>" method="post" name="form" style="margin-bottom:200px;">
                                    <?php if (empty($id)) { ?>
                                        Selecione o Participante:
                                        <select name="id" class="campotexto" onchange="exibe()">
                                            <option disabled="disabled" selected>Escolha um participante abaixo</option>
                                            <?php while ($participante = mysql_fetch_assoc($result)) { ?>
                                                <option id="participante" value="<?= $participante[$coluna_id] ?>"><?= $participante['nome'] ?></option> 
                                            <?php } ?>
                                        </select>
                                    <?php } else { ?>
                            ...
                            <td colspan="3">
                                <table width="980" border="0" cellspacing="2" cellpadding="3" class="relacao" style="font-weight:normal; line-height:22px; margin-top:30px;">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" style="width:10%"><?php
                                            if ($participante['data_saida'] != "00/00/0000") {
                                                echo $participante['data_saida'];
                                            }
                                            ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="2"><?php echo "R$ ";
                                            echo number_format($curso['salario'], 2, ',', '.');
                                            ?></td>
                ...
                <?php for ($b = 0; $b < 2; $b++) { ?>
                                            ...
                                            <td colspan="13">
                                                <table cellpadding="0" cellspacing="0" width="100%" class="relacao" style="border:0px;">
                                                    <tr style="font-size:10px;">
                                                            <?php for ($c = 2; $c < 14; $c++) { ?>
                                                            <td style="width:7%" align="center"><?php
                                            if (!empty($rendimentos[$a][$c])) {
                                                echo formata($rendimentos[$a][$c]);
                                            } else {
                                                echo "&nbsp;";
                                            }
                                            ?></td>
                                        ...
                                        <?php
                                        $soma_total_rendimentos = $soma_total_rendimentos + $rendimentos[$a][14];
                                    }
            ...
            <?php for ($f = 0; $f < 12; $f++) { ?>
                                                        <td style="width:7%" align="center"><?php
                if (!empty($total_rendimentos[$f])) {
                    echo formata2($total_rendimentos[$f]);
                } else {
                    echo "&nbsp;";
                }
                ?></td>
            ...
            <?php for ($g = 0; $g < sizeof($descontos); $g++) { ?>
                ...
                ?>">
                                        ...
                                        <?php for ($i = 2; $i < 14; $i++) { ?>
                                                            <td style="width:7%" align="center"><?php
                                            if (!empty($descontos[$g][$i])) {
                                                echo formata2($descontos[$g][$i]);
                                            } else {
                                                echo "&nbsp;";
                                            }
                                            ?></td>
                                        ...
                                        <?php
                                        $soma_total_descontos = $soma_total_descontos + $descontos[$g][14];
                                    }
            ...
            <?php for ($l = 0; $l < 12; $l++) { ?>
                                                        <td style="width:7%" align="center"><?php
                if (!empty($total_descontos[$l])) {
                    echo formata2($total_descontos[$l]);
                } else {
                    echo "&nbsp;";
                }
                ?></td>
            ...
            <?php for ($n = 0; $n < 12; $n++) { ?>
                ...
                <?php
                $valor_liquido = $total_rendimentos[$n] - $total_descontos[$n];
                if (!empty($valor_liquido)) {
                    echo formata2($valor_liquido);
                } else {
                    echo "&nbsp;";
                } unset($valor_liquido);
                ?>
            ...
            <?php } ?>
                                                    <td style="width:16%" align="center"><?php $valor_liquido_total = $soma_total_rendimentos - $soma_total_descontos;
            echo formata2($valor_liquido_total);
            ?></td>
                                                </tr>
                                            </table>
                                        </td>
