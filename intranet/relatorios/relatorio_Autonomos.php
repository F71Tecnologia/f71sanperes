...
if (isset($_REQUEST['gerar']) || isset($_REQUEST['todos_projetos'])) {
    ...
    $contratacao = ($tipo_contratacao == "2")? "clt" : "autonomo";
        ...
        $str_qr_relatorio = "SELECT *, A.nome, B.nome AS nome_curso, B.salario,
            ...
            ON D.id = A.etnia
            WHERE A.id_regiao = '$id_regiao' AND A.tipo_contratacao = '1' AND A.status = '1'";
...
<html lang="pt">
    <head>
        ...
        <title>:: Intranet :: Autônomos do Projeto em Ordem Alfabética</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - RECURSOS HUMANOS <small> - Autônomos do Projeto em Ordem Alfabética</small></h2></div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading text-bold hidden-print">Relatório</div>
                        ...
                        <div class="panel-footer text-right hidden-print controls">
                            ...
                            <button type="button" onclick="tableToExcel('tbRelatorio', 'Autônomos do Projeto')" value="Exportar para Excel" class="btn btn-success" ><span class="fa fa-file-excel-o"></span> Exportar para Excel</button>
                            <?php } ?>
