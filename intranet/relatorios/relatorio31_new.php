                ...
                <table id="tbRelatorio" border="0" cellpadding="0" cellspacing="0" class="grid" width="100%" style="page-break-after:auto;"> 
                        ...
                        <?php while ($row_rel = mysql_fetch_assoc($qr_relatorio)) { $class = ($cont++ % 2 == 0)?"even":"odd"; ?>
                            <tr class="<?php echo $class ?>">
                                ...
                                <td><?php if(!empty($row_rel['campo1'])) {echo $row_rel['campo1']; } else { echo "NÃO TEM"; } ?></td>
                                <td><?php if(!empty($row_rel['serie_ctps'])) {echo $row_rel['serie_ctps']; } else { echo "NÃO TEM"; } ?></td>
                                <td><?php if(!empty($row_rel['data_ctpsbr'])) {echo $row_rel['data_ctpsbr']; } else { echo "NÃO TEM"; } ?></td>
                                <td><?php if(!empty($row_rel['uf_ctps'])) {echo $row_rel['uf_ctps']; } else { echo "NÃO TEM"; } ?></td>
