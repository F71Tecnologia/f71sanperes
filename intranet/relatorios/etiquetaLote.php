 ...
 * ??-??-????
 * 
 * Rotina para geração de etiqueta em lote
 * 
 * Versão: 3.0.8413 - 21/03/2016 - Jacques - Critério para escolha do último salário passou a ser pela diferença,
 *                                           e o campo nome do projeto o endereço para empresa
 * 
 * Versão: 3.0.9675 - 02/06/2016 - Leonardo - Alteração do curso para puxar o cbo correto. Antes estava puxando o id_cbo
 * 
 * @Autor não definido
 *  
 */
                    ...
                    while ($row = mysql_fetch_array($rslote)) {
                        ...
                        <div class="etiquetaPrincipal">
                            ...
                            <div class="divDados">
                                ...
                                <b>CBO n°:</b> <?= $cursoNome['cbo_codigo']; ?> <b>Data admissão:</b> <?= $dataNova; ?> <b>Registro n°:</b> <?= $row['matricula']; ?><br/>
                                <b>Remuneração especifica: </b>R$ <?= $cursoNome['salario']; ?> (<?php echo valor_extenso(number_format($row2['salario'], 2, ',', '')); ?>), por mês<br/><br/>
