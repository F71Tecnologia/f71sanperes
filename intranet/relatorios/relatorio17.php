...
<html lang="pt">
    <head>
        ...
        <title>:: Intranet :: Relatório de Quotas e Parcelas</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - Relatório de Quotas e Parcelas </h2></div>
