                    ...
                    <td>
                        <table cellspacing="0" cellpadding="0" class="" border="1" width="100%" id="result" >
                                    ...
                                    <tr>
                                        ...
                                        <?php foreach ($cabecalho as $key => $cab) { ?> 
                                            <?php if (!empty($values[$key])) { ?> 
                                                ...
                                                <?php if($values["nome"] == "RENDIMENTOS" || $values['nome'] == "FÉRIAS NO MÊS" ||
                            ...
                            <?php if(!empty($dadosFeriasNova)){ ?>        
                                ...
                                -------------------------->
<!--                                <tr class="destaque">
                                    <td colspan="15" style="text-align: left;">RESCISÃO RENDIMENTOS</td>
                                </tr>-->
                            ...
                            <?php if(!empty($arrayDadosRescisaoComplementar)){ ?>        
                                ...
                                -------------------------->
                                <tr class="destaque">
                                    <td colspan="15" style="text-align: left;">RESCISÃO COMPLEMENTAR RENDIMENTOS</td>
                                </tr>
                            ...
                            <?php if(!empty($arrayDadosRescisao)){ ?>        
                                ...
                                -------------------------->
                                <tr class="destaque">
                                    <td colspan="15" style="text-align: left;">RESCISÃO DESCONTOS</td>
                                </tr>
                                <?php foreach ($arrayDadosRescisao as $mes => $dadosArrayResc){ ?>
                                    <?php foreach ($dadosArrayResc as $campos => $itens){ ?>                                        
                            ...
                            <?php if(!empty($arrayDadosRescisaoComplementar)){ ?>        
                                ...
                                -------------------------->
                                <tr class="destaque">
                                    <td colspan="15" style="text-align: left;">RESCISÃO COMPLEMENTAR DESCONTOS</td>
                                </tr>
                                <?php foreach ($arrayDadosRescisaoComplementar as $mes => $dadosArrayResc){ ?>
                                    <?php foreach ($dadosArrayResc as $campos => $itens){ ?>
                                        <?php if($itens['tipo'] == 'DEBITO' && $itens['valor'] > 0){ ?>
...
<!--                            <tr class="destaque">
                                <td colspan="2" style="text-align: left; ">PENSÃO</td>
                                <?php foreach ($cabecalho as $key => $cab) { ?> 
...
<!--                            <tr class="destaque">
                                <td colspan="2" style="text-align: left; ">PENSÃO 13</td>
                                <?php foreach ($cabecalho as $key => $cab) { ?> 
