...
<html lang="pt">
    <head>
        ...
        <title>:: Intranet :: Relatório de Participantes sem PIS </title>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - RECURSOS HUMANOS <small> - Relatório de Participantes sem PIS</small></h2></div>
