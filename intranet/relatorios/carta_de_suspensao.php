...
<html lang="pt">
    ...
    <body>
        ...
        <div class="pagina">
            ...
            <br>
            <br>
            <h4 class="text-left">CARTA DE SUSPENSÃO DISCIPLINAR</h4>
            <br>
            ...
            <p class="text-justify">
                ...
                este motivo e, em cumprimento ao Regulamento Interno, vimos pela presente aplicar-lhe a pena de <strong>suspensão disciplinar</strong>
                , por <strong><?= "$qntDias $txtDias" ?></strong>, a partir <?= $inicio ?>, em razão da seguinte ocorrência: <strong><?=$clt[1]['motivo']?></strong>. Sendo assim, resolvemos
                aplicar-lhe como medida disciplinar a presente Suspensão.<br>
                Esclarecemos que a resistência na prática do ato, por sua repetição, ocasionará a rescisão do Contrato de Trabalho.<br>
                Reassumindo suas funções em _______/________/____________, orientamos para que observe as normas internas da empresa, para que não tenhamos, no futuro, que tomar medidas 
                enérgicas que nos são facultadas pela legislação vigente.<br>
