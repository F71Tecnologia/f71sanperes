...
if (isset($_REQUEST['gerar']) || isset($_REQUEST['todos_projetos'])) {
    ...
    if ($tipo_contratacao == 2) {
        $str_qr_relatorio = "SELECT nome, locacao, endereco, bairro, cidade, cep, uf 
            FROM rh_clt
...
<html lang="pt">
    <head>
        ...
        <title>:: Intranet :: Relatório de Participantes por Endereço </title>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - RECURSOS HUMANOS <small> - Relatório de Participantes por Endereço</small></h2></div>
                        ...
                        <tbody>
                            ...
                            while ($row_rel = mysql_fetch_assoc($qr_relatorio)) {
                                ...
                                <tr class="<?php echo $class ?>">
                                    ...
                                    <td> <?php echo "{$row_rel['endereco']} , {$row_rel['bairro']} , {$row_rel['cidade']}"; ?></td>
