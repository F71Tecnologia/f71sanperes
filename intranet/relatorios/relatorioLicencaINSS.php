...
<html lang="pt">
    <head>
        ...
        <title>:: Intranet :: Relatório de Licença Pelo INSS</title>
...
<?php include("../template/navbar_default.php"); ?>
        ...
        <div class="container">
            <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - Relatório <small> - Licença Pelo INSS</small></h2></div>
                    ...
                    <div class="panel-heading text-bold hidden-print">Relatório</div>
                        ...
                        <div class="panel-footer text-right hidden-print">
                            ...
                            <?php if (!empty($result) && (isset($_POST['gerar']) || isset($_REQUEST['todos_projetos']))) { ?>
                                <button type="button" onclick="tableToExcel('tbRelatorio', 'Licença Pelo INSS')" class="btn btn-success"><span class="fa fa-file-excel-o"></span> Exportar para Excel</button>
                            <?php } ?>
