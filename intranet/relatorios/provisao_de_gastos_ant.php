 ...
 * 
 * @file      provisao_de_gastos_ant.php
 * @license   F71
 * @link      http://www.f71lagos.com/intranet/relatorios/provisao_de_gastos_ant.php
 * @copyright 2016 F71
...
//                $("#form").validationEngine();
                ...
                $("body").on("click", ".visualizar", function () {
                    ...
                    $.ajax({
                        url: "provisao_de_gastos_ant.php",
                        type: "POST",
                        dataType: "json",
                ...
                $("#visualizar_participantes").click(function () {
                    ...
                    $.ajax({
                        url: "provisao_de_gastos_ant.php?method=verificaParticipantes&" + dados,
                        type: "POST",
                        dataType: "json",
                        success: function (data) {
                ...
                $("body").on("click", "#gerar", function () {
                    ...
                    $.getJSON('provisao_de_gastos_ant.php?method=verificaRescisao&'+dados, function (data) {
                        ...
                        if (data.status == 1) {
                            ...
                            thickBoxConfirm("Gerar novas rescisões", "Nao foi encontrado nenhuma rescisao com as configuracões selecionadas, deseja criar agora?", 500, 350, function (data) {
                                ...
                                if (data == true) {
                                    ...
                                    $.getJSON('provisao_de_gastos_ant.php?method=criarHeader&'+dados, function (response) {
                                        ...
                                        $(".clts").each(function(i) {
                                            ...
                                            $.get('/intranet/rh/recisao/recisao2.php?dispensa='+dispensa+'&fator='+fator+'&diastrab='+dias_trab+'&valor=0,00&faltas=0&aviso='+aviso+'&data_aviso='+data_aviso+'&tela=3&idclt='+$(this).val()+'&regiao='+id_regiao+'&logado=<?=$_COOKIE['logado']?>&data_demi='+data_demi+'&recisao_coletiva=1&id_header='+id_header, function (response) {
                                                ...
                                                if(i==$(".clts").size()-1) {
                                                    ...
                                                    $.getJSON('provisao_de_gastos_ant.php?method=getHeaderRescisao&id_header='+id_header, function (data) {
