...
<html lang="pt">
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - Relatório de Pagamentos por Banco </h2></div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group" >
                            ...
                            <label for="select" class="col-sm-1 control-label hidden-print" >Banco</label>
                            <div class="col-sm-2">
                                <?php echo montaSelect($optBanco, $bancoSel, array('name' => "banco", 'id' => 'banco', 'class' => 'form-control')); ?><span class="loader"></span>
                            </div>
