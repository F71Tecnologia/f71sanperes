...
if (isset($_REQUEST['method']) && $_REQUEST['method'] == "desprocessarRecisao") {
    ...
    $query_linhas = "DELETE FROM rh_recisao WHERE id_recisao_lote = '{$_REQUEST['header']}'";
            ...
            $(function () {
                ...
                $("#visualizar_participantes").click(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            var html = "";
                            if (data.status == 1) {
                                html += "<table id='tbRelatorio' border='0' cellpadding='0' cellspacing='0' class='grid' width='100%' style='page-break-after:auto;'><thead><tr><th colspan='6'></th></tr><tr style='font-size:10px !important;'><th rowspan='2'><input type='checkbox' name='id_clt_todos' id='id_clt_todos'/></th><th rowspan='2'>NOME</th><th rowspan='2'>FUNÇÃO</th><th rowspan='2'>STATUS</th><th rowspan='2'>SALÁRIO BRUTO</th></tr></thead>";
                                $.each(data.dados, function (k, v) {
                                    html += "<tr class='' style='font-size:11px;'><td align='center'><input type='checkbox' class='clts validate[minCheckbox[1]]' name='id_clt[]' id='id_clt_" + v.id + "' value='" + v.id + "' /></td><td align='left'><label for='id_clt_" + v.id + "'>" + v.nome + "</label></td><td align='left'>" + v.funcao + "</td><td align='left'>" + v.status + "</td><td align='right'>R$ " + v.sal_base + "</td></tr>";
                                });
                                html += "</table>";
                                                ...
                                                if (data) {
                                                    ...
                                                    if (data.status == 1) {
                                                        $.each(data.dados_projeto, function (k, v) {
                                                            html += "<tr class='tr_" + v.id_header + "'><td>" + v.projeto + "</td><td>" + v.aviso_previo + "</td><td>" + v.fator + " </td><td>" + v.data_saida + "</td><td>" + v.aviso_previo + "</td><td>" + v.data_aviso + " </td><td>" + v.criado_por + "</td><td>" + v.criado_em + "</td><td align='center'>" + v.total_participantes + "</td><td><a href='javascript:;' data-key='" + v.id_header + "'data-projeto='" + v.id_projeto + "' class='visualizar' style='text-decoration: none; color: #0000CC; font-weight: bold; cursor: pointer;'><img src='../imagens/icones/icon-view.gif' title='visualizar' /></a></td><td><a href='javascript:;' data-key='" + v.id_header + "' class='desprocessar' style='text-decoration: none; color: #0000CC; font-weight: bold; cursor: pointer;'><img src='../imagens/icones/icon-delete.gif' title='desprocessar' /></a></td></tr>";
                                                        });
                ...
                $("body").on('click', ".xpandir", function () {
                    ...
                    if ($('span').hasClass('compactarr') && $('span').hasClass('compactarrr')) {
                        ...
                        $(".cabecalho_compactar").attr({colspan: "65"});
                    } else if ($('span').hasClass('compactarr')) {
                        $(".area-xpandir-4").attr({colspan: "17"});
                        $(".cabecalho_compactar").attr({colspan: "62"});
                    } else if ($('span').hasClass('compactarrr')) {
                        $(".area-xpandir-4").attr({colspan: "1"});
                        $(".area-xpandir-6").attr({colspan: "3"});
                        $(".cabecalho_compactar").attr({colspan: "48"});
                    }
                });
                ...
                $("body").on("click", ".compactar", function () {
                    ...
                    if ($('span').hasClass('compactarr') && $('span').hasClass('compactarrr')) {
                        ...
                        $(".area-xpandir-2").attr({colspan: "1"});
                        $(".area-xpandir-3").attr({colspan: "1"});
                        $(".area-xpandir-4").attr({colspan: "16"});
                        $(".area-xpandir-5").attr({colspan: "1"});
                        $(".area-xpandir-6").attr({colspan: "1"});
                        $(".cabecalho_compactar").attr({colspan: "31"});
                    } else if ($('span').hasClass('compactarrr')) {
                        $(".area-xpandir-1").attr({colspan: "10"});
                        $(".area-xpandir-2").attr({colspan: "1"});
                        $(".area-xpandir-3").attr({colspan: "1"});
                        ...
                        $(".cabecalho_compactar").attr({colspan: "17"});
                    }
                ...
                $("body").on('click', ".xpandirr", function () {
                    ...
                    if ($('span').hasClass('compactar') && $('span').hasClass('compactarrr')) {
                        ...
                        $(".area-xpandir-5").attr({colspan: "1"});
                        $(".area-xpandir-6").attr({colspan: "3"});
                        $(".cabecalho_compactar").attr({colspan: "34"});
                    }
                });
...
<?php echo montaSelect($dispensa, $dispensaSel, array('name' => "dispensa", 'id' => 'dispensa', 'class' => 'selectPequeno', 'disabled' => 'disabled')); ?>
                                </p>
                                <p>
                                    <label class="first">Fator:</label>
<?php echo montaSelect($fator, $fatorSel, array('name' => "fator", 'id' => 'fator', 'class' => 'selectPequeno', 'disabled' => 'disabled')); ?>
                                </p>
                            ...
                            <div class="col-dir">
                                <p>
                                    ...
                                    <input type="text" name="dataDemi" id="dataDemi" class="inputPequeno" value="<?php echo $_REQUEST['dataDemi']; ?>" disabled="true"/>
                                </p>
                                <p>
        ...
        if ($status != $row_rel["codigo"]) {
            ...
            ?>
                            ...
                            <tr class="<?php echo $class ?>" style="font-size:11px;">
                                ...
                                <td align="left"><?php echo "R$ " . number_format($total_rendi, 2, ",", ".");
                    $total_das_medias_outras_remuneracoes += $total_rendi; ?></td>
                                <td align="right">
        <?php
...
//                            echo "<pre>"; 
                                ...
                                <!--DISCRIMINAÇÃO DAS VERBAS RESCISÓRIAS--->
                                <td align="left" class=""><?php echo "[" . $row_rel['dias_saldo'] . "/30] <br /> R$ " . number_format($row_rel['saldo_salario'], 2, ",", ".");
                        $total_saldo_salario += $row_rel['saldo_salario']; ?></td>
                                <td align="left" class="esconder"><?php echo "R$ " . number_format($row_rel['comissao'], 2, ",", ".");
                        $total_comissoes += $row_rel['comissao']; ?></td> <!--- 51--->
                                <td align="left" class="esconder"><?php echo "R$ " . number_format($mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][5912]["valor"], 2, ",", ".");
                        $total_gratificacao += $mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][5912]["valor"]; ?></td> <!--- 52--->
                                <td align="left" class="esconder"><?php echo "R$ " . number_format($row_rel['insalubridade'], 2, ",", ".");
                        $total_insalubridade += $row_rel['insalubridade']; ?></td>  <!--- 53--->
                                <td align="left" class="esconder"><?php echo "R$ " . number_format($mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][6007]["valor"], 2, ",", ".");
                        $total_periculosidade += $mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][6007]["valor"]; ?></td> <!--- 54--->
                                <td align="left" class="esconder"><?php echo "R$ " . number_format($mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][9000]["valor"], 2, ",", ".");
                        $total_adicional_noturno += $mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][9000]["valor"]; ?></td> <!-- 55 -->
                                <td align="left" class="esconder"><?php echo "R$ " . number_format($mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][8080]["valor"], 2, ",", ".");
                        $total_hora_extra += $mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][8080]["valor"]; ?></td> <!-- 56 -->
                                <td align="left" class="esconder"><?php echo "R$ " . number_format(0, 2, ",", ".");
                        $total_gorjetas += 0; ?></td> <!-- 57 -->
                                <td align="left" class="esconder"><?php echo "R$ " . number_format($mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][9997]["valor"], 2, ",", ".");
                        $total_dsr += $mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][9997]["valor"]; ?></td> <!-- 58 -->
                                <td align="left" class="esconder"><?php echo "R$ " . number_format(0, 2, ",", ".");
                        $total_reflexo_dsr += 0; ?></td> <!-- 59 -->
                                <td align="left" class="esconder"><?php echo "R$ " . number_format($row_rel['a477'], 2, ",", ".");
                        $total_multa_477 += $row_rel['a477']; ?></td> <!-- 60 -->
        <?php if ($row_rel['motivo'] == 64) {
            $multa_479 = $row_rel['a479'];
        } else if ($row_rel['motivo'] == 63) {
            $multa_479 = null;
        } ?>
                                <td align="left" class="esconder"><?php echo "R$ " . number_format($multa_479, 2, ",", ".");
        $total_multa_479 += $multa_479; ?></td> <!-- 61 -->
                                <td align="left" class="esconder"><?php echo "R$ " . number_format($row_rel['sal_familia'], 2, ",", ".");
        $total_sal_familia += $row_rel['sal_familia']; ?></td> <!-- 62 -->
<!--                                <td align="right" class="esconder"><?php echo "[" . sprintf('%02d', $row_rel['avos_dt']) . "/12] <br /> R$ " . number_format($row_rel['dt_salario'], 2, ",", ".");
        $total_dt_salario += $row_rel['dt_salario'];
        $total_decimo_a_pagar += $row_rel['dt_salario']; ?></td>  63                       -->
<!--                                <td align="right" class="esconder"><?php echo "R$ " . number_format(0, 2, ",", ".");
        $total_terceiro_exercicio += 0;
        $total_decimo_a_pagar += 0; ?></td>     64                      -->
<!--                                <td align="right" class="esconder"><?php echo "[" . sprintf('%02d', $row_rel['avos_fp']) . "/12] <br /> R$ " . number_format($row_rel['ferias_pr'], 2, ",", ".");
                            $total_ferias_pr += $row_rel['ferias_pr'];
                            $total_ferias_a_pagar += $row_rel['ferias_pr']; ?></td>   65   
                                <td align="right" class="esconder"><?php echo "R$ " . number_format($row_rel['umterco_fp'], 2, ",", ".");
                            $total_umterco_fp += $row_rel['umterco_fp'];
                            $total_ferias_a_pagar += $row_rel['umterco_fp']; ?></td> 
                                <td align="right" class="esconder"><?php echo "R$ " . number_format($row_rel['ferias_vencidas'], 2, ",", ".");
                            $total_ferias_aquisitivas += $row_rel['ferias_vencidas'];
                            $total_ferias_a_pagar += $row_rel['ferias_vencidas']; ?></td>   66                          
                                <td align="right" class="esconder"><?php echo "R$ " . number_format($row_rel['umterco_fv'], 2, ",", ".");
                            $total_umterco_fv += $row_rel['umterco_fv'];
                            $total_ferias_a_pagar += $row_rel['umterco_fv']; ?></td> 
                                <td align="right" class="esconder"><?php echo "R$ " . number_format($row_rel['umterco_fv'] + $row_rel['umterco_fp'], 2, ",", ".");
                        $total_terco_constitucional += $row_rel['umterco_fv'] + $row_rel['umterco_fp'];
                        $total_ferias_a_pagar += $row_rel['umterco_fv'] + $row_rel['umterco_fp']; ?></td>     68               -->
<!--                                <td align="right" class="esconder"><?php echo "R$ " . number_format($aviso[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'], 2, ",", ".");
                        $total_aviso_indenizado += $aviso[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO']; ?></td>     69               -->
<!--                                <td align="right" class="esconder"><?php echo "R$ " . number_format($row_rel['terceiro_ss'], 2, ",", ".");
                        $total_terceiro_ss += $row_rel['terceiro_ss'];
                        $total_decimo_a_pagar += $row_rel['terceiro_ss']; ?></td>    70                       -->
<!--                                <td align="right" class="esconder"><?php echo "R$ " . number_format($row_rel['ferias_aviso_indenizado'], 2, ",", ".");
                        $total_f_aviso_indenizado += $row_rel['ferias_aviso_indenizado'];
                        $total_ferias_a_pagar += $row_rel['ferias_aviso_indenizado']; ?></td>               71            
                                <td align="right" class="esconder"><?php echo "R$ " . number_format($row_rel['fv_dobro'], 2, ",", ".");
                        $total_f_dobro += $row_rel['fv_dobro']; ?></td>   72                            
                                <td align="right" class="esconder"><?php echo "R$ " . number_format($row_rel['um_terco_ferias_dobro'], 2, ",", ".");
                        $total_umterco_f_dobro += $row_rel['um_terco_ferias_dobro'];
                        $total_ferias_a_pagar += $row_rel['um_terco_ferias_dobro']; ?></td>   73                            -->
<!--                                <td align="right" class="esconder"><?php echo "R$ " . number_format($row_rel['umterco_ferias_aviso_indenizado'], 2, ",", ".");
                        $total_umterco_ferias_aviso += $row_rel['umterco_ferias_aviso_indenizado'];
                        $total_ferias_a_pagar += $row_rel['umterco_ferias_aviso_indenizado']; ?></td>    82  -->
                                <td align="right" class="esconder"><?php echo "R$ " . number_format($mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][5012]["valor"], 2, ",", ".");
                            $total_diferenca_salarial += $mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][5012]["valor"]; ?></td> <!-- 80 -->
                                <td align="right" class="esconder"><?php echo "R$ " . number_format($mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][5011]["valor"], 2, ",", ".");
                            $total_ajuda_custo += $mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][5011]["valor"]; ?></td>  <!-- 82 -->                           
<!--                                <td align="right" class="esconder"><?php echo "R$ " . number_format($row_rel['lei_12_506'], 2, ",", ".");
                            $total_lei_12_506 += $row_rel['lei_12_506']; ?></td>   95                            -->
                                <td align="right" class="esconder"><?php echo "R$ " . number_format($mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][80017]["valor"], 2, ",", ".");
                            $total_dif_dissidio += $mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][80017]["valor"]; ?></td>  <!-- 95 -->                           
                                <td align="right" class="esconder"><?php echo "R$ " . number_format($mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][7001]["valor"], 2, ",", ".");
                            $total_vale_transporte += $mov[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'][7001]["valor"]; ?></td>  <!-- 106 -->                           
                                <td align="right" class="esconder"><?php echo "R$ " . number_format($row_rel['arredondamento_positivo'], 2, ",", ".");
                            $total_ajuste_de_saldo += $row_rel['arredondamento_positivo']; ?></td>  <!-- 99 -->                           
        ...
        <?php if (isset($mov[$row_rel['id_recisao']][$row_rel['id_clt']]['DEBITO'][6004]["valor"])) {
            ...
            $pensao = 0;
                                ...
                                <td align="right" class="esconderr"><?php echo "R$ " . number_format($pensao, 2, ",", ".");
                            $total_pensao_alimenticia += $pensao;
                            $total_deducao_debito +=$pensao; ?></td>  <!-- 100 -->                           
                                <td align="right" class="esconderr"><?php echo "R$ " . number_format($mov[$row_rel['id_recisao']][$row_rel['id_clt']]['DEBITO'][7003]["valor"], 2, ",", ".");
                            $total_adiantamento_salarial += $mov[$row_rel['id_recisao']][$row_rel['id_clt']]['DEBITO'][7003]["valor"]; ?></td>  <!-- 101 -->                           
                                <td align="right" class="esconderr"><?php echo "R$ " . number_format(0, 2, ",", ".");
                            $total_adiantamento_13_salarial += 0; ?></td>  <!-- 102 -->                           
                                <td align="right" class="esconderr"><?php echo "R$ " . number_format($aviso[$row_rel['id_recisao']][$row_rel['id_clt']]['DEBITO'], 2, ",", ".");
                            $total_aviso_indenizado_debito += $aviso[$row_rel['id_recisao']][$row_rel['id_clt']]['DEBITO']; ?></td>  <!-- 103 -->                           
                                    <?php if ($row_rel['motivo'] == 64) {
                                        $multa_480 = null;
                                    } else if ($row_rel['motivo'] == 63) {
                                        $multa_480 = $row_rescisao['a480'];
                                    } ?>
                                <td align="right" class="esconderr"><?php echo "R$ " . number_format($multa_480, 2, ",", ".");
                            $total_multa_480 += $multa_480;
                            $total_deducao_debito += $multa_480; ?></td>  <!-- 104 -->                           
                                <td align="right" class="esconderr"><?php echo "R$ " . number_format(0, 2, ",", ".");
                            $total_emprestimo_consignado += 0; ?></td>  <!-- 105 -->                           
                                <td align="right" class="esconderr"><?php echo "R$ " . number_format(0, 2, ",", ".");
                            $total_vale_transporte_debito += 0; ?></td>  <!-- 107 -->  
                                <td align="right" class="esconderr"><?php echo "R$ " . number_format($mov[$row_rel['id_recisao']][$row_rel['id_clt']]['DEBITO'][8006]["valor"], 2, ",", ".");
                            $total_vale_alimentacao_debito += $mov[$row_rel['id_recisao']][$row_rel['id_clt']]['DEBITO'][8006]["valor"]; ?></td>  <!-- 109 -->  
                                <td align="right" class="esconderr"><?php echo "R$ " . number_format($inss_saldo_salario, 2, ",", ".");
                            $total_inss_ss += $inss_saldo_salario;
                            $total_deducao_debito += $inss_saldo_salario; ?></td>  <!-- 112.1 --> 
                                <td align="right" class="esconderr"><?php echo "R$ " . number_format($row_rel['inss_dt'], 2, ",", ".");
                            $total_inss_dt += $row_rel['inss_dt'];
                            $total_deducao_debito += $row_rel['inss_dt']; ?></td>   <!-- 112.2 -->                     
                                <td align="right" class="esconderr"><?php echo "R$ " . number_format($calculos->valor, 2, ",", ".");
                            $total_ir_ss += $calculos->valor;
                            $total_deducao_debito += $calculos->valor; ?></td>   <!-- 114.1 -->                     
                                <td align="right" class="esconderr"><?php echo "R$ " . number_format($row_rel['ir_dt'], 2, ",", ".");
                            $total_ir_dt += $row_rel['ir_dt'];
                            $total_deducao_debito += $row_rel['ir_dt']; ?></td>    <!-- 114.2 -->                    
                                <td align="right" class="esconderr"><?php echo "R$ " . number_format($row_rel['devolucao'], 2, ",", ".");
                            $total_devolucao += $row_rel['devolucao'];
                            $total_deducao_debito += $row_rel['devolucao']; ?></td>    <!-- 115 -->                    
                                <td align="right" class="esconderr"><?php echo "R$ " . number_format(0, 2, ",", ".");
                            $total_outros += 0; ?></td>    <!-- 115.1 -->                    
                                <td align="right" class="esconderr"><?php echo "R$ " . number_format($row_rel['adiantamento_13'], 2, ",", ".");
                            $total_adiantamento_13 += $row_rel['adiantamento_13']; ?></td>    <!-- 115.2 -->                    

                            <?php if (isset($mov[$row_rel['id_recisao']][$row_rel['id_clt']]['DEBITO'][50249]["valor"])) {
                                $movimento_falta = $mov[$row_rel['id_recisao']][$row_rel['id_clt']]['DEBITO'][50249]["valor"];
                            } else {
                                $movimento_falta = 0;
                            } ?>
                                <td align="right" class="esconderr"><?php echo "R$ " . number_format($row_rel['valor_faltas'] + $movimento_falta, 2, ",", ".");
                            $total_faltas += $row_rel['valor_faltas'] + $movimento_falta;
                            $total_deducao_debito -= $row_rel['valor_faltas'] + $movimento_falta; ?></td>    <!-- 117 -->                    
                                <td align="right" class="esconderr"><?php echo "R$ " . number_format($row_rel['ir_ferias'], 2, ",", ".");
                            $total_ir_ferias += $row_rel['ir_ferias'];
                            $total_deducao_debito += $row_rel['ir_ferias']; ?></td>    <!-- 116 -->                    
                                <td align="right" class=""><?php echo "R$ " . number_format($row_rel['total_deducao'] + $total_movimentos[$row_rel['id_recisao']][$row_rel['id_clt']]['DEBITO'], 2, ",", ".");
                            $total_deducao += $row_rel['total_deducao'] + $total_movimentos[$row_rel['id_recisao']][$row_rel['id_clt']]['DEBITO']; ?></td> <!--echo "R$ " . number_format($total_deducao_debito + $total_movimentos[$row_rel['id_recisao']][$row_rel['id_clt']]['DEBITO'], 2, ",", "."); $total_deducao += $total_deducao_debito + $total_movimentos[$row_rel['id_recisao']][$row_rel['id_clt']]['DEBITO']; -->         
                                <td align="right">
        <?php
        ...
        ?>
                                ...
                                <td align="right" class="esconderrr"><?php echo "R$ " . number_format($row_rel['saldo_salario'] + $row_rel['dt_salario'] + $movimentos_incide + $row_rel['terceiro_ss'], 2, ",", ".");
        $total_base_inss += $row_rel['saldo_salario'] + $row_rel['dt_salario'] + $movimentos_incide + $row_rel['terceiro_ss']; ?></td> 
                                <td align="right" class="esconderrr"><?php echo "R$ " . number_format($row_rel['saldo_salario'] + $row_rel['dt_salario'] + $movimentos_incide + $row_rel['terceiro_ss'] + $row_rel['lei_12_506'] + $aviso[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'], 2, ",", ".");
        $total_base_fgts += $row_rel['saldo_salario'] + $row_rel['dt_salario'] + $movimentos_incide + $row_rel['terceiro_ss'] + $row_rel['lei_12_506'] + $aviso[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO']; ?></td> 
                                <td align="right" class="esconderrr"><?php echo "R$ " . number_format($row_rel['lei_12_506'] + $row_rel['dt_salario'] + $row_rel['terceiro_ss'], 2, ",", ".");
        $total_base_pis += $row_rel['lei_12_506'] + $row_rel['dt_salario'] + $row_rel['terceiro_ss']; ?></td> 
                                <td align="right" style="background: #fff; border: 0px;"></td>                       
                                <td align="right">
        <?php
    ...
    <?php } ?>
                    ...
                    ?>
                        ...
                        <div class="totalizador">
                            ...
                            <p>PIS: <span><?php echo "R$ " . number_format($total_pis_a_pagar[$status_clt], 2, ",", ".");
                    $total_geral_pis += $total_pis_a_pagar[$status_clt]; ?></span></p>
                            <p>GRRF: <span><?php echo "R$ " . number_format($total_multa_a_pagar[$status_clt], 2, ",", ".");
                    $total_geral_multa += $total_multa_a_pagar[$status_clt]; ?></span></p>
                            <p>FGTS RECOLHER: <span><?php echo "R$ " . number_format($total_fgts_recolher_a_pagar[$status_clt], 2, ",", ".");
                    $total_geral_fgts_recolher += $total_fgts_recolher_a_pagar[$status_clt]; ?></span></p>
                            <p>INSS RECOLHER EMPRESA: <span><?php echo "R$ " . number_format($total_inss_empresa_a_pagar[$status_clt], 2, ",", ".");
                    $total_geral_inss_emp += $total_inss_empresa_a_pagar[$status_clt]; ?></span></p>
                            <p>INSS RECOLHER TERCEIRO: <span><?php echo "R$ " . number_format($total_inss_terceiro_a_pagar[$status_clt], 2, ",", ".");
                    $total_geral_inss_terceiro += $total_inss_terceiro_a_pagar[$status_clt]; ?></span></p>

                            <p class="semborda">(+) SUBTOTAL: <span><?php echo "R$ " . number_format($total_pis_a_pagar[$status_clt] + $total_multa_a_pagar[$status_clt] + $total_inss_empresa_a_pagar[$status_clt] + $total_inss_terceiro_a_pagar[$status_clt] + $total_fgts_recolher_a_pagar[$status_clt], 2, ",", ".");
                    $sub_total_geral += $total_pis_a_pagar[$status_clt] + $total_multa_a_pagar[$status_clt] + $total_inss_empresa_a_pagar[$status_clt] + $total_inss_terceiro_a_pagar[$status_clt] + $total_fgts_recolher_a_pagar[$status_clt]; ?></span></p>
                            <p>(+) TOTAL A SER PAGO(RESCISÕES): <span><?php echo "R$ " . number_format($total_a_ser_pago[$status_clt], 2, ",", ".");
                    $total_geral_a_ser_pago += $total_a_ser_pago[$status_clt]; ?></span></p>
                            <p class="semborda">(=) TOTAL: <span><?php echo "R$ " . number_format($total_pis_a_pagar[$status_clt] + $total_multa_a_pagar[$status_clt] + $total_inss_empresa_a_pagar[$status_clt] + $total_inss_terceiro_a_pagar[$status_clt] + $total_fgts_recolher_a_pagar[$status_clt] + $total_a_ser_pago[$status_clt], 2, ",", ".");
                    $total_geral += $total_pis_a_pagar[$status_clt] + $total_multa_a_pagar[$status_clt] + $total_inss_empresa_a_pagar[$status_clt] + $total_inss_terceiro_a_pagar[$status_clt] + $total_fgts_recolher_a_pagar[$status_clt] + $total_a_ser_pago[$status_clt]; ?></span></p>
                        </div>
                        <?php } ?>
...
//                $total_decimo_a_pagar = 0;
        ...
        <?php if ($row_rel['motivo'] == 64) {
            ...
            $multa_479 = null;
                                ...
                                <td align="right" ><?php echo "[" . sprintf('%02d', $row_rel['avos_dt']) . "/12] <br /> R$ " . number_format($row_rel['dt_salario'], 2, ",", ".");
        $total_dt_salario += $row_rel['dt_salario'];
        $total_decimo_a_pagar += $row_rel['dt_salario']; ?></td> <!-- 63 -->                      
                                <td align="right" ><?php echo "R$ " . number_format(0, 2, ",", ".");
        $total_terceiro_exercicio += 0;
        $total_decimo_a_pagar += 0; ?></td>    <!-- 64 -->   
                                <td align="right" ><?php echo "R$ " . number_format($row_rel['terceiro_ss'], 2, ",", ".");
        $total_terceiro_ss += $row_rel['terceiro_ss'];
        $total_decimo_a_pagar += $row_rel['terceiro_ss']; ?></td>   <!-- 70 -->                      
                                <td align="right" ><?php echo "[" . sprintf('%02d', $row_rel['avos_fp']) . "/12] <br /> R$ " . number_format($row_rel['ferias_pr'], 2, ",", ".");
        $total_ferias_pr += $row_rel['ferias_pr'];
        $total_ferias_a_pagar += $row_rel['ferias_pr']; ?></td>  <!-- 65 -->  
                                <td align="right" ><?php echo "R$ " . number_format($row_rel['umterco_fp'], 2, ",", ".");
        $total_umterco_fp += $row_rel['umterco_fp'];
        $total_ferias_a_pagar += $row_rel['umterco_fp']; ?></td> 
                                <td align="right" ><?php echo "R$ " . number_format($row_rel['ferias_vencidas'], 2, ",", ".");
        $total_ferias_aquisitivas += $row_rel['ferias_vencidas'];
        $total_ferias_a_pagar += $row_rel['ferias_vencidas']; ?></td>  <!-- 66 -->                         
                                <td align="right" ><?php echo "R$ " . number_format($row_rel['umterco_fv'], 2, ",", ".");
        $total_umterco_fv += $row_rel['umterco_fv'];
        $total_ferias_a_pagar += $row_rel['umterco_fv']; ?></td> 
                                <td align="right" ><?php echo "R$ " . number_format($row_rel['umterco_fv'] + $row_rel['umterco_fp'], 2, ",", ".");
        $total_terco_constitucional += $row_rel['umterco_fv'] + $row_rel['umterco_fp'];
        $total_ferias_a_pagar += $row_rel['umterco_fv'] + $row_rel['umterco_fp']; ?></td>    <!-- 68 -->              

                                <td align="right" ><?php echo "R$ " . number_format($row_rel['ferias_aviso_indenizado'], 2, ",", ".");
        $total_f_aviso_indenizado += $row_rel['ferias_aviso_indenizado'];
        $total_ferias_a_pagar += $row_rel['ferias_aviso_indenizado']; ?></td>              <!-- 71 -->           
                                <td align="right" ><?php echo "R$ " . number_format($row_rel['fv_dobro'], 2, ",", ".");
        $total_f_dobro += $row_rel['fv_dobro'];
        $total_ferias_a_pagar += $row_rel['fv_dobro']; ?></td>  <!-- 72 -->                           
                                <td align="right" ><?php echo "R$ " . number_format($row_rel['um_terco_ferias_dobro'], 2, ",", ".");
        $total_umterco_f_dobro += $row_rel['um_terco_ferias_dobro'];
        $total_ferias_a_pagar += $row_rel['um_terco_ferias_dobro']; ?></td>  <!-- 73 -->                           
                                <td align="right" ><?php echo "R$ " . number_format($row_rel['umterco_ferias_aviso_indenizado'], 2, ",", ".");
        $total_umterco_ferias_aviso += $row_rel['umterco_ferias_aviso_indenizado'];
        $total_ferias_a_pagar += $row_rel['umterco_ferias_aviso_indenizado']; ?></td>   <!-- 82 --> 
                                <td align="right" ><?php echo "R$ " . number_format($row_rel['lei_12_506'], 2, ",", ".");
        $total_lei_12_506 += $row_rel['lei_12_506']; ?></td>  <!-- 95 -->                           
                                <td align="right" ><?php echo "R$ " . number_format($aviso[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO'], 2, ",", ".");
        $total_aviso_indenizado += $aviso[$row_rel['id_recisao']][$row_rel['id_clt']]['CREDITO']; ?></td>    <!-- 69 -->  
                                <!--DEDUÇÕES--->
        ...
        <!--                        <td align="right" ><?php echo "R$ " . number_format(0, 2, ",", ".");
                        $total_adiantamento_13_salarial += 0; ?></td>   102                            
        <td align="right" ><?php echo "R$ " . number_format($aviso[$row_rel['id_recisao']][$row_rel['id_clt']]['DEBITO'], 2, ",", ".");
                        $total_aviso_indenizado_debito += $aviso[$row_rel['id_recisao']][$row_rel['id_clt']]['DEBITO']; ?></td>   103                            -->
                                        <?php if ($row_rel['motivo'] == 64) {
                                            $multa_480 = null;
                                        } else if ($row_rel['motivo'] == 63) {
        ...
        <!--                        <td align="right" ><?php echo "R$ " . number_format($row_rel['inss_dt'], 2, ",", ".");
                                        $total_inss_dt += $row_rel['inss_dt'];
                                        $total_deducao_debito += $row_rel['inss_dt']; ?></td>    112.2                      
        <td align="right" ><?php echo "R$ " . number_format($row_rel['ir_dt'], 2, ",", ".");
                                        $total_ir_dt += $row_rel['ir_dt'];
                                        $total_deducao_debito += $row_rel['ir_dt']; ?></td>     114.2                     
        <td align="right" ><?php echo "R$ " . number_format($row_rel['adiantamento_13'], 2, ",", ".");
                                        $total_adiantamento_13 += $row_rel['adiantamento_13']; ?></td>     115.2                     -->
        ...
        <!--<td align="right" ><?php echo "R$ " . number_format($row_rel['ir_ferias'], 2, ",", ".");
        $total_ir_ferias += $row_rel['ir_ferias'];
        $total_deducao_debito += $row_rel['ir_ferias']; ?></td>     116 -->                    
