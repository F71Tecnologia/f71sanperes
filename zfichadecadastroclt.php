...
if (empty($_COOKIE['logado'])) {
    ...
    $result_horario = mysql_query("Select * from rh_horarios where funcao = '$row[id_curso]'");
                ...
                <tr>
                    <td colspan="3">
                        <table class="relacao" style="width:100%; margin-top:10px;">
                            ...
                            <tr>
                                <td colspan="5"><b><?php print "$row[endereco]"; ?>, <?php print "$row[bairro]"; ?>, <?php print "$row[cidade]"; ?> - <?php print "$row[uf]"; ?></b></td>
