...
$row_projeto=mysql_fetch_assoc($qr_projeto);
	...
	?>
      ...
      <div id="topo_menu" >
           ...
           <h2 style="float:left; font-size:18px; border-bottom:2px solid #F3F3F3; ">GERENCIAR ANEXOS DO PROJETO: <span class="projeto"><?=$id_projeto.' - '.$row_projeto['nome'].' '.' ('.$row_projeto['regiao'].')'?></span></h2>
      ...
      <div id="topo_menu" style="border-bottom:2px solid #F3F3F3; margin:10px 0 18px 0;">
        ...
        <table cellpadding="0" cellspacing="1" class="secao">
          ...
          <tr>
            <td class="secao">Proposta de trabalho:</td>
            <td colspan="5">
		...
		<?php	} else {
			?>
            <img src="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/intranet/projeto/anexos/'.$row_anexos['anexo_nome'].'.'.$row_anexos['anexo_extensao']?>" height="250" width="200" >
           <?php }?> </tr>
            <tr>
            <td>
