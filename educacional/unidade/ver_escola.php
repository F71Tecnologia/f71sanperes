...
$breadcrumb_config = array("nivel" => "../../", "key_btn" => "52", "area" => "Educacional", "ativo" => "Cadastro/Edição de Dados da Escolas", "id_form" => "form1");
...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header box-educacional-header"><h2><span class="fa fa-graduation-cap"></span> - EDUCACIONAL <small> - Cadastro/Edição de Dados da Escolas</small></h2></div>
