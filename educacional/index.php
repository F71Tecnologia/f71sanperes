...
<html lang="pt">
    <head>
        ...
        <title>:: Intranet :: EAD/Biblioteca</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header box-educacional-header"><h2><span class="fa fa-graduation-cap"></span> EDUCACIONAL - <small>EAD/Biblioteca</small></h2></div>
                    <div class="bs-component">
                        <div class="detalhes-modulo">
                            <?php echo $botoes->getHtmlBotoesModulo(53, 52) ?>
                        </div>
                    </div> 
                </div>
            </div>
