...
<html lang="pt">
    <head>
        ...
        <title>:: Intranet :: Gestão Escolar</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header box-educacional-header"><h2><span class="fa fa-graduation-cap"></span> EDUCACIONAL - <small>Gestão Escolar</small></h2></div>
                    <div class="bs-component">
                        <div class="detalhes-modulo">
                            <?php echo $botoes->getHtmlBotoesModulo(54, 52) ?>
                        </div>
                    </div> 
                </div>
            </div>
