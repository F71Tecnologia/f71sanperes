...
$result_bolsista = mysql_query("SELECT * FROM autonomo where status = '1'  AND id_projeto = '$projeto' AND tipo_contratacao ='1' AND assinatura ='0' ORDER BY nome");
$num_row = mysql_num_rows($result_bolsista);

$result_clt = mysql_query("SELECT * FROM rh_clt where status = '10' AND id_projeto = '$projeto' AND assinatura ='0' ORDER BY nome");
$num_clt = mysql_num_rows($result_clt);

$result_cooperado = mysql_query("SELECT * FROM autonomo where status = '1' AND id_projeto = '$projeto'  AND tipo_contratacao ='3' AND assinatura ='0' ORDER BY nome");
  ...
  <tr> 
    <td colspan="3"><div align="center">
        <p><strong><br>
          ...
          RELAT&Oacute;RIO DE CONTRATOS N&Atilde;O ASSINADOS<br>
          <br>
