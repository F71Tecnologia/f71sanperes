<?php
  ...
  if (!$ctbc) { $ctbc = "#FF6262"; }			//Set Cell Background Color
...
.NormalDay {
	...
	/*background-image:url('img_menu_principal/dia_normal.png') ;*/
...
.MarkDay {
	...
	text-align: <?php print $ndal; ?>;
	vertical-align: <?php print $ndva; ?>;
	/*background-image:url('img_menu_principal/dia_hoje.png') ;*/
	background-repeat:repeat-x;
}
.BlankDay {
...
.WeekdayTitle {
	...
	/*background-image:url('img_menu_principal/dias_semana.png') ;*/
	background-repeat:repeat-x;
}
-->
</style>
...
<table border="<?php print $tbd; ?>" cellpadding="<?php print $tcp; ?>" cellspacing="<?php print $tcs; ?>" width="<?php print $dbw * 7; ?>">
    <tr>
      <td style="font-size:12px;text-align:center; background-color:#666;color:#FFF; ">
      
	  <?php

 print "<b>$month[$current_month] de $current_year</b>";
