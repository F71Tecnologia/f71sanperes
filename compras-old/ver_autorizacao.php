...
<table width="100%"  border="1px" style="border-color:#000; font-size:19px" cellspacing="0" cellpadding="1">
    ...
    <b>AUTORIZA&Ccedil;&Atilde;O DE COMPRA</b></td>
    ...
    <tr>
    <td colspan="2" align="center"><font size="30"><b> AUTORIZA&Ccedil;&Atilde;O DE COMPRA</b></font></td>
    </tr>
       <tr>
    ...
    APÓS ANÁLISE DO ITEM <?php echo $row_compra['nome_produto'];?>  FOI ENCAMINHADO PARA COTAÇÃO ORÇAMENTÁRIA
    </td>
    </tr>
    <tr>
