...
$('#ok').click(function(){
	...
	var parcelas = parseInt($('#n_parcelas').val());
	var valor = $('#valor').val();
	var i = 0;
	...
	$('#valores_saida').append('<div><span><strong>Parcela '+i+'</strong></span> Data: <input type="text" name="data_pg[]" value="'+data_pg+'" class="data_pg"/> Valor: <input name="valor_parcela[]" value="'+valor+'" class="valores"/> ');	
...
<div id='fixo' style="display:none">
 ...
 <form name="form" id="form" action="gerar_saida.php">        
<table width="100%">
  <tr>
  	<td colspan="2" align="center">DADOS DA SAÍDA PARA O FINANCEIRO</td>
  </tr>
...
$row = mysql_fetch_array($result);
	...
	mysql_query("UPDATE compra SET id_user_aprovacao='$id_user', data_decisao='$data', acompanhamento = '7' where id_compra = '$compra'") or die ("<center>ERRO!<br> tente novamente mais tarde<br><br>".mysql_error());
