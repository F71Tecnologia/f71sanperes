...
<table width="100%"  border="1px" style="border-color:#000; font-size:19px" cellspacing="0" cellpadding="1">
    ...
    <tr>
    <td colspan="2" align="center"><b><font size="30">SELEÇÃO</font></b></td>
    </tr>
       <tr>
    ...
    <td style="font-size:22px"> 
      ...
      <p>APÓS ANÁLISE DO ITEM <?php echo $row_compra['nome_produto'];?>  FOI ENCAMINHADO PARA COTAÇÃO ORÇAMENTÁRIA.
      </p>
