...
$result_fornecedor = mysql_query("SELECT * FROM fornecedores WHERE id_projeto=$row[id_projeto]");
$result_fornecedor2 = mysql_query("SELECT * FROM fornecedores WHERE id_projeto=$row[id_projeto]");
$result_fornecedor3 = mysql_query("SELECT * FROM fornecedores WHERE id_projeto=$row[id_projeto]");
