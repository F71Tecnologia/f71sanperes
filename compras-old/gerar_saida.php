...
mysql_query("INSERT INTO saida(id_regiao,id_projeto,id_banco,id_user,nome,especifica,tipo,valor,data_proc,data_vencimento) values 
...
mysql_query("UPDATE compra SET acompanhamento=8 WHERE id_compra=$id_compra");
