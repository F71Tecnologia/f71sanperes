...
<form action="av_lote.php" method="post" class="style6" name='form1' onSubmit="return valida()">

<table width="86%" align="center" cellspacing="5">
  <tr>
    <td height="25" colspan="3" align="center" valign="middle"><div align="left">
      <p class="style2"><img src="imagens/avalia.gif" alt="avalia" width="440" height="20" /><br />
        <span class="style26">SELECIONE OS CRIT&Eacute;RIOS PARA O CANDIDATO SELECIONADO</span></p>
      <div class="style26">
      
<?php
for($i=0 ; $i < $contCLT; $i++){
	if($tipo == 1){
		$RE_Fun = mysql_query("SELECT * FROM rh_clt WHERE id_clt = '$clt[$i]'");
		$rowFun = mysql_fetch_array($RE_Fun);
	}else{
		$RE_Fun = mysql_query("SELECT * FROM autonomo WHERE id_autonomo = '$clt[$i]'");
		$rowFun = mysql_fetch_array($RE_Fun);
	}
	
	echo "<input name='id_parti[]' id='id_parti' type='checkbox' value='$rowFun[0]' checked style='display:none'>".$rowFun['nome']."<br>";
...
?>
  ...
  <tr>
    <td colspan="2" valign="top" class="style11"><p class="style38"> 1. Compet&ecirc;ncia 
      ...
      Demonstrada&nbsp;</p></td>
    <td class="style13"><table border="1" cellspacing="0" cellpadding="0" width="100%">
      <tr>
        ...
        <td width="98%" valign="top" class="style35"><p>Os conhecimentos, 
          ...
          fizesse determinada tarefa ou qualquer fato que indicasse o <u>reconhecimento 
            ...
            da compet&ecirc;ncia do avaliado por pessoas de fora do seu departamento</u>. </p></td>
      </tr>
    </table></td>
  </tr>
  <tr>
      ...
      <tr>
        ...
        <td width="98%" valign="top" class="style35"><p>Os conhecimentos, 
          ...
          pelo funcion&aacute;rio. O <u>reconhecimento da compet&ecirc;ncia 
            ...
            do funcion&aacute;rio ficou restrito ao seu departamento</u>. </p></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    ...
    <td class="style13"><table border="1" cellspacing="0" cellpadding="0" width="0">
      <tr>
        <td valign="top" class="style35"><p align="center">
          ...
          4 </p></td>
        <td valign="top" class="style35"><p>O funcion&aacute;rio esteve <u>sempre</u> procurando adquirir novos conhecimentos e habilidades e se desenvolver 
    ...
    <td class="style13"><table border="1" cellspacing="0" cellpadding="0" width="0">
      <tr>
        <td valign="top" class="style35"><p align="center">
          ...
          2 </p></td>
        <td valign="top" class="style35"><p>O funcion&aacute;rio <u>s&oacute;</u> tomou a iniciativa de aprender coisas novas <u>quando</u> apareceu 
    ...
    <td class="style13"><table border="1" cellspacing="0" cellpadding="0" width="0">
      <tr>
        <td valign="top" class="style35"><p align="center">
          ...
          1 </p></td>
        <td valign="top" class="style35"><p>O funcion&aacute;rio <u>s&oacute;</u> tomou a iniciativa para adquirir novos conhecimentos ou habilidades <u>quando</u> fortemente <u>incentivado, ou direta ou indiretamente 
    ...
    <td class="style13"><table border="1" cellspacing="0" cellpadding="0" width="0">
      <tr>
        ...
        <td valign="top" class="style35"><p>O funcion&aacute;rio <u>precisar&aacute; 
          ...
          seu superior imediato ou ocupar um cargo maior em outra &aacute;rea. </p></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    ...
    <td class="style13"><table border="1" cellspacing="0" cellpadding="0" width="0">
      <tr>
        ...
        <td valign="top" class="style35"><p>Para conseguir os resultados esperados, 
          ...
          reconhecido como uma das pessoas que <u>fizeram a diferen&ccedil;a</u> no grupo. Foi um dos principais destaques na equipe. </p></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    ...
    <td class="style13"><table border="1" cellspacing="0" cellpadding="0" width="0">
      <tr>
        ...
        <td valign="top" class="style35"><p>O funcion&aacute;rio <u>n&atilde;o 
          ...
          pessoas da equipe e <u>constante orienta&ccedil;&atilde;o superior</u>. </p></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    ...
    <td class="style13"><table border="1" cellspacing="0" cellpadding="0" width="0">
      <tr>
        ...
        <td valign="top" class="style35"><p>O funcion&aacute;rio conseguiu 
          ...
          O funcion&aacute;rio <u>soube resolver os problemas mais complexos</u> que surgiram, <u>praticamente sem orienta&ccedil;&atilde;o superior</u>. </p></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    ...
    <td class="style13"><table border="1" cellspacing="0" cellpadding="0" width="0">
      <tr>
        ...
        <td valign="top" class="style35"><p><u>Contribu&iacute;ram</u> para 
          ...
          melhorar a compet&ecirc;ncia e desempenho do funcion&aacute;rio.&nbsp; <u>Tiveram alguns reflexos positivos na qualidade ou resultados 
    ...
    <td class="style13"><table border="1" cellspacing="0" cellpadding="0" width="0">
      <tr>
        <td valign="top" class="style35"><p align="center">
          ...
          1 </p></td>
        <td valign="top" class="style35"><p><u>Praticamente n&atilde;o contribu&iacute;ram</u> para a qualidade ou resultados do trabalho do funcion&aacute;rio 
  ...
  <tr>
    <td colspan="3" valign="top" class="style23"><center>
      <input type="button" value="Calcular Pontua&ccedil;&atilde;o Final" onclick="valida()" />
      <br />
      <br />
      <span id="resultado2" class="style27">Pontua&ccedil;&atilde;o:</span>
    </center>
      <br /></td>
  </tr>
  <tr>
    ...
    <td colspan="2"><strong>
      <textarea name="obs" cols="51" rows="5" id="obs"></textarea>
    </strong></td>
  </tr>
  <tr>
    ...
    <input type="hidden" name="regiao" value="<?=$regiao?>" />
      ...
      <input type="hidden" name="id_clt" value="<?=$teste?>" />
...
$contCLT = count($pessoas);

for($i=0 ; $i < $contCLT ; $i++){
	
	if($tipo == 1){
		$RE_Fun = mysql_query("SELECT * FROM rh_clt WHERE id_clt = '$pessoas[$i]'");
		$rowFun = mysql_fetch_array($RE_Fun);
		mysql_query ("UPDATE rh_clt SET psicologia = '$radio_total', obs = '$obs', id_psicologia = '1' where id_clt = '$pessoas[$i]'");
	}else{
		$RE_Fun = mysql_query("SELECT * FROM autonomo WHERE id_autonomo = '$pessoas[$i]'");
		$rowFun = mysql_fetch_array($RE_Fun);
		mysql_query ("UPDATE autonomo SET psicologia = '$radio_total', obs = '$obs', id_psicologia = '1' where id_autonomo = '$pessoas[$i]'");
	}
	
	$result_pro = mysql_query("SELECT * FROM projeto where id_projeto = '$rowFun[id_projeto]'");
	$row_pro = mysql_fetch_array($result_pro);

	$result_curso = mysql_query("SELECT * FROM curso where id_curso = '$rowFun[id_curso]'");
        ...
        <tr align='center' valign='top'>
          ...
          <td align='left'>
            ...
            <blockquote>
               ...
               <font face='arial' size='2' color='red'>Nome:&nbsp; <strong>$rowFun[nome]  &nbsp;-&nbsp;RG: $rowFun[rg]</strong></font><br><br>
			    <font face='arial' size='2' color='red'> Unidade:&nbsp; <strong>$rowFun[locacao]</strong></font><br><br>
			  ...
			  <table width='80%' border='0' cellspacing='0' cellpadding='0' align='center'>
			  	<tr>
			  		...
			  		<td width='50%' align='center'><font face='arial' size='2'>_______________________________________________<br>COORDENADOR RESPONSÁVEL</font></td>
			  	</tr>
			  </table>
			  <br>
			  
              <hr align='center' style='style24'>
              <div align='center'><font face='arial' size='2'><strong>INSTITUTO  &ldquo;SORRINDO PARA A VIDA&rdquo; - C.G.C. 06.888.897/0001-18</strong><br>
                Av. S&atilde;o Luiz, 112 - 18&ordm;. andar - Cj 1802 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Rua da Assembleia,   10 - Cj 2617- Centro &nbsp;&nbsp;&nbsp;<BR>
                S&atilde;o Paulo - SP -   CEP 01046-000   - (11) 3255-6959&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;Rio de Janeiro - RJ - CEP 20011-901 - (21) 2252-8901<BR></font>
              </div>
...
}//FINALIZANDO PAGINA TODA

?>


<a href='bolsista_class.php?id=2&projeto=<?=$projeto?>&regiao=<?=$regiao?>' class='link'><img src='imagens/voltar.gif' border=0></a>
