...
<html>
    ...
    <?php if(!isset($_GET['id'])) {
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - RECURSOS HUMANOS<small> - CBO Total de Atividades: <?=($total_cbo_clt + $total_cbo_cooperado)?></small></h2></div>
                </div>
            </div>
            <hr>
            <div class="row">
                                        ...
                                        <?php while($row_cbo_clt = mysql_fetch_assoc($qr_cbo_clt)) { ?>
                                            <tr>
                                                <td>
                                                    ...
                                                    <a href="?id=<?=$row_cbo_clt['id_curso']?>" onClick="return hs.htmlExpand(this, { objectType: 'iframe' } )" class="participante" title="Editar CBO desta atividade"><?=$row_cbo_clt['nome']?></a>
                                                    <?php }else{ ?>
                                                    <?=$row_cbo_clt['nome']?>
                                                    <?php } ?>
                                                </td>
