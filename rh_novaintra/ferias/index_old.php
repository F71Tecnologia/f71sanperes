                        ...
                        <div role="tabpanel" class="tab-pane" id="relatorio">
                            <form class="form-horizontal" role="form" id="form-rel" method="post">
                                ...
                                <div class="panel panel-default hidden-print">
                                    ...
                                    <div class="panel-footer text-right">
                                        <a href="relatorio_ferias_vencidas.php" class="btn btn-success">Relatório de Férias Vencidadas </a>
...
<!--                                <div class="panel panel-default hidden-print">
        ...
        <script type="text/javascript" src="/intranet/js/bootstrap-datepicker-1.4.0-dist/js/bootstrap-datepicker.js?9135"></script>
        <script type="text/javascript" src="/intranet/js/bootstrap-datepicker-1.4.0-dist/js/bootstrap-datepicker.min.js?9135"></script>
        <script type="text/javascript" src="/intranet/js/bootstrap-datepicker-1.4.0-dist/locales/bootstrap-datepicker.pt-BR.min.js?9135"></script>
        <script src="../../resources/js/rh/ferias/index2.js?9135"></script>
