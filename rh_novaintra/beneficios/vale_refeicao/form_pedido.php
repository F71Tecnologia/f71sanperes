...
$breadcrumb_pages = array("Gestão de RH" => "../../../rh/principalrh.php", "Benefícios" => "../", "Vale Refeição" => "index.php");
...
if (isset($_REQUEST['salvar'])) {
    ...
    $log->gravaLog('Benefícios - Vale Refeição', "Pedido Gerado: ID{$id_pedido_salvo}");
                    ...
                    <form method="post" action="#" id="form1" class="form-horizontal">
                        ...
                        <?php if (count($listaS) > 0) { ?> 
                            <div class="alert alert-danger">
                                <h4>Sindicatos sem valor de refeição:</h4>
                                <ul>
                                            ...
                                            foreach ($lista as $key => $value) {
                                                ...
                                                if (($value['horas_semanais'] > 20 || $id_regiao == 1) || (strstr($fnc, "MEDICO"))) {
                                                    ...
                                                    if($value['valor_vr_fixo'] > 0){
                                                        ...
                                                        //PESSOAS QUE RECEBEM VR POR DIA ÚTIL
                                                        if($value['val_dia'] > 0){
...
<!--                                            <tr>
                            ...
                            <div class="alert alert-danger">
                                <?php if($totSemHorario > 0){ ?>
                                <h4>Existe(m) <?php echo $totSemHorario; ?> Clt(s) sem Horário:</h4>
                                <ul>
