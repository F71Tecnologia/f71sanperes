...
if(isset($_REQUEST['excluir'])){
    ...
    $log->gravaLog('Benefícios - Vale Refeição', "Pedido Excluido: ID{$_REQUEST['id']}");
    echo json_encode(array('status'=>$return,'msg'=>'Excluido com sucesso.'));
    exit();
}

$breadcrumb_config = array("nivel" => "../../../", "key_btn" => "3", "area" => "Recursos Humanos", "id_form" => "form1", "ativo" => "Vale Refeição");
$breadcrumb_pages = array("Gestão de RH" => "../../../rh/principalrh.php", "Benefícios" => "../");

$lista = $objAlimentaca->listar(2);
...
<html lang="pt">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - RECURSOS HUMANOS <small>- Vale Refeição</small></h2></div>
                                ...
                                <?php foreach ($lista as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <a href="../controle.php?id=<?= $value['id_va_pedido'] ?>&tipo=2" class="btn btn-info btn-xs" data-toggle="tooltip" title="Download"><i class="fa fa-download"></i></a>
