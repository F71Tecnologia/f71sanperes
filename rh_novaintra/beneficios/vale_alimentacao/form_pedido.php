...
if (isset($_REQUEST['filtrar'])) {
    ...
    $result = $objAlimentacaItem->getListaCltsVA($regiao, $id_tipo);
    ...
    $pedidosMes = $objAlimentacaItem->getPedidoNoMes($mes, $ano, $projeto, $regiao, 1);
    $totPedido = mysql_num_rows($pedidosMes);
    
    if(($totSemUnidade > 0) || ($totSemFuncao > 0) || ($totSemSindicato > 0) || ($totPedido > 0)){
