...
$breadcrumb_caminhos[0] = array("Gestão de RH"=>"index.php", "Edição de Participantes"=>"clt.php");
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - RECURSOS HUMANOS<small> - Relátorio Folha de Ponto/Produção</small></h2></div>
                </div>
            </div>
