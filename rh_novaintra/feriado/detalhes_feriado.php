        ...
        <div id="content" style="width: 1000px;">
            <form action="" method="post" name="form1" id="form1" enctype="multipart/form-data" >
                <div id="head">
                    ...
                    <div class="fleft">
                        <h2>Feriado <?php echo $row['nome']; ?></h2>
                    </div>
                </div>
                ...
                <p class="controls">
                    <input type="submit" class="button bt-image" value="Editar" name="editarFeriado" id="editarFeriado" data-type="editar" data-key="<?php echo $row['id_feriado']; ?>" />
