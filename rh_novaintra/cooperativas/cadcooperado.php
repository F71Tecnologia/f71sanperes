...
if(empty($_REQUEST['update'])) {
    ...
    switch($tipo_contratacao) {
        case 3: $tipo_contratacao_nome = 'Cooperado'; break;
        case 4: $tipo_contratacao_nome = 'Autônomo / PJ'; break;
   }

    $usuario = carregaUsuario();
    
    $dadosHeader = montaCabecalhoNovo(getRegioes(), getMasters(), $usuario, __FILE__); //PREPARA VARIAVEIS PARA FUNCIONAMENTO DO CABEÇALHO (TROCA DE MASTER E DE REGIÕES)
    $breadcrumb_config = array("nivel"=>"", "key_btn"=>"3", "area"=>"Recursos Humanos", "id_form"=>"form1", "ativo"=>"Cadastrar $tipo_contratacao_nome");
    ...
    <html>
        <head>
            ...
            <title>:: Intranet :: Cadastrar <?=$tipo_contratacao_nome?></title>
        ...
        <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - RECURSOS HUMANOS <small> - Cadastrar <?=$tipo_contratacao_nome?></small></h2></div>
                    </div>
                </div>
                <form action="<?=$_SERVER['PHP_SELF']?>" method="post" name="form1" class="form-horizontal" enctype="multipart/form-data" onsubmit="return validaForm()">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-xs-1"><input name="codigo" class="form-control" type="text" id="codigo" value="<?=$codigo?>" /></div>
                                <label class="col-xs-offset-2 col-xs-2 control-label">Projeto:</label>
                            ...
                            <div class="form-group">
                                <label class="col-xs-2 control-label">Matrícula:</label>
                                <div class="col-xs-4"><input type="text" name="matricula" maxlength="6" class="form-control" /></div>
                                <label class="col-xs-2 control-label">Número do processo:</label>
                                <div class="col-xs-4"><input type="text" name="n_processo" maxlength="11" class="form-control" /></div>
                            </div>
                            <?php } ?>
                            <div class="form-group">
                                <label class="col-xs-2 control-label">Cooperativa Vinculada:</label>
                                ...
                                if(!empty($verifica_coop)) {
                                    echo "<div class='col-xs-4'><select class='form-control' name='vinculo' id='vinculo'>";
                                    while($row_coop = mysql_fetch_array($result_coop)) {
                                        echo "<option value='$row_coop[0]'>$row_coop[0] - $row_coop[fantasia]</option>";
                                    }
                                    echo "</select></div>";
                                } else {
                                    echo "<label class='col-xs-4 control-label text-left'>Nenhuma Cooperativa Cadastrada</label>";
                                } ?>
                                ...
                                if(!empty($verifica_curso)) {
                                    echo "<div class='col-xs-4'><select class='form-control' name='atividade' id='atividade'>";
                                    while($row_curso = mysql_fetch_array($result_curso)) {
                                        echo "<option value='$row_curso[0]'>$row_curso[0] - $row_curso[nome]</option>";
                                    }
                                    echo "</select></div>";
                                } else {
                                    echo "<label class='col-xs-4 control-label text-left'>Nenhuma Atividade Cadastrada</label>";
                                } ?>
                            </div>
                            <div class="form-group">
                                ...
                                if(!empty($verifica_unidade)) {
                                    echo "<div class='col-xs-4'><select class='form-control' name='locacao' id='locacao'>";
                                    while ($row_unidade = mysql_fetch_array($result_unidade)) {
                                        echo "<option value='" . $row_unidade[unidade] . " // " . $row_unidade[id_unidade] . "'>$row_unidade[id_unidade] - $row_unidade[unidade]</option>";
                                    }
                                    echo "</select></div>";
                                } else {
                                    echo "<label class='col-xs-4 control-label text-left'>Nenhuma Unidade Cadastrada</label>";
                                } ?>
                                <?php if($tipo_contratacao == 4) { ?>
                                <label class="col-xs-2 control-label"></label>
                                <label class='col-xs-4 control-label text-left'><input type="checkbox" name="contrato_medico" value="1"/> Necessita de contrato para médicos?</label>
                                <?php  } ?>
                            </div>
                            <div class="form-group none">
                                <label class="col-xs-2 control-label"></label>
                                <label class='col-xs-2 control-label text-left'><input name='contratacao' type='radio' class="reset" id='contratacao' value='3' <?=($_GET['tipo'] == "3") ? "checked" : "";?> > Cooperado </label>
                                <label class='col-xs-2 control-label text-left'><input name='contratacao' type='radio' class="reset" id='contratacao' value='4' <?=($_GET['tipo'] == "4") ? "checked" : ""; ?> > Autônomo / PJ</label>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-xs-2"><input name="nome" type="text" id="nome" class="form-control 75" onchange="this.value=this.value.toUpperCase()"/></div>
                                <label class="col-xs-2 control-label">Data de Nascimento</label>
                                <div class="col-xs-2"><input name="data_nasci" type="text" id="data_nasci" class="data form-control 15" maxlength="10" onkeyup="mascara_data(this);"/></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-2"><input name="endereco" type="text" id="endereco" class="form-control 35" onchange="this.value=this.value.toUpperCase()"/></div>
                                <label class="col-xs-2 control-label">Bairro</label>
                                <div class="col-xs-2"><input name="bairro" type="text" id="bairro" class="form-control 16" onchange="this.value=this.value.toUpperCase()"/></div>
                                <label class="col-xs-2 control-label">Naturalidade</label>
                                <div class="col-xs-2"><input name="naturalidade" type="text" id="naturalidade" class="form-control 15" onchange="this.value=this.value.toUpperCase()"/></div>
                            </div>
                        </div>
                    </div>
                </form>
<table cellpadding="0" cellspacing="1" class="secao">
  ...
  <td>
	<input name="cep" type="text" id="cep" class="form-control 10" maxlength="9"
  ...
  <tr>
    ...
    <td>
       <input name="data_escola" type="text" id="data_escola" class="form-control 15" maxlength="10"
  ...
  <tr>
    ...
    <td>
       <input name="curso" type="text" id="zona" class="form-control 16" 
              onchange="this.value=this.value.toUpperCase()"/>
    </td>
    <td class="secao">Instituição:</td>
    <td>
       <input name="instituicao" type="text" id="titulo" class="form-control 15" 
              onchange="this.value=this.value.toUpperCase()"/>
    </td>
  </tr>
  <tr>
   <td class="secao">Telefone Fixo:</td>
   <td><input name="tel_fixo" type="text" id="tel_fixo" class="form-control 14" 
              onKeyPress="return(TelefoneFormat(this,event))"
              onkeyup="pula(13,this.id,tel_cel.id)" />
   </td>
   <td class="secao">Celular:</td>
   <td><input name="tel_cel" type="text" id="tel_cel" class="form-control 16" 
              onKeyPress="return(TelefoneFormat(this,event))"
		      onkeyup="pula(13,this.id,tel_rec.id)" />
   </td>
   <td class="secao">Recado:</td>
   <td><input name="tel_rec" type="text" id="tel_rec" class="form-control 15" 
              onKeyPress="return(TelefoneFormat(this,event))" 
  ...
  <tr>
     ...
     <td colspan="5">
    	<input name="email" type="text" id="email" class="form-control 35" />
    </td>
  </tr>
    <tr>
...
<tr>
  ...
  <td>
    <input name="c_nome" type="text" id="c_nome" class="form-control 50"
           onchange="this.value=this.value.toUpperCase()" />
  </td>
  <td class="secao">Data de Nascimento:</td>
  <td>
    <input name="c_nascimento" type="text" id="c_nascimento" class="form-control 15"
...
<tr>
  ...
  <td>
    <input name="c_cpf" type="text" id="c_cpf" maxlength="15" class="form-control 20" 
           onkeypress="formatar('###.###.###-##', this)"
		   onkeyup="pula(14,this.id,c_profissao.id)"/>
  </td>
  <td class="secao">Profiss&atilde;o C&ocirc;njuge:</td>
  <td>
    <input name="c_profissao" type="text" id="c_profissao" class="form-control 15"
           onChange="this.value=this.value.toUpperCase()"/>
    </td>
  </tr>
  <tr>
	...
	<td>
      <input name="pai" type="text" id="pai" class="form-control 50" 
        	 onchange="this.value=this.value.toUpperCase()"/>
    </td>
    <td class="secao">Nacionalidade Pai:</td>
	<td>
      <input name="nacionalidade_pai" type="text" id="nacionalidade_pai" class="form-control 15" 
             onchange="this.value=this.value.toUpperCase()"/>	
    </td>
  </tr>
  <tr>
    ...
    <td>
      <input name="mae" type="text" id="mae" class="form-control 50" 
             onchange="this.value=this.value.toUpperCase()"/>
    </td>
    <td class="secao">Nacionalidade Mãe:</td>
    <td>
      <input name="nacionalidade_mae" type="text" id="nacionalidade_mae" class="form-control 15" 
             onchange="this.value=this.value.toUpperCase()"/>	
    </td>
  </tr>
  <tr>
    ...
    <td colspan="3">
		<input name="filhos" type="text" id="filhos" class="form-control 2" />
    </td>
  </tr>
  <tr>
    <td class="secao">Nome:</td>
    <td><input name="filho_1" type="text" id="filho_1" class="form-control 50" 
               onchange="this.value=this.value.toUpperCase()"/>
    </td>
    <td class="secao">Nascimento:</td>
    <td><input name="data_filho_1" type="text" class="form-control 12" maxlength="10" id="data_filho_1"
  ...
  <tr>
    <td class="secao">Nome:</td>
    <td><input name="filho_2" type="text" id="filho_2" class="form-control 50" 
               onchange="this.value=this.value.toUpperCase()"/>
    </td>
    <td class="secao">Nascimento:</td>
    <td><input name="data_filho_2" type="text" class="form-control 12" maxlength="10" id="data_filho_2"
  ...
  <tr>
    <td class="secao">Nome:</td>
    <td><input name="filho_3" type="text" id="filho_3" class="form-control 50" 
               onchange="this.value=this.value.toUpperCase()"/>
    </td>
    <td class="secao">Nascimento:</td>
    <td><input name="data_filho_3" type="text" class="form-control 12" maxlength="10" id="data_filho_3"
  ...
  <tr>
    <td class="secao">Nome:</td>
    <td><input name="filho_4" type="text" id="filho_4" class="form-control 50" 
               onchange="this.value=this.value.toUpperCase()"/>
    </td>
    <td class="secao">Nascimento:</td>
    <td><input name="data_filho_4" type="text" class="form-control 12" maxlength="10" id="data_filho_4"
  ...
  <tr>
    <td class="secao">Nome:</td>
    <td><input name="filho_5" type="text" id="filho_5" class="form-control 50" 
               onchange="this.value=this.value.toUpperCase()"/>
    </td>
    <td class="secao">Nascimento:</td>
    <td><input name="data_filho_5" type="text" class="form-control 12" maxlength="10" id="data_filho_5"
               onkeyup="mascara_data(this);"
               onchange="this.value=this.value.toUpperCase()" />
    </td>
  </tr>
...
<table cellpadding="0" cellspacing="1" class="secao">
   ...
   <tr>
      ...
      <td>
        <select class="form-control" name="cabelos" id="cabelos">
            <option>Loiro</option>
      ...
      <td>
        <select class="form-control" name="olhos" id="olhos">
            <option>Castanho Claro</option>
            <option>Castanho Escuro</option>
            <option>Verde</option>
            <option>Azul</option>
     ...
     <td>
        <input name="peso" type="text" id="peso" class="form-control 5" />
     </td>
  </tr>
  <tr>
     <td class="secao">Altura:</td>
     <td>
        <input name="altura" type="text" id="altura" class="form-control 5" />
     </td>
     ...
     <td>
        <input name="defeito" type="text" id="defeito" class="form-control 18" 
               onchange="this.value=this.value.toUpperCase()"/>
     </td>
  </tr>
  <tr>
 ...
 <tr>
	...
	<td colspan="5">
        ...
        <input name="arquivo" type="file" id="arquivo" class="form-control 60" style="display:none"/>
    </td>
  </tr>
</table>
<table cellpadding="0" cellspacing="1" class="secao">
  ...
  <tr>
    ...
    <td>
	<input name="rg" type="text" id="rg" class="form-control 13" maxlength="14"
           OnKeyPress="formatar('##.###.###-###', this)" 
		   onkeyup="pula(14,this.id,orgao.id)">
    </td>
    <td class="secao">Orgão Expedidor:</td>
    <td>
    <input name="orgao" type="text" id="orgao" class="form-control 8"
           onChange="this.value=this.value.toUpperCase()"/>
    </td>
    <td class="secao">UF:</td>
    <td>
    <input name="uf_rg" type="text" id="uf_rg" class="form-control 2" maxlength="2" 
		   onKeyUp="pula(2,this.id,data_rg.id)"
           onChange="this.value=this.value.toUpperCase()"/></td>
    <td class="secao">Data Expedição:</td>
    <td>
    <input name="data_rg" type="text" class="form-control 12" maxlength="10" id="data_rg"
  ...
  <tr>
    ...
    <td>
    <input name="cpf" type="text" id="cpf" class="form-control 17" maxlength="14"
           onKeyPress="formatar('###.###.###-##', this)"  
		   onkeyup="pula(14,this.id,reservista.id)"/>
    </td>
    <td class="secao">Carteira do Conselho:</td>
    <td colspan="3">
      <input name="conselho" type="text" id="conselho" class="form-control 13" />
    </td>
     <td class="secao">Data de Emissão:</td>
    <td>
    <input name="data_emissao" type="text" class="form-control 12" maxlength="10" id="data_emissao"
  ...
  <tr>
    ...
    <td>
      <input name="trabalho" type="text" id="trabalho" class="form-control 15" />
    </td>
    <td class="secao">Série:</td>
    <td>
     <input name="serie_ctps" type="text" id="serie_ctps" class="form-control 10" />  
	</td>
    <td class="secao">UF:</td>
    <td>
	<input name="uf_ctps" type="text" id="uf_ctps" class="form-control 2" maxlength="2"  
		   onKeyUp="pula(2,this.id,data_ctps.id)"
           onChange="this.value=this.value.toUpperCase()"/></td>
    <td class="secao">Data carteira de Trabalho:</td>
    <td>
      <input name="data_ctps" type="text" class="form-control 12" maxlength="10" id="data_ctps"
  ...
  <tr>
    ...
    <td>
       <input name="titulo" type="text" id="titulo2" class="form-control 10" />
    </td>
    <td class="secao">Zona:</td>
    <td colspan="3">
        <input name="zona" type="text" id="zona2" class="form-control 3" />
    </td>
    <td class="secao">Seção:</td>
    <td>
        <input name="secao" type="text" id="secao" class="form-control 3" />
    </td>
  </tr>
  <tr>
    <td class="secao">PIS:</td>
    <td>
        <input name="pis" type="text" id="pis" class="form-control 12" maxlength="11"
               onkeyup="pula(11,this.id,data_pis.id)"/>
    </td>
    <td class="secao">Data Pis:</td>
    <td colspan="3">
      <input name="data_pis" type="text" class="form-control 12" maxlength="10" id="data_pis"
		     onkeyup="mascara_data(this); pula(10,this.id,fgts.id)" />
	</td>
    <td class="secao">FGTS:</td>
    <td>
        <input name="fgts" type="text" id="fgts" class="form-control 10" />
    </td>
  </tr>
    <tr>
     <td class="secao">Certificado de Reservista:</td>
    <td colspan="7">
      <input name="reservista" type="text" id="reservista" class="form-control 18" />
    </td>
    </tr>
  <tr>
  ...
  <tr style="display:none" id="divInss">
    ...
    <td colspan="7">
      <input name="p_inss" type="text" id="p_inss" class="form-control 3" /> % 
      <input name="inss_recolher" type="hidden" id="inss_recolher" value="11" class="form-control 3">
    </td>
  </tr>
</table>
<table cellpadding="0" cellspacing="1" class="secao" style="display:none">
  ...
  <tr>
    ...
    <td>
	<select class="form-control" name="plano_medico" id="plano_medico">
  ...
  <tr>
    ...
    <td>
      <select class="form-control" name="apolice" id="apolice">
    ...
    <td>
      <input name='dependente' type='text' id='dependente' class='form-control 20' value=''
             onChange="this.value=this.value.toUpperCase()"/>
    </td>
  </tr>
  <tr>
...
<table cellpadding="0" cellspacing="1" class="secao">
  ...
  <tr>
    ...
    <td colspan="3">
      <input name='e_nome' type='text' id='e_nome' class='form-control 50' 
             onChange="this.value=this.value.toUpperCase()"/>
    </td>
    <td width='10%' class="secao">CNPJ:</td>
    <td width='22%'>
      <input name='e_cnpj' type='text' id='e_cnpj' class="form-control 19" maxlength='18'
             OnKeyPress="formatar('##.###.###/####-##', this)"
  ...
  <tr>
    ...
    <td width='24%'>
      <input name='e_endereco' type='text' id='e_endereco' 
             onChange="this.value=this.value.toUpperCase()" class='form-control 35'/>
    </td>
    <td width='11%' class="secao">Bairro:</td>
    <td width='20%'>
      <input name='e_bairro' type='text' id='e_bairro' class='form-control 20'
             onChange="this.value=this.value.toUpperCase()" />
    </td>
    <td class="secao">Cidade:</td>
    <td> 
      <input name='e_cidade' type='text' id='e_cidade' 
             onChange="this.value=this.value.toUpperCase()" class='form-control 20'/>
    </td>
  </tr>
  <tr>
    <td class="secao">Estado:</td>
    <td>
      <input name='e_estado' type='text' id='e_estado' class='form-control 2' maxlength='2' 
             onChange="this.value=this.value.toUpperCase()"
             onKeyUp="pula(2,this.id,e_cep.id)" />
    </td>
    <td class="secao">CEP:</td>
    <td>
      <input name='e_cep' type='text' id='e_cep' class='form-control 10' maxlength='9' 
    ...
    <td>
      <input name='e_ramo' type='text' id='e_ramo' class='form-control 20'
             onChange="this.value=this.value.toUpperCase()" />
    </td>
  </tr>
  <tr>
    ...
    <td>
      <input name='e_telefone' type='text' id='e_telefone' class='form-control 14' 
             onKeyPress="return(TelefoneFormat(this,event))" 
             onKeyUp="pula(13,this.id,e_ramal.id)" />
    </td>
    <td class="secao">Ramal:</td>
    <td>
      <input name='e_ramal' type='text' id='e_ramal' class='form-control 14'>
    </td>
    <td class="secao">Fax:</td>
    <td> 
      <input name='e_fax' type='text' id='e_fax' class='form-control 14' 
             onKeyPress="return(TelefoneFormat(this,event))" 
  ...
  <tr>
    <td class="secao">E-mail:</td>
    <td>
      <input name='e_email' type='text' id='e_email' class='form-control 30' 
             style="text-transform:lowercase">
    </td>
    <td class="secao">Tempo de Servi&ccedil;o:</td>
    <td>
      <input name='e_tempo' type='text' id='e_tempo' class='form-control 14' 
             onChange="this.value=this.value.toUpperCase()">
    </td>
    <td class="secao">Profiss&atilde;o:</td>
    <td>
      <input name='e_profissao' type='text' id='e_profissao' class='form-control 14' 
             onChange="this.value=this.value.toUpperCase()">
    </td>
  </tr>
  <tr>
    ...
    <td>
      <input name='e_cargo' type='text' id='e_cargo' class='form-control 20' 
             onChange="this.value=this.value.toUpperCase()">
    </td>
    <td class="secao">Data Emiss&atilde;o:</td>
    <td>
      <input name='e_dataemissao' type='text' class='form-control 12' maxlength='10' id='e_dataemissao'
		     onkeyup="mascara_data(this); pula(10,this.id,e_referencia.id)" />
    </td>
    <td class="secao">Refer&ecirc;ncia:</td>
    <td>
        <input name='e_referencia' type='text' id='e_referencia' class="form-control" />
    </td>
  </tr>
  <tr>
    <td class="secao">Renda:</td>
    <td colspan="5">
      <input name='e_renda' type='text' id='e_renda' class="form-control 15"
             onChange="this.value=this.value.toUpperCase()" 
...
<table cellpadding="0" cellspacing="1" class="secao">
  ...
  <tr>
    ...
    <td colspan="5">
      <input name='r_nome' type='text' id='r_nome' class='form-control 50' 
             onChange="this.value=this.value.toUpperCase()"/>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      <input name='r_estado' type='text' id='r_estado' 
             onKeyUp="pula(2,this.id,e_cep.id)"
             onChange="this.value=this.value.toUpperCase()" class='form-control 2'/>
    </td>
    <td class="secao">CEP:</td>
    <td>
      <input name='r_cep' type='text' id='r_cep' class='form-control 10' maxlength='9' 
             style='text-transform:uppercase;'
             OnKeyPress="formatar('#####-###', this)" 
    ...
    <td class="secao">E-mail:</td>
    <td>
      <input name='r_email' type='text' id='r_email' class="form-control 30"
             style="text-transform:lowercase" />
    </td>
    </tr>
  <tr>
    <td class="secao">Telefone:</td>
    <td>
      <input name='r_telefone' type='text' id='r_telefone' class='form-control 14' 
             onKeyPress="return(TelefoneFormat(this,event))" 
             onKeyUp="pula(13,this.id,r_ramal.id)" />
      </td>
    <td class="secao">Ramal:</td>
    <td>
      <input name='r_ramal' type='text' id='r_ramal' class='form-control 14' />
      </td>
    <td class="secao">Fax:</td>
    <td>
      <input name='r_fax' type='text' id='r_fax' class='form-control 14' 
             onKeyPress="return(TelefoneFormat(this,event))" 
...
<table cellpadding="0" cellspacing="1" class="secao">
  ...
  <tr>
    ...
    <td width="30%">
      <input name="agencia" type="text" id="agencia" class="form-control 12" />
    </td>
  </tr>
  <tr>
    <td class="secao">Conta:</td>
    <td>
      <input name="conta" type="text" id="conta" class="form-control 12" /><br />
    ...
    <td>
       <input name="nomebanco" type="text" id="nomebanco" class="form-control 25" 
              onChange="this.value=this.value.toUpperCase()"/>
    </td>
  </tr>
</table>
<table cellpadding="0" cellspacing="1" class="secao">
  ...
  <tr>
    ...
    <td>
        <input name='data_entrada' type='text' class='form-control 12' maxlength='10' id='data_entrada'
               onkeyup="mascara_data(this); pula(10,this.id,data_exame.id)" />
    </td>
	<td class="secao">Data do Exame Admissional:</td>
	<td>
        <input name='data_exame' type='text' class='form-control 12' maxlength='10' id='data_exame'
  ...
  <tr>
	...
	<td width='77%' colspan='3'>
        <input name='localpagamento' type='text' id='localpagamento' class='form-control 25'  
               onChange="this.value=this.value.toUpperCase()"/>
     </td>
   </tr>
   <tr>
     ...
     <td colspan='3'>
        <select class="form-control" name='tipopg' id='tipopg'>
  ...
  <tr>
    ...
    <td>
      <input name='cota' type='text' id='cota' class='form-control 18' 
             OnKeyDown="FormataValor(this,event,17,2)"
             onChange="this.value=this.value.toUpperCase()"/>
    </td>
    <td class="secao">Parcelas:</td>
    <td>
      <input name='parcelas' type='text' id='parcelas' class='form-control 15'  
	         onChange="this.value=this.value.toUpperCase()"/>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
	<input name="hora_retirada" type="text" id="hora_retirada" class="form-control 13" maxlength="8" value="<?php echo $Row['hora_retirada'] ?>"
           OnKeyPress="formatar('##:##:##', this)" />
    </td>
    <td class="secao">Hora Almoço:</td>
    <td>
	<input name="hora_almoco" type="text" id="hora_almoco" class="form-control 13" maxlength="8" value="<?php echo $Row['hora_almoco'] ?>"
           OnKeyPress="formatar('##:##:##', this)" />
    </td>
    <td class="secao">Hora Retorno</td>
    <td>
	<input name="hora_retorno" type="text" id="hora_retorno" class="form-control 13" maxlength="8" value="<?php echo $Row['hora_retorno'] ?>"
           OnKeyPress="formatar('##:##:##', this)" />
    </td>
    <td class="secao">Hora Saída:</td>
    <td>
	<input name="hora_saida" type="text" id="hora_saida" class="form-control 13" maxlength="8" value="<?php echo $Row['hora_saida'] ?>"
           OnKeyPress="formatar('##:##:##', this)" />
    </td>
  </tr>
  </table>
...
r_estado,r_cep,r_tel,r_ramal ,r_fax,r_email,rh_vinculo,rh_status,rh_horario,rh_sindicato,rh_cbo,cota,parcelas, contrato_medico,matricula, n_processo, email, data_emissao, tipo_sanguineo, id_estado_civil,hora_retirada, hora_almoco,hora_retorno,hora_saida) 
VALUES
...
'$r_ramal','$r_fax','$r_email','$rh_vinculo','$rh_status','$rh_horario','$rh_sindicato','$rh_cbo','$cota','$parcelas','$contrato_medico', '$matricula', '$n_processo', '$email', '$data_emissao', '$tipo_sanguineo', '$estCivilId','$hora_retirada','$hora_almoco','$hora_retorno','$hora_saida')") or die ("Ops! Erro<br>" . mysql_error());
