...
$breadcrumb_pages = array("Gestão de RH" => "../", "Empresas" => "index.php");
        ...
        <div class="container">
            ...
            <form id="form1" class="form-horizontal">
                ...
                <div class="note text-right">
                    ...
                    <?php if($_COOKIE['logado'] != 395) { ?><input type="submit" class="btn btn-primary" value="Editar" name="editarEmpresa" id="editarEmpresa" data-type="editar" data-key="<?=$row['id_empresa']?>" /><?php } ?>
