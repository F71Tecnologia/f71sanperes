...
$breadcrumb_config = array("nivel"=>"../intranet", "key_btn"=>"3", "area"=>"Recursos Humanos", "id_form"=>"form1", "ativo"=>"Carteiras de Trabalho Entregues");
$breadcrumb_pages = array("Carteiras de Trabalho"=>"ctps.php"); 
?>
...
<html>
    <head>
        ...
        <title>:: Intranet :: Carteiras de Trabalho Entregues</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - RECURSOS HUMANOS <small> - Carteiras de Trabalho Entregues</small></h2></div>
                </div><!-- /.col-lg-12 -->
            </div><!-- /.row -->
            <div class="row">
