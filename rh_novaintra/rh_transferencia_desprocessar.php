...
$breadcrumb_pages = array("Lista Transferências"=>"lista_desprocessar_transf.php");
?>
<!DOCTYPE html>
<html>
    <head>
                    ...
                    <?php if ($tela == 1) { ?>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-footer text-right">
                                ...
                                <button type="submit" class="btn btn-danger" value="Desprocessar" name="desprocessar" id="desprocessar"><span class="fa fa-ban"></span>&nbsp;&nbsp;Desprocessar</button>
                            </div>
                        </div>
                    <?php } else { ?>
