...
$breadcrumb_pages = array("Gestão de RH"=>"../", "Seguro Desemprego"=>"index.php");
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - RECURSOS HUMANOS <small> - Formulário Seguro Desemprego</small></h2></div>
                </div><!-- /.col-lg-12 -->
            </div><!-- /.row -->
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="nome" class="col-xs-2 control-label no-padding-hr">Nome:</label>
                            <div class="col-lg-4">
                                <input type="text" value="<?=normaliza_nome($funcionario['nome'],40)?>" name="nome" id="nome" maxlength="40" class="form-control" />
                            </div>
                            <label for="mae" class="col-xs-2 control-label no-padding-hr">Nome da Mãe:</label>
                            <div class="col-lg-4">
                                <input type="text" value="<?=normaliza_nome($funcionario['nome_mae'],40)?>" name="mae" id="mae" maxlength="40" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="endereco" class="col-xs-2 control-label no-padding-hr">Endereço:</label>
                            <div class="col-lg-4">
                            ...
                            <label for="complemento" class="col-xs-2 control-label no-padding-hr">Complemento:</label>
                            <div class="col-lg-4">
                        ...
                        <div class="form-group">
                            <label for="cep" class="col-xs-2 control-label no-padding-hr">Cep:</label>
                            <div class="col-lg-4">
                                <input type="text" value="<?=$funcionario['cep']?>" name="cep" id="cep" maxlength="8" class="form-control" />
                            </div>
                            <label for="uf" class="col-xs-2 control-label no-padding-hr">UF:</label>
                            <div class="col-lg-4">
                                <input type="text" value="<?=normaliza_nome($funcionario['uf'],2)?>" name="uf" id="uf" maxlength="2" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="tel" class="col-xs-2 control-label no-padding-hr">TEL:</label>
                            <div class="col-lg-4">
                                <input type="text" value="<?=normaliza_nome($funcionario['tel_fixo'],10)?>" name="tel" id="tel" maxlength="10" class="form-control" />
                            </div>
                            <label for="pis" class="col-xs-2 control-label no-padding-hr">TEL:</label>
                            <div class="col-lg-4">
                                <input type="text" value="<?=normaliza_nome($funcionario['pis'],11)?>" name="pis" id="pis" maxlength="11" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="pis" class="col-xs-2 control-label no-padding-hr">PIS:</label>
                            <div class="col-lg-4">
                                <input type="text" value="<?=normaliza_nome($funcionario['pis'],11)?>" name="pis" id="pis" maxlength="11" class="form-control" />
                            </div>
                            <label for="ctps_numero" class="col-xs-2 control-label no-padding-hr">NÚMERO CTPS:</label>
                            <div class="col-lg-4">
                        ...
                        <div class="form-group">
                            <label for="grau_instrucao" class="col-xs-2 control-label no-padding-hr">GRAU INSTRUÇAO:</label>
                            <div class="col-lg-4">
                            ...
                            <label for="data_nascimento" class="col-xs-2 control-label no-padding-hr">DATA NASCIMENTO:</label>
                            <div class="col-lg-4">
                                <div class="input-group">
                        ...
                        <div class="form-group">
                            <label for="hora_semana" class="col-xs-2 control-label no-padding-hr">HORA SEMANA:</label>
                            <div class="col-lg-4">
                                <input type="text" value="<?=$funcionario['hora_semana']?>" name="hora_semana" id="hora_semana" maxlength="2" class="form-control" />
                            </div>
                            <label for="banco" class="col-xs-2 control-label no-padding-hr">BANCO:</label>
                            <div class="col-lg-4">
                                <?php echo montaSelect($arr_banco, '104', array('name' => "banco", 'id' => "banco", 'class'=>'form-control')); ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="antepenultimo_mes" class="col-xs-2 control-label no-padding-hr text-sm">ANTEPENÚLTIMO SALÁRIO:</label>
                            <div class="col-lg-4">
                                <div class="input-group">
                            ...
                            <label for="penultimo_mes" class="col-xs-2 control-label no-padding-hr">PENÚLTIMO SALÁRIO:</label>
                            <div class="col-lg-4">
                                <div class="input-group">
                        ...
                        <div class="form-group">
                            <label for="ultimo_mes" class="col-xs-2 control-label no-padding-hr">ÚLTIMO SALÁRIO:</label>
                            <div class="col-lg-4">
                                <div class="input-group">
                            ...
                            <label for="recebeu_ultimos_meses" class="col-xs-2 control-label no-padding-hr text-sm">RECEBEU ÚLTIMOS 6 MÊSES:</label>
                            <div class="col-lg-4">
                        ...
                        <div class="form-group">
                            <label for="aviso_indenizado" class="col-xs-2 control-label no-padding-hr">AVISO INDENIZADO:</label>
                            <div class="col-lg-10">
