...
$breadcrumb_pages = array("Gestão de RH"=>"../", "Contracheque"=>"../contracheque/");
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <title>:: Intranet :: Contracheque Todos</title>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header box-rh-header"><h2><span class="fa fa-users"></span> - RECURSOS HUMANOS<small> - Contracheque Todos</small></h2></div>
