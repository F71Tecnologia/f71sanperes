...
//    }
    ...
    ///////////////////////////////////////
    //adicionado ir de ferias(5036) no array
            ...
            switch ($row_mov['cod']) {
                ...
                default :
                    ...
                    if ($categoria == 'CREDITO') {
                        ...
                        //if($_COOKIE[logado] == 257){echo $row_mov['cod'].' & '.$row_mov['descicao'].' * '.$desconto.' % '.$categoria.'<br>'.$total_desconto.'<br>';}
                        
                    }
                    
//                    if($_COOKIE['logado'] == 158){
//                        //ESTAVA ENTRANDO EVENTO DE AJUSTE SALDO DEVEDOR 0,00 PARA TODOS OS CLTS
//                        //ASICIONEI A VALIDAÇÃO $valor_movimento != 0
    ...
    if (!empty($RowFolhaPro['ids_movimentos'])) {
        ...
        if (mysql_num_rows($qr_movimento_clt) != 0) {
            ...
            while ($row_mov2 = mysql_fetch_assoc($qr_movimento_clt)):
                ...
                if ( ($row_mov2['tipo_movimento'] == 'DEBITO' or $row_mov2['tipo_movimento'] == 'DESCONTO' or ($row_mov2['tipo_movimento'] == 'CREDITO' AND $RowFolha[terceiro] != 1))) {
...
//                }
    ...
    if (sprintf('%02s', $num_mes + 1) == $row_clt['mes_nasci'] || ($num_mes == 12 && $row_clt['mes_nasci'] == 1)) {
        ...
        ($num_mes + 1 == 8 && $row_clt['sexo'] == 'M' && !empty($row_clt['num_filhos'])) {
            $saudacao = "A EMPRESA $row_master[nome] DESEJA-LHE UM FELIZ ANIVERSÁRIO E FELIZ DIA DOS PAIS!";
        } elseif
        ////////////////////////////////// NATAL ///////////////////////////////
