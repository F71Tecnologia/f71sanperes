...
$rh = $rh->addClassChildren('Projetos');
...
$breadcrumb_attr = array(
    "Visualizar Projeto" => "class='link-sem-get' data-projeto='$projeto' data-form='form1' data-url='ver.php'",
    "Lista Participantes" => "class='link-sem-get' data-projeto='$projeto' data-form='form1' data-url='bolsista.php'",
    "Visualizar Participante" => "class='link-sem-get' data-pro='$projeto' data-clt='$id_clt' data-form='form1' data-url='ver_clt.php'"
); ?>
