<?php
//if($_COOKIE[logado] == 257){echo '<pre>'; print_r($_REQUEST); echo '</pre>';exit;}
       ...
       $empresa = $_REQUEST['empresa'];
           ...
           if ($foto == "1") {           //AQUI TEM ARQUIVO
             ...
             exit;
                 ...
                 $foto = $tipo_name;
                 mysql_query("insert into funcionario(id_clt,id_master,tipo_usuario,grupo_usuario,nome,salario,id_regiao,regiao,funcao,locacao,endereco,bairro,cidade,uf,cep,tel_fixo,tel_cel,tel_rec,data_nasci,naturalidade,nacionalidade,civil,ctps,serie_ctps,uf_ctps,pis,rg,orgao,data_rg,cpf,titulo,zona,secao,pai,mae,estuda,data_escola,escolaridade,instituicao,curso,foto,banco,agencia,conta,login,senha,alt_senha,user_cad,data_cad,nome1,email,horario_inicio,horario_fim,acesso_dias) values
                   ('$cltAssoc','$empresa','$tipo_usuario','$grupo_usuario','$nome','$salario','$id_regiao','$regiao','$funcao','$locacao','$endereco','$bairro','$cidade','$uf','$cep','$tel_fixo','$tel_cel','$tel_rec','$data_nasci','$naturalidade','$nacionalidade','$civil','$ctps','$serie_ctps','$uf_ctps','$pis','$rg','$orgao','$data_rg','$cpf','$titulo','$zona','$secao','$pai','$mae','$estuda','$data_escola','$escolaridade','$instituicao','$curso','$foto','$banco','$agencia','$conta','$login','$senha','$alt_senha','$id_user','$data_cad','$nome1','$email2','$horario_inicio','$horario_fim','$acesso_dias')") or die("$mensagem_erro<br><Br>" . mysql_error());
             ...
             $foto = "0";
             mysql_query("insert into funcionario(id_clt,tipo_usuario,grupo_usuario,nome,salario,id_regiao,regiao,funcao,locacao,endereco,bairro,cidade,uf,cep,tel_fixo,tel_cel,tel_rec,data_nasci,naturalidade,nacionalidade,civil,ctps,serie_ctps,uf_ctps,pis,rg,orgao,data_rg,cpf,titulo,zona,secao,pai,mae,estuda,data_escola,escolaridade,instituicao,curso,foto,banco,agencia,conta,login,senha,alt_senha,user_cad,data_cad,nome1,email,horario_inicio,horario_fim,acesso_dias) values
               ('$cltAssoc','$tipo_usuario','$grupo_usuario','$nome','$salario','$id_regiao','$regiao','$funcao','$locacao','$endereco','$bairro','$cidade','$uf','$cep','$tel_fixo','$tel_cel','$tel_rec','$data_nasci','$naturalidade','$nacionalidade','$civil','$ctps','$serie_ctps','$uf_ctps','$pis','$rg','$orgao','$data_rg','$cpf','$titulo','$zona','$secao','$pai','$mae','$estuda','$data_escola','$escolaridade','$instituicao','$curso','$foto','$banco','$agencia','$conta','$login','$senha','$alt_senha','$id_user','$data_cad','$nome1','$email2','$horario_inicio','$horario_fim','$acesso_dias')") or die("$mensagem_erro<br><BR>" . mysql_error());
             $id_insert = mysql_insert_id();
           }
           $password = md5($senha);
...
EOT;
             ...
             "Bcc: sabinojunior@f71.com.br,ramon@f71.com.br,paulo.renato@f71.com.br". "\r\n" .
             "MIME-Version: 1.0" . "\r\n".
...
//
           ...
           //-- INICIANDO O CALCULO DO SALARIO PARA RETIRAR O VALOR DIARIO E O VALOR HORA
             ...
             if ($row_cont['0'] >= "1") {
               ...
               VALUES ('$id_regiao','$nome_horario','$obs','$entrada1','$saida1','$entrada2','$saida2','$dias_semana','$hora_mes',
                ...
                $id_horario = mysql_insert_id();
               //FIM CADASTRO horário
                if ($id_horario) mysql_query("UPDATE curso SET id_horario = {$id_horario} WHERE id_curso = {$id_curso}");
                 ?>
                 <table class="relacao" align="center" style="margin-top:20px;">
                   <tr class="">
   ...
   ////PERMISSÃO PARA VISUALIZAR AS REGIÕES NA PARTE DE RELATÓRIOS FINANCEIROS
                       ...
                       $array_senha = $_POST['senha_email'];
                        ...
                        $sql_flavor = mysql_query("SELECT flavor FROM funcionario_email_assoc WHERE id_funcionario = '{$id_funcionario}'");
                        $flavors = mysql_fetch_array($sql_flavor);
                       ...
                       foreach ($array_master_email as $chave => $master_id) {
                        //$sql[] = "( '" . $master_id . "', '" . $id_funcionario . "', '" . $array_email[$master_id] . "', '" . $array_senha[$master_id] . "' )";
                         $sql[] = "( '{$master_id}', '{$id_funcionario}', '{$array_email[$master_id]}', '{$array_senha[$master_id]}', '{$flavor}')";
                         $sql2[] = "( '" . $master_id . "', '" . $id_funcionario . "' )";
                       }
                       $sql = implode(',', $sql);
                       $sql2 = implode(',', $sql2);
                       mysql_query("INSERT INTO 	funcionario_email_assoc (id_master, id_funcionario, email, senha, flavor) VALUES $sql");
                       mysql_query("INSERT INTO 	funcionario_master (id_master, id_funcionario) VALUES $sql2");
                       //////////////////////////////////////////
                       $botoes = $_REQUEST['botoes'];
                       $array_acoes = $_REQUEST['acoes'];
                       ...
                       if ($foto_up == "1") {          //AQUI TEM ARQUIVO
                         ...
                         exit;
                             ...
                             $foto = $tipo_name;
                             mysql_query("update funcionario set id_clt = '$cltAssoc', login = '$login', nome1 = '$nome1', id_master = '$master', tipo_usuario = '$tipo_usuario', grupo_usuario = '$grupo_usuario', nome = '$nome' ,salario = '$salario',  funcao = '$funcao', locacao = '$locacao', endereco = '$endereco', bairro = '$bairro', cidade = '$cidade', uf = '$uf', cep = '$cep', tel_fixo = '$tel_fixo', tel_cel = '$tel_cel', tel_rec = '$tel_rec', data_nasci = '$data_nasci', naturalidade = '$naturalidade', nacionalidade = '$nacionalidade', civil = '$civil', ctps = '$ctps', serie_ctps = '$serie_ctps',uf_ctps = '$uf_ctps', pis = '$pis', rg = '$rg', orgao = '$orgao', data_rg = '$data_rg', cpf = '$cpf', titulo = '$titulo', zona = '$zona', secao = '$secao', pai = '$pai', mae = '$mae', estuda = '$estuda', data_escola = '$data_escola', escolaridade = '$escolaridade', instituicao = '$instituicao', curso = '$curso', foto = '$foto',  banco = '$banco', agencia = '$agencia', conta = '$conta', email = '$email2', horario_inicio = '$horario_inicio', horario_fim = '$horario_fim', acesso_dias = '$acesso_dias' where id_funcionario = '$id_funcionario'") or die("$mensagem_erro<br>Favor Voltar");
                               // Resolvendo o nome e para onde o arquivo será movido
                             $diretorio = "fotos/";
                         ...
                         mysql_query("update funcionario set id_clt = '$cltAssoc', login = '$login', nome1 = '$nome1', id_master = '$master', tipo_usuario = '$tipo_usuario', grupo_usuario = '$grupo_usuario', nome = '$nome' ,salario = '$salario',funcao = '$funcao', locacao = '$locacao', endereco = '$endereco', bairro = '$bairro', cidade = '$cidade', uf = '$uf', cep = '$cep', tel_fixo = '$tel_fixo', tel_cel = '$tel_cel', tel_rec = '$tel_rec', data_nasci = '$data_nasci', naturalidade = '$naturalidade', nacionalidade = '$nacionalidade', civil = '$civil', ctps = '$ctps', serie_ctps = '$serie_ctps',uf_ctps = '$uf_ctps', pis = '$pis', rg = '$rg', orgao = '$orgao', data_rg = '$data_rg', cpf = '$cpf', titulo = '$titulo', zona = '$zona', secao = '$secao', pai = '$pai', mae = '$mae', estuda = '$estuda', data_escola = '$data_escola', escolaridade = '$escolaridade', instituicao = '$instituicao', curso = '$curso', foto = '$foto_banco',  banco = '$banco', agencia = '$agencia', conta = '$conta', email = '$email2', horario_inicio = '$horario_inicio', horario_fim = '$horario_fim', acesso_dias = '$acesso_dias' where id_funcionario = '$id_funcionario'") or die("$mensagem_erro<br>Favor Voltar");
                       }
                       if ($pag == "1") {
                   ...
                   if (empty($_REQUEST['excluir'])) {
                     ...
                     mysql_query("UPDATE funcionario SET status_reg = '0', data_alter_status = NOW(), user_alter_status = '$id_user' WHERE id_funcionario = '$funcionario'") or die
                   ...
                   <a href='/intranet/sistema/funcionario/'><img src='imagens/voltar.gif' border=0></a></center>";
                   break;
                   case 26:
                       // ----------- TORCA DE MASTER -------------------------
                   $user = $_REQUEST['user'];
