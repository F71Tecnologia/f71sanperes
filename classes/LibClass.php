 ...
 * 29/02/2016
 * 
 * Classe de com biblioteca de automatização do framework
 * 
 * Versão: 3.00.7788 - 29/02/2016 - Jacques - Versão Inicial
 * 
 * @Jacques
 */
...
class LibClass {
     ...
     * @name setDefault
     * 
     * @internal - Define um valor de retorno caso a referência ao objeto seja feita em um procedimento de retorno de valor
     */    
     ...
     * @name setDefault
     * 
     * @internal - Define um valor padrão de início de valor para as propriedades do objeto
     */    
     ...
     * 
     * @internal - Retorna a montagem de um option range de acordo com os parámetros que pode ser um vetor 
     *             com segundo parámetro de string definindo o índice dos vetores para atribuição de valor,
