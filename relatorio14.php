...
$result_bolsista = mysql_query("SELECT *,date_format(data_saida, '%d/%m/%Y') as data_saida, date_format(data_entrada, '%d/%m/%Y') as data_entrada FROM autonomo where tipo_contratacao ='1' and status = '1' AND id_projeto ='$projeto' ORDER BY year(data_entrada),month(data_entrada),day(data_entrada) asc");
$num_row = mysql_num_rows($result_bolsista);

$result_clt = mysql_query("SELECT *,date_format(data_saida, '%d/%m/%Y') as data_saida, date_format(data_entrada, '%d/%m/%Y') as data_entrada FROM rh_clt where tipo_contratacao ='2' AND id_projeto ='$projeto' ORDER BY year(data_entrada),month(data_entrada),day(data_entrada) asc");
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="bordaescura1px">
  ...
  <tr> 
    ...
    <td colspan="3"><div align="center">
        ...
        <p><strong><br>
          ...
          RELAT&Oacute;RIO DE PARTICIPANTES DO PROJETO POR DATA<br>
  ...
  <td background='layout/fundo_tab_azul.gif' align=center>Data de Entrada</td>

  <td background='layout/fundo_tab_azul.gif' align=center>Data Saída</td>
...
<TD><font face='Arial, Helvetica, sans-serif' size='-2'>$row_bolsista[data_entrada]</font></td>
...
<TD><font face='Arial, Helvetica, sans-serif' size='-2'>$row_clt[data_entrada]</font></td>
...
<TD><font face='Arial, Helvetica, sans-serif' size='-2'>$row_cooperado[data_entrada]</font></TD>
