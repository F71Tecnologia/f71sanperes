...
$id_permitidos = array(5, 9, 24, 87, 204, 255);
...
//                    extract($row_tipo);
                    ...
                    if ($_REQUEST['status'] == 2) {
                        $qr_oscip = mysql_query("SELECT *
                                            FROM obrigacoes_oscip AS A
                                            WHERE status='1'  AND tipo_oscip='{$row_tipo['tipo_nome']}' AND id_master='$Master' AND 
                                            (
                                        ...
                                        <td>
                                            ...
                                            while ($row_regiao = mysql_fetch_assoc($qr_regiao)):
                                                ...
                                                while ($row_projeto = mysql_fetch_assoc($qr_projeto)):
                                                    ...
                                                    $mostra_oscip = mysql_query("SELECT * FROM obrigacoes_oscip WHERE  status='1'  AND tipo_oscip='{$row_tipo['tipo_nome']}' AND id_master='$Master'  AND id_projeto='{$row_projeto['id_projeto']}' ORDER BY data_publicacao DESC")or die("Erro no comando sql");
                            ...
                            <table cellspacing="1" cellpadding="4" class="relacao" width="100%" style="display:none;">
                                <tr class="secao">
                                    ...
                                    if ($row_tipo['tipo_nome'] == 'Ofícios Enviados' OR $row_tipo['tipo_nome'] == 'Ofícios Recebidos'){ ?>
                                       <?php echo ' <td align="center">Cod</td>';
                                    }
                                    ?>
                                    <td align="center">Documento </td>  
                                    <td align="center">Editar</td>
...
//                                    if ($_COOKIE['logado'] == 255) {
                                        ...
                                        echo ' <td align="center">Renovar</td>';
//                                    }
                                    ?>
                                ...
                                while ($row_oscip = mysql_fetch_assoc($qr_oscip)):                                    
                                    ...
                                    ?>>                     
                                            <?php
                                            if ($row_tipo['tipo_nome'] == 'Ofícios Enviados' OR $row_tipo['tipo_nome'] == 'Ofícios Recebidos') {
                                                $dataPublicacao = explode('-', $row_oscip['data_publicacao']);
                                                $anoPublicacao = $dataPublicacao[0];
//                                                if($anoPublicacao != $novoAnoPublicacao){?>                                               
                                                    
                                                <!--<span style="text-transform:uppercase"><?php echo $anoPublicacao; ?> </span>-->
...
//                                                }
                                        ...
                                        <?php
                                        if (//$_COOKIE['logado'] == 255 && 
                                         $row_oscip['periodo'] != 'Indeterminado') {
                                            ?>
                                    ...
                                    $contador++;
                                endwhile;
                                $novoAnoPublicacao = $anoPublicacao;
                            }
                            ?>
