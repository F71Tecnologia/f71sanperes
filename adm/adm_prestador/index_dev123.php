...
if ((isset($_REQUEST['filtrar']) && !empty($_REQUEST['filtrar'])) || (isset($_SESSION['voltarPrestador']))) {
    ...
    $rs = montaQuery("prestadorservico", "*,DATE_FORMAT(contratado_em, '%d/%m/%Y') AS contratado_embr, DATE_FORMAT(encerrado_em, '%d/%m/%Y') AS encerrado_embr ", "id_regiao = {$_REQUEST['regiao']} AND id_projeto = {$_REQUEST['projeto']}", "c_razao", null, null, false);
        ...
        <div id="content">
            <form action="" method="post" name="form1" id="form1" enctype="multipart/form-data" >
                ...
                <fieldset>
                    ...
                    <p><label class="first">Região:</label> <?php echo montaSelect(GlobalClass::carregaRegioes(1), $regiaoR, "id='regiao' name='regiao' class='required[custom[select]]'") ?></p>
