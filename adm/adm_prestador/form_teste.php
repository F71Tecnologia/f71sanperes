...
<html>
    <head>
        ...
        <script>
            $(function() {
                ...
                $("#cad").click(function(){
                    ...
                    if(($("#c_site").val() != '')){
                        $("#c_site").addClass("validate[custom[url]]");
                    }
        ...
        <style>
            ...
            .contratante, .contratada, .socios, .dados_projeto{
                display: none;
            }
        </style>
    </head>
    <body class="novaintra">
        <div id="content" style="width: 850px;">
            <form action="" method="post" name="form1" id="form1" enctype="multipart/form-data" >
                ...
                <div id='message-box' class='message-red dados_projeto'></div>
                <fieldset>
                    ...
                    <div class="colEsq" style="margin-top:0;">
                        ...
                        <p><label class="first">Projeto:</label> <?php echo montaSelect(array("-1"=>"« Selecione a Região »"), $projetoSel, "id='projeto' name='projeto' class='validate[custom[select]]'") ?></p>
                    </div>
                    <?php }else{ ?>
                ...
                <fieldset>
                    ...
                    <input type="hidden" name="contratante" value="<?php echo $prestador['contratante']?>" />
                    <p><label class='first'>Contratante:</label><input type="text" disabled="disabled" name="contratante_fake" value="<?php echo $prestador['contratante']?>" /></p>
                    <p><label class='first'>Endereço:</label><input type="text" name="endereco" id="endereco" value="<?php echo $prestador['endereco']?>" size="108" /></p>
                    <div class="colEsq">
                    ...
                    <div class="colDir">
                        ...
                        <p><label class='first'>Formação:</label><input type="text" name="formacao" id="formacao" value="<?php echo $prestador['formacao']?>" size="30" /></p>
                ...
                <fieldset>
                    ...
                    <input type="hidden" name="contratante" value="<?php echo $row_contratante['razao']; ?>" />
                    
                    <p><label class='first'>Contratante:</label><input type="text" disabled="disabled" name="contratante_fake" id="contratante" value="<?php echo $row_contratante['razao']?>" size="108" class="validate[required]" /></p>
                    <p><label class='first'>Endereço:</label><input type="text" name="endereco" id="endereco" value="<?php echo $row_contratante['endereco']?>" size="108" /></p>
                    <div class="colEsq">
                    ...
                    <div class="colDir">
                        ...
                        <p><label class='first'>Formação:</label><input type="text" name="formacao" id="formacao" value="<?php echo $row_contratante['formacao']?>" size="30" /></p>
                ...
                <fieldset>
                    ...
                    <p><label class='first'>Agência:</label><input type="text" name="agencia" id="agencia" value="<?php echo $prestador['agencia']?>" size="30" /></p>
                ...
                <p class="controls">
                    <?php //Verifica se foi selecionado um prestador na tela anterior
                        ...
                        <?php //Verifica se o contrato já foi encerrado anteriormente
