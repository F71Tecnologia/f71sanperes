    ...
    <body class="novaintra">
        <div id="content" style="width: 850px;">
            <form action="" method="post" name="form1" id="form1" autocomplete="off">
                ...
                <label class='first alinha'>Tipo de Contrata��o:</label>                               
                <select name="contratacao" id="contratacao" class="validate[required]">
                    <option class="btn_cont1" value="1">Aut�nomo</option>
                ...
                <div class="form_funcoes">                                        
                    ...
                    <fieldset id="func1">
                        ...
                        <p>
                            <label class='first'>Nome da Fun��o:</label>
                            <input type="text" name="nome_funcao" id="nome_funcao" size="85" class="validate[required]" />
                        </p>
                        <p>
                            <label class='first'>�rea:</label>
                            <input type="text" name="area" id="area" size="117" class="validate[required]" />
                        </p>
                        <p>
                            <label class='first'>CBO:</label>
                            <input type="text" name="cbo" id="cbo" size="117" class="validate[required]" />
                        </p>
                        <p>
                            <label class='first'>Local:</label>
                            <input type="text" name="local" id="local" size="117" class="validate[required]" />
                        </p>
                        
                        <div id="esquerda">
                            <p>
                                <label class='first'>In�cio:</label>
                            ...
                            <p>
                                <label class='first'>Sal�rio:</label>
                            ...
                            <p>
                                <label class='first'>M�s Abono:</label>
                            ...
                            <p>
                                <label class='first'>Quantidade de Sal�rios:</label>
                        ...
                        <div id="direita"> 
                            ...
                            <p>
                                <label class='first'>Qtd. M�xima de Contrata��o:</label>
                        ...
                        <p>
                            <label class='first' style="vertical-align: top!important;">Descri��o:</label>
                    ...
                    <fieldset id="func2">
                        <legend>Dados do Hor�rio (CLT)</legend>
                        <p>
                            <label class='first'>Nome do Hor�rio:</label>
                            <input type="text" name="nome_horario" id="nome_horario" size="117" class="validate[required]" />
                        </p>
                        <p>
                            <label class='first'>Observa��es:</label>
                            <input type="text" name="obs" id="obs" size="117" />
                        </p>
                        <p>
                            ...
                            Sa�da Almo�o <input type="text" name="ida_almoco" id="ida_almoco" size="10" class="preenchimento validate[required]" />
                            Retorno Almo�o <input type="text" name="volta_almoco" id="volta_almoco" size="10" class="preenchimento validate[required]" />
                            Sa�da <input type="text" name="saida" id="saida" size="10" class="preenchimento validate[required]" />
                        </p>
                        ...
                        <div id="direita">
                            ...
                            <p>
                                ...
                                <input type="checkbox" name="folga1" value="1"> S�bado
