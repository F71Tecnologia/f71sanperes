        ...
        <script>
            $(function() {
                ...
                $("#cadastrar").click(function(){
                    ...
                    if(horas != ''){
                        $(".form_funcoes #horas").addClass("validate[custom[onlyNumber]]");
                    }
                });
                ...
                <div class="form_funcoes">                                        
                    ...
                    <fieldset id="func1">
                        ...
                        <p>
                            ...
                            <?php echo montaSelect(getProjetos($regiao_selecionada),null, "id='projeto' name='projeto' class='validate[required,custom[select]]'"); ?>
                        </p>
                        <p>
                            <label class='first'>Nome da Função:</label>
                            <input type="text" name="nome_funcao" id="nome_funcao" size="93" class="validate[required]" />
                        </p>
                        <p>
                            <label class='first'>Área:</label>
                            <input type="text" name="area" id="area" size="93" class="validate[required]" />
                        </p>
                        <p>
                            <label class='first'>Departamento:</label>
                            <?php echo montaSelect($arrayDepartamentos, $value, 'name="departamento" id="departamento" class="validate[required,custom[select]] departamento"'); ?>
                        </p>
                        <p>
                            <label class='first'>Nome do CBO:</label>
                            <input type="text" name="cbo" id="cbo" size="70" class="validate[required]" placeholder="Ex: Assistente administrativo  - 4110.10" />
                            <span id="selection"></span>
                        </p>
                        <p>
                            <label class='first'>Local:</label>
                            <input type="text" name="local" id="local" size="93" class="validate[required]" />
                        </p>
                        ...
                        <div id="direita">                                                                                    
                            ...
                            <p>
                                ...
                                <input type="text" name="horas" id="horas" size="30" maxlength="4" />
                            </p>
                            <p id="p_valor_hora" >
                                <label class='first'>Valor Hora:</label>
                                <input type="text" name="valor_hora_cooperado" id="valor_hora" class="money" />
                            </p>
                        </div>
                        ...
                        <div id="peric_insal">
                            ...
                            <p class="some_insa">
                                ...
                                <input type="text" name="qtd_salarios" id="qtd_salarios" size="30" maxlength="4" />
                            </p>                            
                        </div>
                    ...
                    <fieldset class="horario" data-position="0">
                        ...
                        <p>
                            ...
                            <input type="text" name="nome_horario[]" id="nome_horario" size="93" class="validate[required] limpa" />
                        </p>
                        <p>
                            <label class='first'>Observações:</label>
                            <input type="text" name="obs[]" id="obs" class="limpa" size="93" />
                        </p>
                        <p class="remove">
                        ...
                        <div id="direita">
                            <p>
                                ...
                                <input type="text" name="horas_semana[]" id="horas_semana" size="30" maxlength="4" class="validate[required,custom[onlyNumber]] limpa" />
                            </p>
                            <p>
                        ...
                        <p>
                            ...
                            <input type="radio" name="noturno[]" value="1" id="n_sim" class="check_not" /> Sim
                            <input type="radio" name="noturno[]" value="0" id="n_nao" class="check_not" /> Não
                        </p>
                        
                        <p id="hide_noturno">
                            <label class='first'>Horas Noturno:</label>
                            <input type="text" name="horas_noturno[]" id="horas_noturno" size="30" maxlength="4" />
                        </p>
                    </fieldset>
