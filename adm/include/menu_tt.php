...
for ($mail = 0; $mail < 1; $mail++):
    ...
    ?>
        ...
        <div class="titulo_tabela">  
            ...
            <table class="relacao">
                ...
                <tr class="titulo">
                    <td colspan="3" align="center">OBRIGAÇÕES DA INSTITUIÇÃO</td>
                </tr>
    ...
    $qry_tt = mysql_query("SELECT * FROM
            (SELECT *,
                     CASE periodo
            ...
            WHERE id_master = 6 AND status = 1)
            as obrigacoes
            WHERE prazo_expiracao >-10 AND prazo_expiracao <= 60 AND tipo_oscip != ''");    
