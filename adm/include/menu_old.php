...
<br>
 	 ...
 	 <a href="prestador.php?m=<?=$link_master?>" ><img target="_blank" src="imagens/prestador.jpg" width="70" height="70"></a><br />
<br>
      	 PRESTAÇÃO DE SERVIÇOS
    </td>
         <td width="17%" align="center">
 	 <a href="documentos/index.php?m=<?=$link_master?>"><img src="imagens/download.jpg" width="70" height="70"></a><br />
<br>
...
<?php 
//	quantodade de dias para o aviso ser exibido
$qnt_dias =60;
...
for($mail=0; $mail<=1; $mail++):
		...
		while($row_regiao = mysql_fetch_assoc($qr_regiao)):
						...
						while($row_projeto = mysql_fetch_assoc($qr_projeto)):
									 ...
									 $prazo_renovacao = mktime(0,0,0,$mes,$dia-$qnt_dias,$ano); //45 dias
									 /////////////////////
								 ...
								 if(($prazo_renovacao<=$data_hoje) and($data_termino>$data_hoje))
									...
									?>
                                     <tr class="linha_um">
                                        <td align="left"><?php echo $row_projeto['id_projeto'].' - '.$row_projeto['nome'];?> </td>
                                        <td align="left"><?php echo $row_regiao['regiao'];?> </td>
                                        <td><?php echo '<span style="color:#09C;font-weight:bold;">Expira em '.(int)$dif.' dias!</span>';?> </td>
                                        <td>
											 ...
											 { 
												$dif=($data_termino-$data_hoje)/86400;
                                                            ...
                                                            <tr class="linha_um">
                                                                ...
                                                                <td><?php echo '<span style="color:#09C;font-weight:bold;">Renovação expira em '.(int)$dif.' dias!</span>';?> </td>
                                                            </tr>
...
<?php	
$tipos = array( 1 => 'Qualificação', 2 => 'Alvará de Funcionamento', 3 => 'Balanço Patrimonial', 4 => 'Declaração de Isenção de IR', 5 => 'Cartão CNPJ' , 6 => 'CRF', 7 => 'CND', 8 => 'Estatuto',9 => 'CCN-RFB/PGFN', 10 =>'Procuração', 11 =>'Ofícios Enviados', 12 => 'Ata',13 => 'Ofícios Recebidos',14 =>'Certidão de Distribuições Cíveis', 15 => 'Certidão de Tributos Mobiliários', 16 => 'Inscrição Municipal');
						...
						if($verifica_oscip == 0)
						{
										if($a==0)
										{
											echo '	<table class="relacao">
										     ...
										     if($mail!=1){ echo '<td>Cadastrar </td>'; }
														echo '<td>Região</td>
															  <td>Ano</td>
													</tr>';
													  $a=1;
