		...
		<?php // Início do Loop
          ...
          <div class="AccordionPanelTab<? if($alternateColor++%2==0) { ?>_um<? } else { ?>_dois<? } ?>">
           <table cellspacing="0" cellpadding="4" class="relacao" style="width:100%;">
            <tr onClick="mudar_cor(this);mostraDiv('opcoes');" class="linha_<? if($alternateColor2++%2==0) { ?>um<? } else { ?>dois<? } ?>_accordion" <? if($curso['aula_id'] == $_GET['curso']) { ?>style="background-color:#dee3ed;"<?php } ?>>
