...
//trata unidade
$locacao = explode("//", $_REQUEST['lotacao']);
...
mysql_query ("update autonomo set localpagamento = '$localpagamento', locacao = '$locacao_nome', id_unidade = '$locacao_id', nome = '$nome', sexo = '$sexo', endereco = '$endereco', bairro = '$bairro', cidade = '$cidade', uf = '$uf', cep = '$cep', tel_fixo = '$tel_fixo',
